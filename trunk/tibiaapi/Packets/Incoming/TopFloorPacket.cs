...
{
    public class TopFloorPacket : MapPacket
    {

        public TopFloorPacket(Objects.Client c)
            : base(c)
        {
            Type = IncomingPacketType.TopFloor;
        ...
        public override bool ParseMessage(NetworkMessage msg, PacketDestination destination, NetworkMessage outMsg)
        {
            ...
            if (msg.GetByte() != (byte)IncomingPacketType.TopFloor)
                return false;
