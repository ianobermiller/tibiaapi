namespace Tibia.Addresses
{
    ...
    public static class Client
    {
        ...
        public static uint LoginStruct;
        public static uint LoginCharListBegin;
        public static uint LoginCharListEnd;
        public static uint LoginCharListDistanceCharName;
        public static uint LoginCharListDistanceWorldName;
        public static uint LoginCharListDistanceIsPreview;
        public static uint LoginCharListDistanceWorldIP;
        public static uint LoginCharListDistanceWorldPort;
        public static uint LoginCharListStepCharacter;
