namespace Tibia.Addresses
{
    ...
    {
        public static uint Exp = 0x635F04; // 8.53
        ...
        public static uint SlotHead = 0x6427E0; // 8.53
        ...
        public static uint CurrentTileToGo = 0x635F18; // 8.53
        public static uint TilesToGo = 0x635F1C; // 8.53


        public static uint RedSquare = 0x635EDC; // 8.53
        ...
        /// </summary>
        public static uint Z = 0x645148; // 8.53
