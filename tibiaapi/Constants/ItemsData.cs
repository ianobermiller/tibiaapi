...
namespace Tibia.Constants
{
    public static class ItemsData
    {
        ...
        public static ItemData Apple = new ItemData("Apple", 3585, false, 1.5, 0, new List<string>() { "Elf", "Priestess", "Omruc", "Valkyrie" });
        public static ItemData Banana = new ItemData("Banana", 3587, false, 1.8, 1, new List<string>() { "Sibang", "Kongra", "Merlkin", "Hairman", "Grynch" });
        public static ItemData Blueberry = new ItemData("Blueberry", 0, false, 0.2, 0, new List<string>() { "Marid" });
        public static ItemData Bread = new ItemData("Bread", 3600, false, 5, 0, new List<string>() { "Elf", "Fernfang", "Fire", "Monk", "Dark", "Warlock" });
        public static ItemData BrownBread = new ItemData("Brown Bread", 3602, false, 4, 0, new List<string>() { "Amazon", "Black", "Gang" });
        public static ItemData BrownMushroom = new ItemData("Brown Mushroom", 3725, false, 0.2, 1, new List<string>() { "Thornback", "Skeleton", "Ushuriel" });
        public static ItemData Carrot = new ItemData("Carrot", 3595, false, 1.6, 2, new List<string>() { "Rabbit", "Minotaur", "Blue", "Apprentice" });
        public static ItemData Cheese = new ItemData("Cheese", 3607, false, 4, 0, new List<string>() { "Rat", "Cave", "Witch", "Green", "Munster" });
        public static ItemData Cherry = new ItemData("Cherry", 3590, false, 0.2, 0, new List<string>() { "Bug", "Warlock" });
        public static ItemData Coconut = new ItemData("Coconut", 3589, false, 4.8, 25, new List<string>() { "Sibang" });
        public static ItemData Cookie = new ItemData("Cookie", 3598, false, 0.1, 1, new List<string>() { "Witch", "Cave", "Munster", "Grynch" });
        public static ItemData Corncob = new ItemData("Corncob", 3597, false, 3.5, 1, new List<string>() { "Orc", "Barbarian" });
        public static ItemData DragonHam = new ItemData("Dragon Ham", 3583, false, 30, 0, new List<string>() { "Dragon", "Dragon", "Dragon", "Dragon", "Frost", "Frost", "Wyvern", "Juggernaut", "Demodras", "Sea", "Young", "Wyrm" });
        public static ItemData Egg = new ItemData("Egg", 3606, false, 0.3, 1, new List<string>() { "Chicken", "Rabbit" });
        public static ItemData Fish = new ItemData("Fish", 3578, false, 5.2, 0, new List<string>() { "Blood", "Chakoya", "Chakoya", "Chakoya", "Crab", "Dire", "Frost", "Swamp", "Orc", "Orc", "Warlord", "Penguin", "Toad", "Thornback", "Goblin", "Tortoise" });
        public static ItemData Grapes = new ItemData("Grapes", 3592, false, 2.5, 1, new List<string>() { "Hero", "Elf" });
        public static ItemData GreenMushroom = new ItemData("Green Mushroom", 3732, false, 0.1, 0, new List<string>() { "Bonebeast", "Necromancer", "Dragon", "Serpent", "Necropharus", "Demodras", "Ice", "Frost", "Mutated", "The" });
        public static ItemData Ham = new ItemData("Ham", 3582, false, 20, 4, new List<string>() { "Bear", "Carniphila", "Crocodile", "Cyclops", "Deer", "Elephant", "Gargoyle", "Hydra", "Lion", "Orc", "P", "a", "Polar", "Rotworm", "Carrion", "Smuggler", "Tortoise", "Thornback", "Tiger", "War", "Yeti", "Juggernaut", "Dark", "Nightmare", "Hacker", "Frost", "Frost" });
        public static ItemData Meat = new ItemData("Meat", 3577, false, 13, 1, new List<string>() { "Hero", "Rotworm", "Carrion", "Yeti", "Troll", "Isl", "Troll", "Orc", "Sheep", "Black", "Deer", "Minotaur", "Minotaur", "Hunter", "Valkyrie", "Behemoth", "Cyclops", "Wolf", "Rabbit", "Larva", "Scarab", "Orc", "Orc", "Orc", "Orc", "Orc", "Warlord", "Orc", "Wild", "Badger", "Bear", "Hyaena", "Lion", "Pig", "Polar", "War", "Winter", "Gargoyle", "Fire", "B", "it", "P", "a", "Hydra", "Tiger", "Terror", "Carniphila", "Crocodile", "Elephant", "Smuggler", "Minotaur", "Chicken", "Toad", "General", "Nomad", "Isl", "Troll", "Destroyer", "Fury", "Juggernaut", "Nightmare", "Frost", "Frost", "Sea", "Young", "Apprentice", "Crazed" });
        public static ItemData Mellon = new ItemData("Mellon", 3593, false, 0, 0, new List<string>() { "" });
        public static ItemData Orange = new ItemData("Orange", 3586, false, 1.1, 0, new List<string>() { "Hunter", "Sibang", "Grynch" });
        public static ItemData Roll = new ItemData("Roll", 3601, false, 1, 0, new List<string>() { "Hunter", "Poacher", "Crazed" });
        public static ItemData Salmon = new ItemData("Salmon", 3579, false, 3.2, 0, new List<string>() { "None" });
        public static ItemData WhiteMushroom = new ItemData("White Mushroom", 3723, false, 0.4, 1, new List<string>() { "Dwarf", "Dwarf", "Dwarf", "Dwarf", "Thornback", "Skeleton", "Haunted" });
        public static ItemData AnimateDeadRune = new ItemData("Animate Dead Rune", 3203, false, 0, 0, new List<string>() { "" });
        public static ItemData AntidoteRune = new ItemData("Antidote Rune", 3153, false, 1.2, 0, new List<string>() { "" });
        public static ItemData AvalancheRune = new ItemData("Avalanche Rune", 3161, false, 0, 0, new List<string>() { "" });
        public static ItemData ChameleonRune = new ItemData("Chameleon Rune", 3178, false, 0, 0, new List<string>() { "" });
        public static ItemData ConvinceCreatureRune = new ItemData("Convince Creature Rune", 3177, false, 0, 0, new List<string>() { "" });
        public static ItemData DesintegrateRune = new ItemData("Desintegrate Rune", 3197, false, 0, 0, new List<string>() { "" });
        public static ItemData DestroyFieldRune = new ItemData("Destroy Field Rune", 3148, false, 0, 0, new List<string>() { "" });
        public static ItemData EnergyBombRune = new ItemData("Energy Bomb Rune", 3149, false, 1.2, 0, new List<string>() { "" });
        public static ItemData EnergyFieldRune = new ItemData("Energy Field Rune", 3164, false, 0, 0, new List<string>() { "" });
        public static ItemData EnergyWallRune = new ItemData("Energy Wall Rune", 3166, false, 1.2, 0, new List<string>() { "" });
        public static ItemData ExplosionRune = new ItemData("Explosion Rune", 3200, false, 1.2, 0, new List<string>() { "" });
        public static ItemData FireBombRune = new ItemData("Fire Bomb Rune", 3192, false, 0, 0, new List<string>() { "" });
        public static ItemData FireFieldRune = new ItemData("Fire Field Rune", 3188, false, 1.2, 0, new List<string>() { "" });
        public static ItemData FireWallRune = new ItemData("Fire Wall Rune", 3190, false, 1.2, 0, new List<string>() { "" });
        public static ItemData FireballRune = new ItemData("Fireball Rune", 3189, false, 0, 0, new List<string>() { "" });
        public static ItemData GreatFireballRune = new ItemData("Great Fireball Rune", 3191, false, 0, 0, new List<string>() { "" });
        public static ItemData HeavyMagicMissileRune = new ItemData("Heavy Magic Missile Rune", 3198, false, 0, 0, new List<string>() { "" });
        public static ItemData IcicleRune = new ItemData("Icicle Rune", 3158, false, 0, 0, new List<string>() { "" });
        public static ItemData IntenseHealingRune = new ItemData("Intense Healing Rune", 3152, false, 1.2, 0, new List<string>() { "" });
        public static ItemData LightMagicMissileRune = new ItemData("Light Magic Missile Rune", 3174, false, 0, 0, new List<string>() { "" });
        public static ItemData MagicWallRune = new ItemData("Magic Wall Rune", 3180, false, 0, 0, new List<string>() { "" });
        public static ItemData ParalyzeRune = new ItemData("Paralyze Rune", 3165, false, 0, 0, new List<string>() { "" });
        public static ItemData PoisonBombRune = new ItemData("Poison Bomb Rune", 3173, false, 0, 0, new List<string>() { "" });
        public static ItemData PoisonFieldRune = new ItemData("Poison Field Rune", 3172, false, 0, 0, new List<string>() { "" });
        public static ItemData PoisonWallRune = new ItemData("Poison Wall Rune", 3176, false, 1.2, 0, new List<string>() { "" });
        public static ItemData SoulfireRune = new ItemData("Soulfire Rune", 3195, false, 0, 0, new List<string>() { "" });
        public static ItemData StalagmiteRune = new ItemData("Stalagmite Rune", 3179, false, 0, 0, new List<string>() { "" });
        public static ItemData StoneShowerRune = new ItemData("Stone Shower Rune", 3175, false, 0, 0, new List<string>() { "" });
        public static ItemData SuddenDeathRune = new ItemData("Sudden Death Rune", 3155, false, 1.2, 0, new List<string>() { "" });
        public static ItemData ThunderstormRune = new ItemData("Thunderstorm Rune", 3202, false, 0, 0, new List<string>() { "" });
        public static ItemData UltimateHealingRune = new ItemData("Ultimate Healing Rune", 3160, false, 1.2, 0, new List<string>() { "" });
    }
}
