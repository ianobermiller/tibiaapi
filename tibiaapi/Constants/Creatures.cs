...
namespace Tibia.Constants
{
    public static class Creatures
    {
        ...
        public static CreatureData Ashmunrah = new CreatureData("Ashmunrah", 5000, 3100, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 140), new Loot("Silver Brooch", 0, LootPossibility.Normal, 0), new Loot("Great Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Might Ring", 3048, LootPossibility.Rare, 0), new Loot("Crown Armor", 3381, LootPossibility.Rare, 0), new Loot("Holy Scarab", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Banshee = new CreatureData("Banshee", 1000, 900, 0, 0, 652, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 100), new Loot("C", 0, LootPossibility.Normal, 0), new Loot("lestick", 0, LootPossibility.Normal, 0), new Loot("Simple Dress", 0, LootPossibility.Normal, 0), new Loot("Dirty Cape", 0, LootPossibility.Normal, 0), new Loot("Silver Amulet", 3054, LootPossibility.Normal, 0), new Loot("Mirror", 0, LootPossibility.Normal, 0), new Loot("Black Pearl", 3027, LootPossibility.SemiRare, 0), new Loot("Poison Dagger", 3299, LootPossibility.Rare, 0), new Loot("Silver Brooch", 0, LootPossibility.Rare, 0), new Loot("Stone Skin Amulet", 3081, LootPossibility.Rare, 0), new Loot("Lyre", 0, LootPossibility.Rare, 0), new Loot("Spellbook", 648, LootPossibility.Rare, 0), new Loot("Strong Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Ring of Healing", 3098, LootPossibility.Rare, 0), new Loot("Blue Robe", 3567, LootPossibility.Rare, 0), new Loot("White Pearl", 3026, LootPossibility.VeryRare, 0), new Loot("Terra Mantle", 811, LootPossibility.VeryRare, 0), new Loot("Wedding Ring", 3004, LootPossibility.VeryRare, 0), new Loot("Life Crystal", 3061, LootPossibility.VeryRare, 0), new Loot("Red Robe", 3566, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData BarbarianBloodwalker = new CreatureData("Barbarian Bloodwalker", 305, 195, 0, 0, 200, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 0), new Loot("Ham", 0, LootPossibility.Normal, 1), new Loot("Chain Armor", 3358, LootPossibility.Normal, 0), new Loot("Halberd", 3269, LootPossibility.Normal, 0), new Loot("Battle Axe", 3266, LootPossibility.Normal, 0), new Loot("Chain Helmet", 3352, LootPossibility.Normal, 0), new Loot("Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Beastslayer Axe", 0, LootPossibility.Rare, 0), new Loot("Fur Boots", 7457, LootPossibility.Rare, 0), new Loot("Red Piece of Cloth", 5911, LootPossibility.VeryRare, 0), new Loot("Shard", 7290, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData BarbarianBrutetamer = new CreatureData("Barbarian Brutetamer", 145, 90, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 15), new Loot("Corncob", 0, LootPossibility.Normal, 2), new Loot("Ham", 0, LootPossibility.Normal, 3), new Loot("Chain Armor", 3358, LootPossibility.Normal, 0), new Loot("Grey Small Book", 0, LootPossibility.Normal, 0), new Loot("Staff", 3289, LootPossibility.Normal, 0), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Hunting Spear", 3347, LootPossibility.Normal, 0), new Loot("Mana Potion", 0, LootPossibility.SemiRare, 0), new Loot("Brutetamer's Staff", 0, LootPossibility.Rare, 0), new Loot("Fur Boots", 7457, LootPossibility.Rare, 0), new Loot("Mammoth Fur Shorts", 7464, LootPossibility.VeryRare, 0), new Loot("Mammoth Fur Cape", 7463, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData CrystalSpider = new CreatureData("Crystal Spider", 1250, 900, 0, 0, 358, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 95), new Loot("Sniper Arrow", 7364, LootPossibility.Normal, 7), new Loot("Brass Legs", 3372, LootPossibility.Normal, 0), new Loot("Steel Helmet", 3351, LootPossibility.Normal, 0), new Loot("Plate Armor", 3357, LootPossibility.Normal, 0), new Loot("Ice Cube", 7441, LootPossibility.Normal, 0), new Loot("Strong Mana Potion", 0, LootPossibility.SemiRare, 0), new Loot("Crystal Sword", 7449, LootPossibility.SemiRare, 0), new Loot("Glacier Mask", 829, LootPossibility.SemiRare, 0), new Loot("Shard", 7290, LootPossibility.SemiRare, 0), new Loot("Time Ring", 3053, LootPossibility.SemiRare, 0), new Loot("Spider Silk", 5879, LootPossibility.SemiRare, 0), new Loot("Knight Armor", 3370, LootPossibility.Rare, 0), new Loot("Knight Legs", 3371, LootPossibility.Rare, 0), new Loot("Platinum Amulet", 3055, LootPossibility.Rare, 0), new Loot("Sapphire Hammer", 7437, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData CyclopsDrone = new CreatureData("Cyclops Drone", 325, 200, 0, 0, 180, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 24), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Meat", 0, LootPossibility.Normal, 2), new Loot("Short Sword", 3294, LootPossibility.Normal, 0), new Loot("Plate Shield", 3410, LootPossibility.Normal, 0), new Loot("Battle Shield", 3413, LootPossibility.SemiRare, 0), new Loot("Halberd", 3269, LootPossibility.Rare, 0), new Loot("Cyclops Trophy", 7398, LootPossibility.Rare, 0), new Loot("Strong Health Potion", 0, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData CyclopsSmith = new CreatureData("Cyclops Smith", 435, 255, 0, 0, 220, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 69), new Loot("Meat", 0, LootPossibility.Normal, 3), new Loot("Ham", 0, LootPossibility.Normal, 0), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Plate Shield", 3410, LootPossibility.Normal, 0), new Loot("Battle Shield", 3413, LootPossibility.Normal, 0), new Loot("Heavy Machete", 0, LootPossibility.Normal, 0), new Loot("Battle Hammer", 3305, LootPossibility.Normal, 0), new Loot("Battle Axe", 3266, LootPossibility.Normal, 0), new Loot("Double Axe", 3275, LootPossibility.Normal, 0), new Loot("Dark Helmet", 3384, LootPossibility.Rare, 0), new Loot("Cyclops Trophy", 7398, LootPossibility.Rare, 0), new Loot("Strong Health Potion", 0, LootPossibility.Rare, 0), new Loot("Club Ring", 3093, LootPossibility.Rare, 0), new Loot("Spiked Squelcher", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Destroyer = new CreatureData("Destroyer", 3700, 2500, 0, 0, 615, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 330), new Loot("Small Amethysts", 0, LootPossibility.Normal, 2), new Loot("Platinum Coins", 0, LootPossibility.Normal, 3), new Loot("Meat", 0, LootPossibility.Normal, 6), new Loot("Burst Arrows", 0, LootPossibility.Normal, 12), new Loot("Demonic Essence", 6499, LootPossibility.Normal, 0), new Loot("Plate Armor", 3357, LootPossibility.Normal, 0), new Loot("Crowbar", 3304, LootPossibility.Normal, 0), new Loot("Dark Armor", 3383, LootPossibility.Normal, 0), new Loot("Pick", 3456, LootPossibility.Normal, 0), new Loot("Big Bone", 0, LootPossibility.Normal, 0), new Loot("Soul Orb", 5944, LootPossibility.Normal, 0), new Loot("Mind Stone", 0, LootPossibility.Rare, 0), new Loot("Giant Sword", 3281, LootPossibility.Rare, 0), new Loot("Steel Boots", 3554, LootPossibility.Rare, 0), new Loot("Great Health Potion", 0, LootPossibility.Rare, 0), new Loot("Chaos Mace", 7427, LootPossibility.Rare, 0), new Loot("Skull Helmet", 5741, LootPossibility.VeryRare, 0), new Loot("Crystal Necklace", 3008, LootPossibility.VeryRare, 0), new Loot("Dreaded Cleaver", 7419, LootPossibility.VeryRare, 0), new Loot("Death Ring", 6299, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData DiblisTheFair = new CreatureData("Diblis The Fair", 0, 1800, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("gold", 0, LootPossibility.Normal, 99), new Loot("Platinum Coin", 3035, LootPossibility.Normal, 5), new Loot("Skull", 0, LootPossibility.Normal, 0), new Loot("Black Pearl", 3027, LootPossibility.SemiRare, 0), new Loot("Ring of Healing", 3098, LootPossibility.SemiRare, 0), new Loot("Strong Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Vampire Shield", 3434, LootPossibility.Rare, 0), new Loot("Spellbook of Lost Souls", 8075, LootPossibility.VeryRare, 0), new Loot("Vampire Lord Token", 8192, LootPossibility.Always, 0) }
        );
        ...
        public static CreatureData DragonHatchling = new CreatureData("Dragon Hatchling", 380, 185, 0, 0, 200, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 0), new Loot("Dragon Ham", 0, LootPossibility.Normal, 0), new Loot("Health Potion", 0, LootPossibility.Normal, 0) }
        );
        ...
        public static CreatureData DragonLordHatchling = new CreatureData("Dragon Lord Hatchling", 750, 645, 0, 0, 335, false, true, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Energy, 10), new DamageModifier(DamageType.Ice, 10) },
            new List<string>() { "Fchu", "Rooawwrr", },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 165), new Loot("Dragon Ham", 0, LootPossibility.Normal, 0), new Loot("Mana Potion", 0, LootPossibility.SemiRare, 0), new Loot("Green Mushroom", 0, LootPossibility.Rare, 1), new Loot("Magma Boots", 818, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Dreadbeast = new CreatureData("Dreadbeast", 800, 250, 0, 0, 140, false, false, FrontAttack.None,
            ...
            new List<string>() { },
            new List<Loot>() { new Loot("Gold Coins", 0, LootPossibility.Normal, 80), new Loot("Big Bone", 0, LootPossibility.Normal, 0), new Loot("Skull", 0, LootPossibility.Rare, 0), new Loot("Bone", 0, LootPossibility.Normal, 0), new Loot("Plate Armor", 3357, LootPossibility.Rare, 0), new Loot("Green Mushroom", 0, LootPossibility.VeryRare, 0), new Loot("Hardened Bone", 5925, LootPossibility.VeryRare, 0), new Loot("Bone Club", 3337, LootPossibility.SemiRare, 0), new Loot("Bone Shield", 3441, LootPossibility.Rare, 0), new Loot("Health Potion", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData DwarfGuard = new CreatureData("Dwarf Guard", 245, 165, 0, 0, 140, false, true, FrontAttack.None,
            ...
            new List<string>() { "Hail Durin!", },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 30), new Loot("White Mushrooms", 0, LootPossibility.Normal, 2), new Loot("Leather Boots", 3552, LootPossibility.Normal, 0), new Loot("Scale Armor", 3377, LootPossibility.Normal, 0), new Loot("Battle Shield", 3413, LootPossibility.Normal, 0), new Loot("Battle Hammer", 3305, LootPossibility.Normal, 0), new Loot("Steel Helmet", 3351, LootPossibility.SemiRare, 0), new Loot("Double Axe", 3275, LootPossibility.Rare, 0), new Loot("Iron Ore", 5880, LootPossibility.Rare, 0), new Loot("Axe Ring", 3092, LootPossibility.VeryRare, 0), new Loot("Health Potion", 0, LootPossibility.VeryRare, 0), new Loot("Small Amethyst", 3033, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData DworcVoodoomaster = new CreatureData("Dworc Voodoomaster", 80, 55, 0, 0, 90, false, false, FrontAttack.None,
            ...
            new List<string>() { "Grow truk grrrrr.", "Brak brrretz!", "Prek tars,  dekklep zurk.", },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 20), new Loot("Skull", 0, LootPossibility.Normal, 3), new Loot("Torch", 0, LootPossibility.Normal, 0), new Loot("Bone", 0, LootPossibility.Normal, 0), new Loot("Big Bone", 0, LootPossibility.Normal, 0), new Loot("Leather Armor", 3361, LootPossibility.Normal, 0), new Loot("Bronze Amulet", 3056, LootPossibility.SemiRare, 0), new Loot("Poison Dagger", 3299, LootPossibility.SemiRare, 0), new Loot("Tribal Mask", 3403, LootPossibility.SemiRare, 0), new Loot("Strange Symbol", 3206, LootPossibility.Rare, 0), new Loot("Health Potion", 0, LootPossibility.Rare, 0), new Loot("Voodoo Doll", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData FrostDragonHatchling = new CreatureData("Frost Dragon Hatchling", 800, 745, 0, 0, 380, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 55), new Loot("Dragon Ham", 0, LootPossibility.Normal, 0), new Loot("Spellbook of Enlightenment", 8072, LootPossibility.Rare, 0), new Loot("Health Potion", 0, LootPossibility.Rare, 0) }
        );
        ...
        public static CreatureData GiantSpider = new CreatureData("Giant Spider", 1300, 900, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Fire, 10) },
            new List<string>() { },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 115), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Brass Legs", 3372, LootPossibility.Normal, 0), new Loot("Steel Helmet", 3351, LootPossibility.Normal, 0), new Loot("Plate Armor", 3357, LootPossibility.Normal, 0), new Loot("Poison Arrows", 0, LootPossibility.Normal, 12), new Loot("Spider Silk", 5879, LootPossibility.Rare, 0), new Loot("Time Ring", 3053, LootPossibility.Rare, 0), new Loot("Strong Health Potion", 0, LootPossibility.Rare, 0), new Loot("Knight Armor", 3370, LootPossibility.Rare, 0), new Loot("Knight Legs", 3371, LootPossibility.Rare, 0), new Loot("Platinum Amulet", 3055, LootPossibility.VeryRare, 0), new Loot("Lightning Headb", 0, LootPossibility.Normal, 0), new Loot("very rare)", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData GreenDjinn = new CreatureData("Green Djinn", 330, 215, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 113), new Loot("Cheese", 0, LootPossibility.Normal, 0), new Loot("Grave Flower", 3661, LootPossibility.Normal, 0), new Loot("Small Oil Lamp", 2933, LootPossibility.SemiRare, 0), new Loot("Royal Spear", 7378, LootPossibility.SemiRare, 2), new Loot("Green Book", 0, LootPossibility.SemiRare, 0), new Loot("Small Emerald", 3032, LootPossibility.Rare, 4), new Loot("Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Green Piece of Cloth", 5910, LootPossibility.Rare, 0), new Loot("Mystic Turban", 3574, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData HauntedTreeling = new CreatureData("Haunted Treeling", 450, 310, 0, 0, 300, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 96), new Loot("White Mushroom", 0, LootPossibility.Normal, 2), new Loot("Red Mushroom", 0, LootPossibility.Normal, 0), new Loot("Wooden Trash", 0, LootPossibility.Normal, 0), new Loot("Health Potion", 0, LootPossibility.Normal, 0), new Loot("Orange Mushroom", 0, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Trunk Chair Kit", 0, LootPossibility.SemiRare, 0), new Loot("Small Emerald", 3032, LootPossibility.SemiRare, 0), new Loot("Dwarven Ring", 3097, LootPossibility.Rare, 0), new Loot("Bullseye Potion", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Hero = new CreatureData("Hero", 1400, 1200, 0, 0, 360, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 100), new Loot("Arrows", 0, LootPossibility.Normal, 15), new Loot("Rope", 3003, LootPossibility.Normal, 0), new Loot("Scroll", 0, LootPossibility.Normal, 0), new Loot("Lyre", 0, LootPossibility.Normal, 0), new Loot("Green Tunic", 0, LootPossibility.Normal, 0), new Loot("Bow", 3350, LootPossibility.Normal, 0), new Loot("Scarf", 3572, LootPossibility.Normal, 0), new Loot("Meat", 0, LootPossibility.Normal, 0), new Loot("Grapes", 0, LootPossibility.Normal, 0), new Loot("Red Rose", 0, LootPossibility.Normal, 0), new Loot("Wedding Ring", 3004, LootPossibility.Normal, 0), new Loot("Two H", 0, LootPossibility.Normal, 0), new Loot("ed Sword", 0, LootPossibility.Normal, 0), new Loot("Sniper Arrow", 7364, LootPossibility.Normal, 6), new Loot("War Hammer", 3279, LootPossibility.SemiRare, 0), new Loot("Red Piece of Cloth", 5911, LootPossibility.SemiRare, 0), new Loot("Crown Armor", 3381, LootPossibility.Rare, 0), new Loot("Crown Shield", 3419, LootPossibility.Rare, 0), new Loot("Crown Helmet", 3385, LootPossibility.Rare, 0), new Loot("Fire Sword", 3280, LootPossibility.Rare, 0), new Loot("Great Health Potion", 0, LootPossibility.Rare, 0), new Loot("Piggy Bank", 2995, LootPossibility.VeryRare, 0), new Loot("Might Ring", 3048, LootPossibility.VeryRare, 0), new Loot("Crown Legs", 3382, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData IceGolem = new CreatureData("Ice Golem", 385, 295, 0, 0, 305, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 53), new Loot("Ice Cube", 7441, LootPossibility.Rare, 0), new Loot("Ice Rapier", 3284, LootPossibility.SemiRare, 0), new Loot("Black Pearl", 3027, LootPossibility.SemiRare, 0), new Loot("Small Sapphire", 3029, LootPossibility.Rare, 0), new Loot("Small Diamond", 3028, LootPossibility.Rare, 0), new Loot("Crystal Sword", 7449, LootPossibility.Rare, 0), new Loot("Strange Helmet", 0, LootPossibility.Rare, 0), new Loot("Shard", 7290, LootPossibility.Rare, 0), new Loot("Spike Sword", 0, LootPossibility.VeryRare, 0), new Loot("Strong Health Potion", 0, LootPossibility.VeryRare, 0), new Loot("Glacier Mask", 829, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Lich = new CreatureData("Lich", 880, 900, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 120), new Loot("Staff", 3289, LootPossibility.Normal, 0), new Loot("Spellbook", 648, LootPossibility.Normal, 0), new Loot("Black Pearl", 3027, LootPossibility.Normal, 0), new Loot("White Pearl", 3026, LootPossibility.Normal, 0), new Loot("Dirty Cape", 0, LootPossibility.Normal, 0), new Loot("Strange Helmet", 0, LootPossibility.Normal, 0), new Loot("Mind Stone", 0, LootPossibility.Normal, 0), new Loot("Strong Mana Potion", 0, LootPossibility.SemiRare, 0), new Loot("Platinum Amulet", 3055, LootPossibility.VeryRare, 0), new Loot("Ring of Healing", 3098, LootPossibility.Rare, 0), new Loot("Lightning Boots", 820, LootPossibility.Rare, 0), new Loot("Blue Robe", 3567, LootPossibility.VeryRare, 0), new Loot("Castle Shield", 3435, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData LizardTemplar = new CreatureData("Lizard Templar", 410, 155, 0, 0, 70, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 60), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Short Sword", 3294, LootPossibility.Normal, 0), new Loot("Sword", 3264, LootPossibility.Normal, 0), new Loot("Morning Star", 3282, LootPossibility.Normal, 0), new Loot("Steel Helmet", 3351, LootPossibility.SemiRare, 0), new Loot("Lizard Leather", 5876, LootPossibility.SemiRare, 0), new Loot("Plate Armor", 3357, LootPossibility.Rare, 0), new Loot("Templar Scytheblade", 3345, LootPossibility.Rare, 0), new Loot("Small Emerald", 3032, LootPossibility.Rare, 0), new Loot("Health Potion", 0, LootPossibility.Rare, 0), new Loot("Lizard Scale", 5881, LootPossibility.Rare, 0), new Loot("Salam", 0, LootPossibility.Normal, 0), new Loot("er Shield", 0, LootPossibility.Rare, 0) }
        );
        ...
        public static CreatureData Marziel = new CreatureData("Marziel", 0, 3000, 0, 0, 0, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Platinum Coins", 0, LootPossibility.Normal, 7), new Loot("Gold Coin", 3031, LootPossibility.Normal, 100), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0), new Loot("Vampire Shield", 3434, LootPossibility.Rare, 0), new Loot("Ring of Healing", 3098, LootPossibility.Rare, 0) }
        );
        ...
        public static CreatureData MinotaurGuard = new CreatureData("Minotaur Guard", 185, 160, 0, 0, 100, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 20), new Loot("Meat", 0, LootPossibility.Normal, 0), new Loot("Leather Legs", 3559, LootPossibility.Normal, 0), new Loot("Fishing Rod", 3483, LootPossibility.Normal, 0), new Loot("Hatchet", 3276, LootPossibility.Normal, 0), new Loot("Chain Armor", 3358, LootPossibility.Normal, 0), new Loot("Chain Helmet", 3352, LootPossibility.Normal, 0), new Loot("Chain Legs", 3558, LootPossibility.Normal, 0), new Loot("Battle Shield", 3413, LootPossibility.Normal, 0), new Loot("Brass Armor", 3359, LootPossibility.Normal, 0), new Loot("Health Potion", 0, LootPossibility.Normal, 0), new Loot("Double Axe", 3275, LootPossibility.SemiRare, 0), new Loot("Minotaur Leather", 5878, LootPossibility.Rare, 0), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0) }
        );
        ...
        public static CreatureData Morguthis = new CreatureData("Morguthis", 4800, 3000, 0, 0, 1900, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold", 0, LootPossibility.Normal, 153), new Loot("Stone Skin Amulet", 3081, LootPossibility.Normal, 0), new Loot("Knight Axe", 3318, LootPossibility.Normal, 0), new Loot("Black Pearl", 3027, LootPossibility.Normal, 0), new Loot("Great Health Potion", 0, LootPossibility.Rare, 0), new Loot("Demonbone Amulet", 3019, LootPossibility.VeryRare, 0), new Loot("Ravager's Axe", 0, LootPossibility.VeryRare, 0), new Loot("Assassin Star", 7368, LootPossibility.VeryRare, 3), new Loot("Steel Boots", 3554, LootPossibility.VeryRare, 0), new Loot("Sword Hilt", 0, LootPossibility.Always, 0) }
        );
        ...
        public static CreatureData MutatedRat = new CreatureData("Mutated Rat", 550, 450, 0, 0, 305, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 130), new Loot("Skull", 0, LootPossibility.Normal, 0), new Loot("Moldy Cheese", 0, LootPossibility.Normal, 0), new Loot("Stone Herb", 0, LootPossibility.Normal, 0), new Loot("Green Mushroom", 0, LootPossibility.Normal, 0), new Loot("Plate Shield", 3410, LootPossibility.Normal, 0), new Loot("Halberd", 3269, LootPossibility.Normal, 0), new Loot("Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Stealth Ring", 3049, LootPossibility.Rare, 0), new Loot("Spellbook of Enlightenment", 8072, LootPossibility.VeryRare, 0), new Loot("Tower Shield", 3428, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData MutatedTiger = new CreatureData("Mutated Tiger", 1100, 750, 0, 0, 0, false, true, FrontAttack.Wave,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 96), new Loot("Ham", 0, LootPossibility.Normal, 2), new Loot("Meat", 0, LootPossibility.Normal, 4), new Loot("Steel Shield", 3409, LootPossibility.Normal, 0), new Loot("Life Ring", 3052, LootPossibility.SemiRare, 0), new Loot("Strong Health Potion", 0, LootPossibility.Rare, 0), new Loot("Silky Tapestry", 9046, LootPossibility.Rare, 0), new Loot("Glorious Axe", 7454, LootPossibility.VeryRare, 0), new Loot("Guardian Shield", 0, LootPossibility.VeryRare, 0), new Loot("Angelic Axe", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Nightstalker = new CreatureData("Nightstalker", 700, 500, 0, 0, 260, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 107), new Loot("Shadow Herb", 0, LootPossibility.Normal, 0), new Loot("Crystal Ring", 3007, LootPossibility.SemiRare, 0), new Loot("Protection Amulet", 3084, LootPossibility.SemiRare, 0), new Loot("Platinum Amulet", 3055, LootPossibility.Rare, 0), new Loot("Strong Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Spirit Cloak", 0, LootPossibility.Rare, 0), new Loot("Crystal of Balance", 0, LootPossibility.VeryRare, 0), new Loot("Haunted Blade", 7407, LootPossibility.VeryRare, 0), new Loot("Chaos Mace", 7427, LootPossibility.VeryRare, 0), new Loot("Boots of Haste", 3079, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData OrcWarlord = new CreatureData("Orc Warlord", 950, 670, 0, 0, 450, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 50), new Loot("Meat", 0, LootPossibility.Normal, 2), new Loot("Fish", 0, LootPossibility.Normal, 2), new Loot("Scimitar", 3307, LootPossibility.Normal, 0), new Loot("Plate Legs", 3557, LootPossibility.Normal, 0), new Loot("Hunting Spear", 3347, LootPossibility.Normal, 0), new Loot("Throwing Stars", 0, LootPossibility.Normal, 22), new Loot("Orcish Axe", 3316, LootPossibility.Normal, 0), new Loot("Brass Legs", 3372, LootPossibility.Normal, 0), new Loot("Brass Armor", 3359, LootPossibility.Normal, 0), new Loot("Plate Armor", 3357, LootPossibility.Normal, 0), new Loot("Protection Amulet", 3084, LootPossibility.Normal, 0), new Loot("Dark Helmet", 3384, LootPossibility.Normal, 0), new Loot("Two-H", 0, LootPossibility.Normal, 0), new Loot("ed Sword", 0, LootPossibility.Normal, 0), new Loot("Dragon Hammer", 3322, LootPossibility.Rare, 0), new Loot("Crusader Helmet", 3391, LootPossibility.Rare, 0), new Loot("Stealth Ring", 3049, LootPossibility.Rare, 0), new Loot("Health Potion", 0, LootPossibility.Rare, 0), new Loot("Orc Trophy", 7395, LootPossibility.VeryRare, 0), new Loot("Golden Ring", 0, LootPossibility.VeryRare, 0), new Loot("Magma Boots", 818, LootPossibility.VeryRare, 0), new Loot("on Thais)", 0, LootPossibility.Normal, 0), new Loot("Amazon Armor", 3394, LootPossibility.Normal, 0), new Loot("on Thais)", 0, LootPossibility.Normal, 0), new Loot("Amazon Shield", 3437, LootPossibility.Normal, 0) }
        );
        ...
        public static CreatureData SeaSerpent = new CreatureData("Sea Serpent", 1950, 2300, 0, 0, 800, false, true, FrontAttack.None,
            ...
            new List<string>() { "CHHHRRRR", "HISSSS", },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 234), new Loot("Dragon Ham", 0, LootPossibility.Normal, 3), new Loot("Viking Helmet", 3367, LootPossibility.Normal, 0), new Loot("Sword", 3264, LootPossibility.Normal, 0), new Loot("Plate Legs", 3557, LootPossibility.Normal, 0), new Loot("Small Sapphire", 3029, LootPossibility.SemiRare, 3), new Loot("Strong Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Strong Mana Potion", 0, LootPossibility.SemiRare, 0), new Loot("Serpent Sword", 3297, LootPossibility.SemiRare, 0), new Loot("Spirit Cloak", 0, LootPossibility.SemiRare, 0), new Loot("Ring of Healing", 3098, LootPossibility.Rare, 0), new Loot("Northwind Rod", 8083, LootPossibility.Rare, 0), new Loot("Great Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Glacier Amulet", 815, LootPossibility.Rare, 0), new Loot("Stealth Ring", 3049, LootPossibility.VeryRare, 0), new Loot("Glacier Kilt", 823, LootPossibility.VeryRare, 0), new Loot("Focus Cape", 8043, LootPossibility.VeryRare, 0), new Loot("Leviathan's Amulet", 0, LootPossibility.VeryRare, 0), new Loot("Crystalline Armor", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Shardhead = new CreatureData("Shardhead", 800, 650, 0, 0, 0, false, false, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Energy, 20) },
            new List<string>() { },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 195), new Loot("Ice Cubes", 0, LootPossibility.Normal, 2), new Loot("Strong Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0), new Loot("Shard", 7290, LootPossibility.Normal, 0) }
        );
        ...
        public static CreatureData Spectre = new CreatureData("Spectre", 1350, 2100, 0, 0, 820, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 300), new Loot("Platinum Coins", 0, LootPossibility.Normal, 7), new Loot("Blank Rune", 0, LootPossibility.Normal, 2), new Loot("S", 0, LootPossibility.Normal, 0), new Loot("als", 0, LootPossibility.Normal, 0), new Loot("Lyre", 0, LootPossibility.Normal, 0), new Loot("W", 0, LootPossibility.Normal, 0), new Loot("of Cosmic Energy", 0, LootPossibility.Normal, 0), new Loot("Soul Orb", 5944, LootPossibility.Normal, 0), new Loot("Demonic Essence", 6499, LootPossibility.SemiRare, 0), new Loot("White Piece of Cloth", 5909, LootPossibility.SemiRare, 0), new Loot("Silver Brooch", 0, LootPossibility.Rare, 0), new Loot("Death Ring", 6299, LootPossibility.Rare, 0), new Loot("Relic Sword", 7383, LootPossibility.Rare, 0), new Loot("Great Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Stealth Ring", 3049, LootPossibility.VeryRare, 0), new Loot("Shadow Sceptre", 7451, LootPossibility.VeryRare, 0), new Loot("Demonbone Amulet", 3019, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData TerrorBird = new CreatureData("Terror Bird", 300, 150, 0, 0, 90, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 30), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Worms", 3492, LootPossibility.Normal, 3), new Loot("Meat", 0, LootPossibility.Normal, 3), new Loot("Seeds", 647, LootPossibility.SemiRare, 0), new Loot("Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Feather Headdress", 3406, LootPossibility.Rare, 0) }
        );
        public static CreatureData Thalas = new CreatureData("Thalas", 4100, 2950, 0, 0, 1400, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 159), new Loot("Small Emerald", 3032, LootPossibility.SemiRare, 3), new Loot("Poison Dagger", 3299, LootPossibility.SemiRare, 0), new Loot("Time Ring", 3053, LootPossibility.SemiRare, 0), new Loot("Stealth Ring", 3049, LootPossibility.Rare, 0), new Loot("Great Health Potion", 0, LootPossibility.Rare, 0), new Loot("Serpent Sword", 3297, LootPossibility.VeryRare, 0), new Loot("Green Gem", 3038, LootPossibility.VeryRare, 0), new Loot("Djinn Blade", 3339, LootPossibility.VeryRare, 0), new Loot("Cobrafang Dagger", 3238, LootPossibility.Always, 0) }
        );
        ...
        public static CreatureData Valkyrie = new CreatureData("Valkyrie", 190, 85, 0, 0, 120, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 12), new Loot("Meat", 0, LootPossibility.Normal, 3), new Loot("Apples", 0, LootPossibility.Normal, 4), new Loot("Skulls", 0, LootPossibility.Normal, 2), new Loot("Dagger", 3267, LootPossibility.Normal, 0), new Loot("Spears", 0, LootPossibility.Normal, 3), new Loot("Chain Helmet", 3352, LootPossibility.Normal, 0), new Loot("Chain Armor", 3358, LootPossibility.Normal, 0), new Loot("Hunting Spear", 3347, LootPossibility.SemiRare, 0), new Loot("Plate Armor", 3357, LootPossibility.SemiRare, 0), new Loot("Crystal Necklace", 3008, LootPossibility.Rare, 0), new Loot("Double Axe", 3275, LootPossibility.Rare, 0), new Loot("Protection Amulet", 3084, LootPossibility.Rare, 0), new Loot("Health Potion", 0, LootPossibility.VeryRare, 0), new Loot("Small Ruby", 3030, LootPossibility.VeryRare, 0), new Loot("Small Diamond", 3028, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Vampire = new CreatureData("Vampire", 475, 305, 0, 0, 300, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 20), new Loot("Bag", 0, LootPossibility.Normal, 0), new Loot("Leather Legs", 3559, LootPossibility.Normal, 0), new Loot("Bowl", 0, LootPossibility.Normal, 0), new Loot("Skull", 0, LootPossibility.Normal, 0), new Loot("Grave Flower", 3661, LootPossibility.Normal, 0), new Loot("Katana", 3300, LootPossibility.Normal, 0), new Loot("Bronze Amulet", 3056, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Black Pearl", 3027, LootPossibility.SemiRare, 0), new Loot("Strange Helmet", 0, LootPossibility.Rare, 0), new Loot("Spike Sword", 0, LootPossibility.Rare, 0), new Loot("Ice Rapier", 3284, LootPossibility.Rare, 0), new Loot("Emerald Bangle", 3010, LootPossibility.Rare, 0), new Loot("Vampire Shield", 3434, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData VampireBride = new CreatureData("Vampire Bride", 1200, 1050, 0, 0, 670, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 130), new Loot("Platinum Coin", 3035, LootPossibility.Normal, 0), new Loot("Strong Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Moonlight Rod", 3070, LootPossibility.Rare, 0), new Loot("Small Diamond", 3028, LootPossibility.Rare, 2), new Loot("Emerald Bangle", 3010, LootPossibility.Rare, 0), new Loot("Hibiscus Dress", 8045, LootPossibility.Rare, 0), new Loot("Rusty Armor", 0, LootPossibility.Normal, 0), new Loot("Velvet Tapestry", 0, LootPossibility.Rare, 0), new Loot("Flower Bouquet", 649, LootPossibility.Rare, 0), new Loot("Mysterious Voodoo Skull", 5668, LootPossibility.VeryRare, 0), new Loot("Boots of Haste", 3079, LootPossibility.VeryRare, 0), new Loot("Blood Goblet", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Vashresamun = new CreatureData("Vashresamun", 4000, 2950, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 235), new Loot("White Pearl", 3026, LootPossibility.Normal, 0), new Loot("Lute", 2950, LootPossibility.Normal, 0), new Loot("Great Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Blue Robe", 3567, LootPossibility.SemiRare, 0), new Loot("Crystal Ring", 3007, LootPossibility.Rare, 0), new Loot("Panpipes", 0, LootPossibility.Rare, 0), new Loot("Crystal Mace", 3333, LootPossibility.VeryRare, 0), new Loot("Ancient Tiara", 3022, LootPossibility.VeryRare, 0), new Loot("Blue Note", 0, LootPossibility.Always, 0) }
        );
        ...
        public static CreatureData WarGolem = new CreatureData("War Golem", 4300, 2750, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 170), new Loot("Nails", 0, LootPossibility.Normal, 5), new Loot("Two H", 0, LootPossibility.Normal, 0), new Loot("ed Sword", 0, LootPossibility.Normal, 0), new Loot("Plate Shield", 3410, LootPossibility.Normal, 0), new Loot("Morning Star", 3282, LootPossibility.Normal, 0), new Loot("Battle Shield", 3413, LootPossibility.Normal, 0), new Loot("Ultimate Health Potion", 0, LootPossibility.Normal, 0), new Loot("Great Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Iron Ore", 5880, LootPossibility.SemiRare, 0), new Loot("Berserk Potion", 0, LootPossibility.SemiRare, 0), new Loot("Epee", 0, LootPossibility.SemiRare, 0), new Loot("Rusty Armor", 0, LootPossibility.Normal, 0), new Loot("Club Ring", 3093, LootPossibility.Rare, 0), new Loot("Dwarven Ring", 3097, LootPossibility.Rare, 0), new Loot("Crystal Pedestal", 0, LootPossibility.Rare, 0), new Loot("Crystal of Power", 9067, LootPossibility.VeryRare, 0), new Loot("Lightning Boots", 820, LootPossibility.VeryRare, 0), new Loot("Steel Boots", 3554, LootPossibility.VeryRare, 0), new Loot("Berserker", 0, LootPossibility.VeryRare, 0), new Loot("Jade Hammer", 0, LootPossibility.VeryRare, 0), new Loot("Bonebreaker", 0, LootPossibility.VeryRare, 0), new Loot("Life Crystal", 3061, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData WarWolf = new CreatureData("War Wolf", 140, 55, 0, 0, 50, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Meat", 0, LootPossibility.Normal, 4), new Loot("Ham", 0, LootPossibility.Normal, 2), new Loot("Wolf Paw", 5897, LootPossibility.Rare, 0), new Loot("Wolf Trophy", 7394, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Warlock = new CreatureData("Warlock", 3500, 4000, 0, 0, 0, false, true, FrontAttack.Beam,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 150), new Loot("Cherries", 0, LootPossibility.Normal, 5), new Loot("Bread", 0, LootPossibility.Normal, 0), new Loot("C", 0, LootPossibility.Normal, 0), new Loot("lestick", 0, LootPossibility.Normal, 0), new Loot("Crystal Ring", 3007, LootPossibility.Normal, 0), new Loot("Dark Mushroom", 0, LootPossibility.Normal, 0), new Loot("Energy Ring", 3051, LootPossibility.Normal, 0), new Loot("Inkwell", 3509, LootPossibility.Normal, 0), new Loot("Mind Stone", 0, LootPossibility.Normal, 0), new Loot("Poison Dagger", 3299, LootPossibility.Normal, 0), new Loot("Skull Staff", 3324, LootPossibility.Normal, 0), new Loot("Talon", 3034, LootPossibility.Normal, 0), new Loot("Great Health Potion", 0, LootPossibility.Normal, 0), new Loot("Great Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Blue Robe", 3567, LootPossibility.SemiRare, 0), new Loot("Assassin Star", 7368, LootPossibility.SemiRare, 4), new Loot("Small Sapphire", 3029, LootPossibility.SemiRare, 0), new Loot("Red Tome", 2852, LootPossibility.Rare, 0), new Loot("Ring of the Sky", 0, LootPossibility.Rare, 0), new Loot("Stone Skin Amulet", 3081, LootPossibility.Rare, 0), new Loot("Lightning Robe", 825, LootPossibility.VeryRare, 0), new Loot("Lightning Legs", 822, LootPossibility.VeryRare, 0), new Loot("Golden Armor", 3360, LootPossibility.VeryRare, 0), new Loot("Piggy Bank", 2995, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData WarlordRuzad = new CreatureData("Warlord Ruzad", 2500, 1700, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Death, 10), new DamageModifier(DamageType.Earth, 10) },
            new List<string>() { },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 59), new Loot("Meat", 0, LootPossibility.Normal, 0), new Loot("Fish", 0, LootPossibility.Normal, 0), new Loot("Scimitar", 3307, LootPossibility.Normal, 0), new Loot("Brass Legs", 3372, LootPossibility.Normal, 0), new Loot("Plate Legs", 3557, LootPossibility.Normal, 0), new Loot("Orcish Axe", 3316, LootPossibility.Normal, 0), new Loot("Protection Amulet", 3084, LootPossibility.Normal, 0), new Loot("Plate Armor", 3357, LootPossibility.Normal, 0) }
        );
        ...
        public static CreatureData WaterElemental = new CreatureData("Water Elemental", 550, 650, 0, 0, 560, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 0), new Loot("Platinum Coin", 3035, LootPossibility.Normal, 0), new Loot("Sword", 3264, LootPossibility.Normal, 0), new Loot("Steel Shield", 3409, LootPossibility.Normal, 0), new Loot("Worn Leather Boots", 0, LootPossibility.Normal, 0), new Loot("Fishbone", 0, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0), new Loot("Strong Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Rusty Legs", 0, LootPossibility.SemiRare, 0), new Loot("Rusty Armor", 0, LootPossibility.SemiRare, 0), new Loot("Life Ring", 3052, LootPossibility.SemiRare, 0), new Loot("Small Emerald", 3032, LootPossibility.SemiRare, 0), new Loot("Small Sapphire", 3029, LootPossibility.SemiRare, 0), new Loot("Energy Ring", 3051, LootPossibility.Rare, 0), new Loot("Giant Shimmering Pearl", 0, LootPossibility.Rare, 0), new Loot("Goldfish Bowl", 0, LootPossibility.VeryRare, 0), new Loot("Leviathan's Amulet", 0, LootPossibility.VeryRare, 0) }
        );
        ...
        public static CreatureData Werewolf = new CreatureData("Werewolf", 1955, 1900, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 225), new Loot("Mace", 3286, LootPossibility.Normal, 0), new Loot("Plate Shield", 3410, LootPossibility.Normal, 0), new Loot("Halberd", 3269, LootPossibility.SemiRare, 0), new Loot("Troll Green", 0, LootPossibility.SemiRare, 0), new Loot("Wolf Paw", 5897, LootPossibility.SemiRare, 0), new Loot("Great Health Potion", 0, LootPossibility.Rare, 0), new Loot("Plate Legs", 3557, LootPossibility.Rare, 0), new Loot("Rusty Armor", 0, LootPossibility.Normal, 0), new Loot("Stone Skin Amulet", 3081, LootPossibility.Rare, 0), new Loot("Strong Health Potion", 0, LootPossibility.Rare, 0), new Loot("Time Ring", 3053, LootPossibility.Rare, 0), new Loot("Ultimate Health Potion", 0, LootPossibility.Rare, 0), new Loot("Berserk Potion", 0, LootPossibility.VeryRare, 0), new Loot("Epee", 0, LootPossibility.VeryRare, 0), new Loot("Dreaded Cleaver", 7419, LootPossibility.VeryRare, 0), new Loot("Relic Sword", 7383, LootPossibility.VeryRare, 0), new Loot("Platinum Amulet", 3055, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData WildWarrior = new CreatureData("Wild Warrior", 135, 60, 0, 0, 70, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 30), new Loot("Meat", 0, LootPossibility.Normal, 0), new Loot("Axe", 3274, LootPossibility.Normal, 0), new Loot("Mace", 3286, LootPossibility.Normal, 0), new Loot("Brass Shield", 3411, LootPossibility.Normal, 0), new Loot("Leather Legs", 3559, LootPossibility.Normal, 0), new Loot("Chain Helmet", 3352, LootPossibility.Normal, 0), new Loot("Iron Helmet", 3353, LootPossibility.Rare, 0), new Loot("Brass Armor", 3359, LootPossibility.Rare, 0), new Loot("Steel Shield", 3409, LootPossibility.VeryRare, 0), new Loot("Doll", 0, LootPossibility.VeryRare, 0), new Loot("War Hammer", 3279, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData WinterWolf = new CreatureData("Winter Wolf", 30, 20, 0, 0, 20, false, false, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Death, 1), new DamageModifier(DamageType.Energy, 1) },
            new List<string>() { },
            new List<Loot>() { new Loot("Meat", 0, LootPossibility.Normal, 2) }
        );
        public static CreatureData Wisp = new CreatureData("Wisp", 115, 0, 0, 0, 7, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Moon Backpack", 9604, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Witch = new CreatureData("Witch", 300, 120, 0, 0, 115, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 10), new Loot("Cookies", 0, LootPossibility.Normal, 8), new Loot("Wolf Tooth Chain", 3012, LootPossibility.Normal, 0), new Loot("Sickle", 3293, LootPossibility.Normal, 0), new Loot("Broom", 0, LootPossibility.Normal, 0), new Loot("Leather Boots", 3552, LootPossibility.Normal, 0), new Loot("Coat", 0, LootPossibility.Normal, 0), new Loot("Cape", 0, LootPossibility.Normal, 0), new Loot("Cheese", 0, LootPossibility.Normal, 0), new Loot("Star Herb", 0, LootPossibility.Normal, 0), new Loot("Garlic Necklace", 3083, LootPossibility.Rare, 0), new Loot("Silver Dagger", 3290, LootPossibility.Rare, 0), new Loot("Necrotic Rod", 3069, LootPossibility.Rare, 0), new Loot("Fern", 0, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Wolf = new CreatureData("Wolf", 25, 18, 0, 0, 19, false, false, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Death, 1), new DamageModifier(DamageType.Ice, 1) },
            new List<string>() { "Yoooohhuuuu!", "Grrrrrrr", },
            new List<Loot>() { new Loot("Meat", 0, LootPossibility.Normal, 2), new Loot("Worm", 0, LootPossibility.Normal, 0), new Loot("Wolf Paw", 5897, LootPossibility.Rare, 0) }
        );
        public static CreatureData WorkerGolem = new CreatureData("Worker Golem", 1470, 1250, 0, 0, 361, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 131), new Loot("Nails", 0, LootPossibility.Normal, 5), new Loot("Small Diamond", 3028, LootPossibility.SemiRare, 3), new Loot("Great Health Potion", 0, LootPossibility.SemiRare, 0), new Loot("Great Spirit Potion", 0, LootPossibility.SemiRare, 0), new Loot("Great Mana Potion", 0, LootPossibility.SemiRare, 0), new Loot("Berserk Potion", 0, LootPossibility.SemiRare, 0), new Loot("Rusty Armor", 0, LootPossibility.Normal, 0), new Loot("Rusty Legs", 0, LootPossibility.Normal, 0), new Loot("Iron Ore", 5880, LootPossibility.Rare, 0), new Loot("Life Crystal", 3061, LootPossibility.Rare, 0), new Loot("War Hammer", 3279, LootPossibility.Rare, 0), new Loot("Crystal Pedestal", 0, LootPossibility.Rare, 0), new Loot("Spiked Squelcher", 0, LootPossibility.Rare, 0), new Loot("Gear Wheel", 0, LootPossibility.VeryRare, 2), new Loot("Might Ring", 3048, LootPossibility.VeryRare, 0), new Loot("Bonebreaker", 0, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Wyrm = new CreatureData("Wyrm", 1825, 1550, 0, 0, 500, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 0), new Loot("Burst Arrows", 0, LootPossibility.Normal, 10), new Loot("Dragon Hams", 0, LootPossibility.Normal, 3), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0), new Loot("Strong Mana Potion", 0, LootPossibility.Normal, 0), new Loot("Crossbow", 3349, LootPossibility.Normal, 0), new Loot("Steel Helmet", 3351, LootPossibility.Normal, 0), new Loot("Plate Legs", 3557, LootPossibility.Normal, 0), new Loot("Small Diamonds", 0, LootPossibility.SemiRare, 3), new Loot("W", 0, LootPossibility.Normal, 0), new Loot("of Draconia", 0, LootPossibility.SemiRare, 0), new Loot("Lightning Pendant", 816, LootPossibility.Rare, 0), new Loot("Focus Cape", 8043, LootPossibility.Rare, 0), new Loot("W", 0, LootPossibility.Normal, 0), new Loot("of Starstorm", 0, LootPossibility.Rare, 0), new Loot("Hibiscus Dress", 8045, LootPossibility.Rare, 0), new Loot("Shockwave Amulet", 0, LootPossibility.VeryRare, 0), new Loot("Dragonbone Staff", 7430, LootPossibility.VeryRare, 0), new Loot("Composite Hornbow", 8027, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Wyvern = new CreatureData("Wyvern", 795, 515, 0, 0, 140, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 75), new Loot("Dragon Ham", 0, LootPossibility.Normal, 3), new Loot("Gemmed Book", 0, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0), new Loot("Bag", 0, LootPossibility.SemiRare, 0), new Loot("Power Bolt", 3450, LootPossibility.SemiRare, 2), new Loot("Emerald Bangle", 3010, LootPossibility.SemiRare, 0), new Loot("W", 0, LootPossibility.Normal, 0), new Loot("of Inferno", 0, LootPossibility.Rare, 0), new Loot("Small Sapphire", 3029, LootPossibility.Rare, 0), new Loot("Wyvern Fang", 7408, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData Xenia = new CreatureData("Xenia", 200, 255, 0, 0, 0, false, false, FrontAttack.None,
            ...
            new List<DamageModifier>() { },
            new List<string>() { },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 44), new Loot("Sabre", 3273, LootPossibility.Normal, 0), new Loot("Skull", 0, LootPossibility.Normal, 2), new Loot("Studded Shield", 3426, LootPossibility.Normal, 0) }
        );
        ...
        public static CreatureData Yakchal = new CreatureData("Yakchal", 0, 4400, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 88), new Loot("Blue Piece of Cloth", 5912, LootPossibility.Normal, 0), new Loot("Crystal Sword", 7449, LootPossibility.Normal, 0), new Loot("Life Ring", 3052, LootPossibility.Normal, 0), new Loot("Mastermind Potion", 0, LootPossibility.Normal, 0), new Loot("Berserk Potion", 0, LootPossibility.Normal, 0), new Loot("Bullseye Potion", 0, LootPossibility.Normal, 0), new Loot("Earmuffs", 7459, LootPossibility.Normal, 0), new Loot("Dragon Necklace", 3085, LootPossibility.Normal, 0), new Loot("Glacier Kilt", 823, LootPossibility.Normal, 0), new Loot("Boots of Haste", 3079, LootPossibility.Rare, 0), new Loot("Glacier Robe", 0, LootPossibility.Rare, 0), new Loot("Queen's Sceptre", 0, LootPossibility.Rare, 0), new Loot("Skull Staff", 3324, LootPossibility.Rare, 0), new Loot("Gold Ingot", 9058, LootPossibility.Rare, 0), new Loot("Robe of the Ice Queen", 0, LootPossibility.VeryRare, 0), new Loot("Shard", 7290, LootPossibility.Always, 0) }
        );
        ...
        public static CreatureData Yeti = new CreatureData("Yeti", 950, 460, 0, 0, 555, false, false, FrontAttack.None,
            ...
            new List<DamageModifier>() { new DamageModifier(DamageType.Earth, 1) },
            new List<string>() { "Yooodelaaahooohooo", },
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 100), new Loot("Meat", 0, LootPossibility.Normal, 4), new Loot("Ham", 0, LootPossibility.Normal, 5), new Loot("Snowballs", 0, LootPossibility.Normal, 22), new Loot("Bunnyslippers", 0, LootPossibility.VeryRare, 0) }
        );
        public static CreatureData YoungSeaSerpent = new CreatureData("Young Sea Serpent", 1050, 1000, 0, 0, 600, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 162), new Loot("Dragon Ham", 0, LootPossibility.Normal, 2), new Loot("Meat", 0, LootPossibility.Normal, 4), new Loot("Small Sapphire", 3029, LootPossibility.SemiRare, 0), new Loot("Dark Armor", 3383, LootPossibility.SemiRare, 0), new Loot("Stealth Ring", 3049, LootPossibility.Rare, 0), new Loot("Strong Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Rusty Armor", 0, LootPossibility.Normal, 2), new Loot("Battle Axe", 3266, LootPossibility.Normal, 0), new Loot("Battle Hammer", 3305, LootPossibility.Normal, 0), new Loot("Morning Star", 3282, LootPossibility.Normal, 0), new Loot("Life Crystal", 3061, LootPossibility.Normal, 0) }
        );
        public static CreatureData Zarabustor = new CreatureData("Zarabustor", 5100, 8000, 0, 0, 0, false, true, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 150), new Loot("Small Sapphire", 3029, LootPossibility.Normal, 2), new Loot("Assassin Star", 7368, LootPossibility.Normal, 1), new Loot("Poison Dagger", 3299, LootPossibility.Normal, 0), new Loot("Blue Robe", 3567, LootPossibility.Normal, 0), new Loot("Might Ring", 3048, LootPossibility.Normal, 0), new Loot("Skull Staff", 3324, LootPossibility.Normal, 0), new Loot("Golden Armor", 3360, LootPossibility.Normal, 0), new Loot("Lightning Legs", 822, LootPossibility.Normal, 0), new Loot("Spellbook of Mind Control", 8074, LootPossibility.Normal, 0) }
        );
        public static CreatureData ZevelonDuskbringer = new CreatureData("Zevelon Duskbringer", 1400, 1800, 0, 0, 0, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 75), new Loot("Platinum Coin", 3035, LootPossibility.Normal, 5), new Loot("Black Pearl", 3027, LootPossibility.Normal, 0), new Loot("Strong Health Potion", 0, LootPossibility.Normal, 0), new Loot("Ring of Healing", 3098, LootPossibility.Normal, 0), new Loot("Vampire Shield", 3434, LootPossibility.VeryRare, 0), new Loot("Vampire Lord Token", 8192, LootPossibility.Always, 0) }
        );
        public static CreatureData Zombie = new CreatureData("Zombie", 500, 280, 0, 0, 203, false, false, FrontAttack.None,
            ...
            new List<Loot>() { new Loot("Gold Coin", 3031, LootPossibility.Normal, 64), new Loot("Mace", 3286, LootPossibility.Normal, 0), new Loot("Torch", 0, LootPossibility.Normal, 0), new Loot("Brass Helmet", 3354, LootPossibility.Normal, 0), new Loot("Halberd", 3269, LootPossibility.Normal, 0), new Loot("Rotten Meat", 0, LootPossibility.Normal, 0), new Loot("Steel Helmet", 3351, LootPossibility.Normal, 0), new Loot("Battle Hammer", 3305, LootPossibility.Normal, 0), new Loot("Rusty Armor", 0, LootPossibility.Normal, 0), new Loot("Mana Potion", 0, LootPossibility.Rare, 0), new Loot("Simple Dress", 0, LootPossibility.Rare, 0), new Loot("Life Ring", 3052, LootPossibility.Normal, 0) }
        );
