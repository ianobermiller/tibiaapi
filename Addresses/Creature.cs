namespace Tibia.Addresses
{
    ...
    public static class Creature
    {
        ...
        public static uint DistanceMountId = 120; // 8.70
        public static uint DistanceLight = 120;
        public static uint DistanceLightColor = 124;
        public static uint DistanceBlackSquare = 132;
        public static uint DistanceHPBar = 136;
        public static uint DistanceWalkSpeed = 140;
        public static uint DistanceIsVisible = 144;
        public static uint DistanceSkull = 148;
        public static uint DistanceParty = 152;
        public static uint DistanceWarIcon = 160;
        public static uint DistanceIsBlocking = 164;
    }
}
