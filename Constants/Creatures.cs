...
namespace Tibia.Constants {
  public static class Creatures {
      ...
      public static CreatureData AcolyteofDarkness = new CreatureData("Acolyte of Darkness", 325, 200, 0, 0, 120, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Death, DamageType.Fire, DamageType.Earth, DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  10), new DamageModifier(DamageType.Drown,  99)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  5), new DamageModifier(DamageType.Holy,  5) },
          new List<string>() { },
      ...
      public static CreatureData AcolyteoftheCult = new CreatureData("Acolyte of the Cult", 390, 300, 0, 0, 220, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  40), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Orange Book",  0,  LootPossibility.Rare,  0), new Loot("Dragon Necklace",  3085,  LootPossibility.Rare,  0), new Loot("Music Sheet",  0,  LootPossibility.Normal,  0), new Loot("rare)",  0,  LootPossibility.Normal,  0), new Loot("Life Ring",  3052,  LootPossibility.Rare,  0), new Loot("Small Emerald",  3032,  LootPossibility.Rare,  0), new Loot("Terra Rod",  3065,  LootPossibility.Rare,  0), new Loot("Green Tunic",  0,  LootPossibility.Rare,  0), new Loot("Pirate Voodoo Doll",  0,  LootPossibility.Rare,  0), new Loot("Key Ring",  5801,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData AdeptoftheCult = new CreatureData("Adept of the Cult", 430, 400, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  57), new Loot("Clerical Mace",  3311,  LootPossibility.SemiRare,  0), new Loot("Pirate Voodoo Doll",  0,  LootPossibility.SemiRare,  0), new Loot("Orange Book",  0,  LootPossibility.Rare,  0), new Loot("Time Ring",  3053,  LootPossibility.Rare,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Rare,  0), new Loot("Small Ruby",  3030,  LootPossibility.Rare,  0), new Loot("Music Sheet",  0,  LootPossibility.Normal,  0), new Loot("rare)",  0,  LootPossibility.Normal,  0), new Loot("Hailstorm Rod",  3067,  LootPossibility.Rare,  0), new Loot("Amber Staff",  7426,  LootPossibility.Rare,  0), new Loot("Red Robe",  3566,  LootPossibility.VeryRare,  0), new Loot("Key Ring",  5801,  LootPossibility.VeryRare,  0), new Loot("Lunar Staff",  7424,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Amazon = new CreatureData("Amazon", 110, 60, 0, 0, 45, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Skull",  0,  LootPossibility.Normal,  2), new Loot("Dagger",  3267,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Brown Bread",  0,  LootPossibility.Normal,  0), new Loot("Leather Armor",  3361,  LootPossibility.Normal,  0), new Loot("Studded Shield",  3426,  LootPossibility.SemiRare,  0), new Loot("Crystal Necklace",  3008,  LootPossibility.Rare,  0), new Loot("Small Ruby",  3030,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData AncientScarab = new CreatureData("Ancient Scarab", 1000, 720, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  230), new Loot("Scarab Coin",  3042,  LootPossibility.Normal,  4), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.SemiRare,  4), new Loot("Ancient Amulet",  3025,  LootPossibility.SemiRare,  0), new Loot("Scarab Amulet",  3018,  LootPossibility.Rare,  0), new Loot("Small Emerald",  3032,  LootPossibility.Rare,  3), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Daramanian Waraxe",  0,  LootPossibility.VeryRare,  0), new Loot("Scarab Shield",  3440,  LootPossibility.VeryRare,  0), new Loot("Terra Hood",  830,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Annihilon = new CreatureData("Annihilon", 40000, 15000, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  159), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  24), new Loot("Gold Ingots",  0,  LootPossibility.Normal,  0), new Loot("Mastermind Potions",  0,  LootPossibility.Normal,  2), new Loot("Viper Star",  7366,  LootPossibility.Normal,  29), new Loot("Small Amethysts",  0,  LootPossibility.Normal,  20), new Loot("Berserk Potions",  0,  LootPossibility.Normal,  2), new Loot("Infernal Bolts",  0,  LootPossibility.Normal,  49), new Loot("Power Bolts",  0,  LootPossibility.Normal,  82), new Loot("Flaming Arrows",  0,  LootPossibility.Normal,  99), new Loot("Demon Horns",  0,  LootPossibility.Normal,  2), new Loot("Giant Shimmering Pearl",  0,  LootPossibility.Normal,  4), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Guardian Shield",  0,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Guardian Halberd",  3315,  LootPossibility.Normal,  0), new Loot("Violet Gem",  3036,  LootPossibility.Normal,  0), new Loot("Green Gem",  3038,  LootPossibility.Normal,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Normal,  0), new Loot("Emerald Bangle",  3010,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Diamond Sceptre",  7387,  LootPossibility.Normal,  0), new Loot("Red Gem",  3039,  LootPossibility.Normal,  0), new Loot("Yellow Gem",  3037,  LootPossibility.Normal,  0), new Loot("Blue Gem",  3041,  LootPossibility.Normal,  0), new Loot("Demon Shield",  3420,  LootPossibility.Normal,  0), new Loot("Mastermind Shield",  3414,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Tower Shield",  3428,  LootPossibility.Normal,  0), new Loot("Paladin Armor",  0,  LootPossibility.Normal,  0), new Loot("Heavy Mace",  3340,  LootPossibility.Normal,  0), new Loot("Skullcracker Armor",  8061,  LootPossibility.Rare,  0), new Loot("Demonbone",  0,  LootPossibility.VeryRare,  0), new Loot("Onyx Flail",  0,  LootPossibility.VeryRare,  0), new Loot("Obsidian Truncheon",  8100,  LootPossibility.Rare,  0), new Loot("The Stomper",  0,  LootPossibility.VeryRare,  0), new Loot("Lavos Armor",  8049,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData ArachirtheAncientOne = new CreatureData("Arachir the Ancient One", 0, 1800, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coins",  0,  LootPossibility.Normal,  98), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  5), new Loot("Black Pearls",  0,  LootPossibility.Normal,  1), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Normal,  0), new Loot("Bloody Edge",  0,  LootPossibility.Rare,  0), new Loot("Vampire Lord Token",  8192,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData Arthei = new CreatureData("Arthei", 0, 4000, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Normal,  0), new Loot("Dreaded Cleaver",  7419,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Ashmunrah = new CreatureData("Ashmunrah", 5000, 3100, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  140), new Loot("Silver Brooch",  0,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Rare,  0), new Loot("Might Ring",  3048,  LootPossibility.Rare,  0), new Loot("Crown Armor",  3381,  LootPossibility.Rare,  0), new Loot("Holy Scarab",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Assassin = new CreatureData("Assassin", 175, 105, 0, 0, 160, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  50), new Loot("Throwing Star",  3287,  LootPossibility.Normal,  14), new Loot("Torch",  0,  LootPossibility.Normal,  2), new Loot("Knife",  3291,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Combat Knife",  3292,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.SemiRare,  0), new Loot("Viper Star",  7366,  LootPossibility.SemiRare,  8), new Loot("Leopard Armor",  3404,  LootPossibility.Rare,  0), new Loot("Small Diamond",  3028,  LootPossibility.VeryRare,  2), new Loot("Horseman Helmet",  3405,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Badger = new CreatureData("Badger", 23, 5, 0, 0, 12, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("worm",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Bandit = new CreatureData("Bandit", 245, 65, 0, 0, 43, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  28), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Brass Shield",  3411,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.SemiRare,  0), new Loot("Iron Helmet",  3353,  LootPossibility.SemiRare,  0), new Loot("War Hammer",  3279,  LootPossibility.Rare,  0)}
      );
      public static CreatureData BaneofLight = new CreatureData("Bane of Light", 0, 450, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Death, DamageType.Ice, DamageType.Earth, DamageType.Drown, DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  35), new DamageModifier(DamageType.Energy,  5)},
      ...
      public static CreatureData Banshee = new CreatureData("Banshee", 1000, 900, 0, 0, 652, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("C",  0,  LootPossibility.Normal,  0), new Loot("lestick",  0,  LootPossibility.Normal,  0), new Loot("Simple Dress",  0,  LootPossibility.Normal,  0), new Loot("Dirty Cape",  0,  LootPossibility.Normal,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Normal,  0), new Loot("Mirror",  0,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.SemiRare,  0), new Loot("Poison Dagger",  3299,  LootPossibility.Rare,  0), new Loot("Silver Brooch",  0,  LootPossibility.Rare,  0), new Loot("Stone Skin Amulet",  3081,  LootPossibility.Rare,  0), new Loot("Lyre",  0,  LootPossibility.Rare,  0), new Loot("Spellbook",  648,  LootPossibility.Rare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Rare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("Blue Robe",  3567,  LootPossibility.Rare,  0), new Loot("White Pearl",  3026,  LootPossibility.VeryRare,  0), new Loot("Terra Mantle",  811,  LootPossibility.VeryRare,  0), new Loot("Wedding Ring",  3004,  LootPossibility.VeryRare,  0), new Loot("Life Crystal",  3061,  LootPossibility.VeryRare,  0), new Loot("Red Robe",  3566,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData BarbarianBloodwalker = new CreatureData("Barbarian Bloodwalker", 305, 195, 0, 0, 200, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  1), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Battle Axe",  3266,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.SemiRare,  0), new Loot("Beastslayer Axe",  0,  LootPossibility.Rare,  0), new Loot("Fur Boots",  7457,  LootPossibility.Rare,  0), new Loot("Red Piece of Cloth",  5911,  LootPossibility.VeryRare,  0), new Loot("Shard",  7290,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData BarbarianBrutetamer = new CreatureData("Barbarian Brutetamer", 145, 90, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Corncob",  0,  LootPossibility.Normal,  2), new Loot("Ham",  0,  LootPossibility.Normal,  3), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Grey Small Book",  0,  LootPossibility.Normal,  0), new Loot("Staff",  3289,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Hunting Spear",  3347,  LootPossibility.Normal,  0), new Loot("Mana Potion",  268,  LootPossibility.SemiRare,  0), new Loot("Brutetamer's Staff",  0,  LootPossibility.Rare,  0), new Loot("Fur Boots",  7457,  LootPossibility.Rare,  0), new Loot("Mammoth Fur Shorts",  7464,  LootPossibility.VeryRare,  0), new Loot("Mammoth Fur Cape",  7463,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData BarbarianHeadsplitter = new CreatureData("Barbarian Headsplitter", 100, 85, 0, 0, 110, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Viking Helmet",  3367,  LootPossibility.Normal,  0), new Loot("Knife",  3291,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Brown Piece of Cloth",  5913,  LootPossibility.SemiRare,  0), new Loot("Scale Armor",  3377,  LootPossibility.SemiRare,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0), new Loot("Krimhorn Helmet",  7461,  LootPossibility.Rare,  0), new Loot("Crystal Sword",  7449,  LootPossibility.Rare,  0), new Loot("Fur boots",  7457,  LootPossibility.Normal,  0)}
      );
      public static CreatureData BarbarianSkullhunter = new CreatureData("Barbarian Skullhunter", 135, 85, 0, 0, 65, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Viking Helmet",  3367,  LootPossibility.Normal,  0), new Loot("Knife",  3291,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Brown Piece of Cloth",  5913,  LootPossibility.SemiRare,  0), new Loot("Scale Armor",  3377,  LootPossibility.SemiRare,  0), new Loot("Life Ring",  3052,  LootPossibility.Rare,  0), new Loot("Ragnir Helmet",  0,  LootPossibility.VeryRare,  0), new Loot("Crystal Sword",  7449,  LootPossibility.VeryRare,  0), new Loot("Fur Boots",  7457,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData BaronBrute = new CreatureData("Baron Brute", 0, 3900, 0, 0, 474, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  80)},
          new List<DamageModifier>() {  },
          new List<string>() { "Mash'n!",  },
          new List<Loot>() { new Loot("Unknown",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData BattlemasterZunzu = new CreatureData("Battlemaster Zunzu", 5000, 2500, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  15), new DamageModifier(DamageType.Death,  10), new DamageModifier(DamageType.Fire,  25), new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  15)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  136), new Loot("Small Emerald",  3032,  LootPossibility.Normal,  10), new Loot("Zaogun Flag",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Legs",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.Rare,  0), new Loot("Zaoan Armor",  0,  LootPossibility.Rare,  0), new Loot("Zaogun's Shoulderplates",  0,  LootPossibility.Always,  0), new Loot("Red Lantern",  0,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData Bear = new CreatureData("Bear", 80, 23, 0, 0, 25, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Ham",  0,  LootPossibility.Normal,  3), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Worms",  3492,  LootPossibility.SemiRare,  3), new Loot("Bear Paw",  5896,  LootPossibility.Rare,  0), new Loot("Honeycomb",  0,  LootPossibility.Rare,  0), new Loot("Bag",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Behemoth = new CreatureData("Behemoth", 4000, 2500, 0, 0, 630, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  140), new Loot("Meat",  0,  LootPossibility.Normal,  6), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Crowbar",  3304,  LootPossibility.Normal,  0), new Loot("Pick",  3456,  LootPossibility.Normal,  0), new Loot("Amphora",  0,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Assassin Stars",  0,  LootPossibility.Normal,  2), new Loot("Dark Armor",  3383,  LootPossibility.SemiRare,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.SemiRare,  0), new Loot("Plate Armor",  3357,  LootPossibility.SemiRare,  0), new Loot("Small Amethyst",  3033,  LootPossibility.SemiRare,  4), new Loot("Giant Sword",  3281,  LootPossibility.Rare,  0), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Perfect Behemoth Fang",  0,  LootPossibility.Rare,  0), new Loot("Strange Symbol",  0,  LootPossibility.Rare,  0), new Loot("War Axe",  3342,  LootPossibility.Rare,  0), new Loot("Crystal Necklace",  3008,  LootPossibility.VeryRare,  0), new Loot("Behemoth Claw",  5930,  LootPossibility.VeryRare,  0), new Loot("Behemoth Trophy",  0,  LootPossibility.VeryRare,  0), new Loot("Steel Boots",  3554,  LootPossibility.VeryRare,  0), new Loot("Titan Axe",  7413,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Beholder = new CreatureData("Beholder", 260, 170, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  60), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Wooden Shield",  3412,  LootPossibility.Normal,  0), new Loot("Spellbook",  648,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.SemiRare,  0), new Loot("Two H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.SemiRare,  0), new Loot("Beholder Eye",  5898,  LootPossibility.Rare,  0), new Loot("Mana Potion",  268,  LootPossibility.Rare,  0), new Loot("Terra Rod",  3065,  LootPossibility.Rare,  0), new Loot("Beholder Shield",  3418,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData BetrayedWraith = new CreatureData("Betrayed Wraith", 4200, 3500, 0, 0, 450, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  302), new Loot("Onyx Arrow",  7365,  LootPossibility.Normal,  1), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  4), new Loot("Sniper Arrows",  0,  LootPossibility.Normal,  5), new Loot("Orichalcum Pearls",  0,  LootPossibility.Normal,  2), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Normal,  0), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Fishbone",  0,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  0), new Loot("Spike Sword",  0,  LootPossibility.SemiRare,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Rare,  0), new Loot("Death Ring",  6299,  LootPossibility.Rare,  0), new Loot("Skull Helmet",  5741,  LootPossibility.Rare,  0), new Loot("Bloody Edge",  0,  LootPossibility.VeryRare,  0), new Loot("Amulet of Loss",  3057,  LootPossibility.Normal,  0), new Loot("not obtainable at PvP-Enforced Worlds)",  0,  LootPossibility.Normal,  0), new Loot("Golden Figurine",  5799,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData BigBossTrolliver = new CreatureData("Big Boss Trolliver", 150, 105, 0, 0, 40, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Spear",  3277,  LootPossibility.Normal,  0), new Loot("Studded Club",  3336,  LootPossibility.Normal,  0)}
      );
      public static CreatureData BlackKnight = new CreatureData("Black Knight", 1800, 1600, 0, 0, 500, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  124), new Loot("Spears",  0,  LootPossibility.Normal,  3), new Loot("Dark Armor",  3383,  LootPossibility.Normal,  0), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("Dark Helmet",  3384,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Rope",  3003,  LootPossibility.Normal,  0), new Loot("Brown Bread",  0,  LootPossibility.Normal,  2), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.Normal,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Knight Axe",  3318,  LootPossibility.SemiRare,  0), new Loot("Warrior Helmet",  3369,  LootPossibility.SemiRare,  0), new Loot("Knight Legs",  3371,  LootPossibility.Rare,  0), new Loot("Ruby Necklace",  3016,  LootPossibility.Rare,  0), new Loot("Knight Armor",  3370,  LootPossibility.Rare,  0), new Loot("Dragon Lance",  3302,  LootPossibility.VeryRare,  0), new Loot("Lightning Legs",  822,  LootPossibility.VeryRare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.VeryRare,  0), new Loot("Boots of Haste",  3079,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData BlackSheep = new CreatureData("Black Sheep", 20, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  4)}
      );
      ...
      public static CreatureData Blightwalker = new CreatureData("Blightwalker", 8900, 5850, 0, 0, 900, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  3), new Loot("Bunches of Wheat",  0,  LootPossibility.Normal,  3), new Loot("Poison Arrows",  0,  LootPossibility.Normal,  9), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Seeds",  647,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Scythe",  3453,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Rare,  0), new Loot("Hailstorm Rod",  3067,  LootPossibility.SemiRare,  0), new Loot("Gold Ring",  3063,  LootPossibility.Rare,  0), new Loot("Terra Legs",  812,  LootPossibility.Rare,  0), new Loot("Terra Mantle",  811,  LootPossibility.Rare,  0), new Loot("Garlic Necklace",  3083,  LootPossibility.VeryRare,  0), new Loot("Amulet of Loss",  3057,  LootPossibility.VeryRare,  0), new Loot("Death Ring",  6299,  LootPossibility.VeryRare,  0), new Loot("Gold Ingot",  9058,  LootPossibility.VeryRare,  0), new Loot("Skull Staff",  3324,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData BloodCrab = new CreatureData("Blood Crab", 290, 160, 0, 0, 110, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("White Pearl",  3026,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData BlueDjinn = new CreatureData("Blue Djinn", 330, 215, 0, 0, 225, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  120), new Loot("Carrot",  0,  LootPossibility.Normal,  0), new Loot("Royal Spear",  7378,  LootPossibility.Normal,  2), new Loot("Small Oil Lamp",  2933,  LootPossibility.Normal,  0), new Loot("Blue Book",  0,  LootPossibility.Normal,  0), new Loot("Mana Potion",  268,  LootPossibility.SemiRare,  0), new Loot("Blue Rose",  3659,  LootPossibility.SemiRare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Rare,  5), new Loot("Blue Piece of Cloth",  5912,  LootPossibility.Rare,  0), new Loot("Mystic Turban",  3574,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData BogRaider = new CreatureData("Bog Raider", 1300, 800, 0, 0, 600, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  129), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  2), new Loot("Great Spirit Potion",  7642,  LootPossibility.Normal,  0), new Loot("Belted Cape",  8044,  LootPossibility.Normal,  0), new Loot("Springsprout Rod",  8084,  LootPossibility.Normal,  0), new Loot("Hibiscus Dress",  8045,  LootPossibility.SemiRare,  0), new Loot("Paladin Armor",  0,  LootPossibility.SemiRare,  0)}
      );
      public static CreatureData Bonebeast = new CreatureData("Bonebeast", 515, 580, 0, 0, 340, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Bone Club",  3337,  LootPossibility.Normal,  0), new Loot("Bone Shield",  3441,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.SemiRare,  0), new Loot("Health Potion",  266,  LootPossibility.SemiRare,  0), new Loot("Green Mushroom",  0,  LootPossibility.Rare,  0), new Loot("Hardened Bone",  5925,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData Boreth = new CreatureData("Boreth", 1400, 1800, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  5), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.SemiRare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.SemiRare,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Rare,  0), new Loot("Hibiscus Dress",  8045,  LootPossibility.Rare,  0), new Loot("Dreaded Cleaver",  7419,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Braindeath = new CreatureData("Braindeath", 1225, 985, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Sniper Arrows",  0,  LootPossibility.Normal,  4), new Loot("Spellbook",  648,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Bone Sword",  3338,  LootPossibility.Normal,  0), new Loot("Clerical Mace",  3311,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Beholder Eye",  5898,  LootPossibility.SemiRare,  0), new Loot("Haunted Blade",  7407,  LootPossibility.Rare,  0), new Loot("Beholder Shield",  3418,  LootPossibility.Normal,  0), new Loot("Beholder Helmet",  3408,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData BrutusBloodbeard = new CreatureData("Brutus Bloodbeard", 1200, 795, 0, 0, 350, false, false, FrontAttack.Wave, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  200), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  0), new Loot("Pirate Backpack",  5926,  LootPossibility.Normal,  0), new Loot("Knight Armor",  3370,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Brutus Bloodbeard's Hat",  0,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData CaptainJones = new CreatureData("Captain Jones", 800, 825, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Crown Legs",  3382,  LootPossibility.Normal,  0), new Loot("Focus Cape",  8043,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Spike Sword",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData CarrionWorm = new CreatureData("Carrion Worm", 145, 70, 0, 0, 45, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  49), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Worms",  3492,  LootPossibility.Normal,  5), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Katana",  3300,  LootPossibility.Normal,  0), new Loot("Copper Shield",  3430,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData CaveRat = new CreatureData("Cave Rat", 30, 10, 0, 0, 10, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  2), new Loot("Worms",  3492,  LootPossibility.Normal,  3), new Loot("Cheese",  0,  LootPossibility.Normal,  0), new Loot("Cookie",  0,  LootPossibility.VeryRare,  0), new Loot("Jacket",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Centipede = new CreatureData("Centipede", 70, 34, 0, 0, 46, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  17), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0)}
      );
      public static CreatureData ChakoyaToolshaper = new CreatureData("Chakoya Toolshaper", 80, 40, 0, 0, 80, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  29), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Fish",  0,  LootPossibility.Normal,  2), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Pick",  3456,  LootPossibility.Normal,  0), new Loot("Bone Shield",  3441,  LootPossibility.Normal,  0), new Loot("Mammoth Whopper",  0,  LootPossibility.SemiRare,  0), new Loot("Ice Cube",  7441,  LootPossibility.Rare,  0), new Loot("Green Perch",  0,  LootPossibility.Rare,  0), new Loot("Northern Pike",  0,  LootPossibility.Rare,  0), new Loot("Rainbow Trout",  0,  LootPossibility.Rare,  0)}
      );
      public static CreatureData ChakoyaTribewarden = new CreatureData("Chakoya Tribewarden", 68, 40, 0, 0, 30, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("meat",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Fish",  0,  LootPossibility.Normal,  3), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Bone Shield",  3441,  LootPossibility.SemiRare,  0), new Loot("Mammoth Whopper",  0,  LootPossibility.SemiRare,  0), new Loot("Ice Cube",  7441,  LootPossibility.Rare,  0), new Loot("Rainbow Trout",  0,  LootPossibility.Rare,  0), new Loot("Green Perch",  0,  LootPossibility.Rare,  0), new Loot("Northern Pike",  0,  LootPossibility.Rare,  0)}
      );
      public static CreatureData ChakoyaWindcaller = new CreatureData("Chakoya Windcaller", 84, 48, 0, 0, 82, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  36), new Loot("Fish",  0,  LootPossibility.Normal,  4), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Bone Shield",  3441,  LootPossibility.SemiRare,  0), new Loot("Ice Cube",  7441,  LootPossibility.Rare,  0), new Loot("Rainbow Trout",  0,  LootPossibility.Rare,  0), new Loot("Northern Pike",  0,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData Chicken = new CreatureData("Chicken", 15, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Worms",  3492,  LootPossibility.Normal,  3), new Loot("Chicken Feather",  5890,  LootPossibility.Normal,  0), new Loot("Egg",  0,  LootPossibility.SemiRare,  0), new Loot("Meat",  0,  LootPossibility.Rare,  2), new Loot("Blue Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Green Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Purple Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Red Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Yellow Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("only during the Easter holiday)",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData ChizzorontheDistorter = new CreatureData("Chizzoron the Distorter", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  10), new DamageModifier(DamageType.Death,  30), new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  20)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Gold Ingot",  9058,  LootPossibility.Normal,  2), new Loot("Lizard Scale",  5881,  LootPossibility.Normal,  0), new Loot("Dragon Scale Mail",  3386,  LootPossibility.SemiRare,  0), new Loot("Crystal Boots",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Cockroach = new CreatureData("Cockroach", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Cockroach Leg",  7882,  LootPossibility.Always,  0)}
      );
      public static CreatureData Coldheart = new CreatureData("Coldheart", 7000, 3500, 0, 0, 0, false, false, FrontAttack.None, 
      ...
      public static CreatureData CountessSorrow = new CreatureData("Countess Sorrow", 0, 13000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0), new Loot("Worn Leather Boots",  0,  LootPossibility.Normal,  0), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Blue Robe",  3567,  LootPossibility.Normal,  0), new Loot("Silver Mace",  3312,  LootPossibility.VeryRare,  0), new Loot("Countess Sorrow's Frozen Tear",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Crab = new CreatureData("Crab", 55, 30, 0, 0, 20, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Energy,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Fish",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Crocodile = new CreatureData("Crocodile", 105, 40, 0, 0, 40, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Crocodile Boots",  3556,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData CryptShambler = new CreatureData("Crypt Shambler", 330, 195, 0, 0, 195, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  55), new Loot("Worms",  3492,  LootPossibility.Normal,  10), new Loot("Rotten Meat",  0,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Iron Helmet",  3353,  LootPossibility.SemiRare,  0), new Loot("Bone Shield",  3441,  LootPossibility.SemiRare,  0), new Loot("Bone Sword",  3338,  LootPossibility.SemiRare,  0), new Loot("Throwing Stars",  0,  LootPossibility.SemiRare,  3), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.SemiRare,  0), new Loot("Small Diamonds",  0,  LootPossibility.Rare,  2)}
      );
      public static CreatureData CrystalSpider = new CreatureData("Crystal Spider", 1250, 900, 0, 0, 358, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  95), new Loot("Sniper Arrow",  7364,  LootPossibility.Normal,  7), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Ice Cube",  7441,  LootPossibility.Normal,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Crystal Sword",  7449,  LootPossibility.SemiRare,  0), new Loot("Glacier Mask",  829,  LootPossibility.SemiRare,  0), new Loot("Shard",  7290,  LootPossibility.SemiRare,  0), new Loot("Time Ring",  3053,  LootPossibility.SemiRare,  0), new Loot("Spider Silk",  5879,  LootPossibility.SemiRare,  0), new Loot("Knight Armor",  3370,  LootPossibility.Rare,  0), new Loot("Knight Legs",  3371,  LootPossibility.Rare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.Rare,  0), new Loot("Sapphire Hammer",  7437,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData CublarcthePlunderer = new CreatureData("Cublarc the Plunderer", 400, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Orcish Axe",  3316,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Cyclops = new CreatureData("Cyclops", 260, 150, 0, 0, 105, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  52), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Ham",  0,  LootPossibility.Normal,  4), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Wolf Tooth Chain",  3012,  LootPossibility.SemiRare,  0), new Loot("Halberd",  3269,  LootPossibility.SemiRare,  0), new Loot("Dark Helmet",  3384,  LootPossibility.VeryRare,  0), new Loot("Club Ring",  3093,  LootPossibility.VeryRare,  0), new Loot("Health Potion",  266,  LootPossibility.VeryRare,  0), new Loot("Cyclops Trophy",  7398,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData CyclopsDrone = new CreatureData("Cyclops Drone", 325, 200, 0, 0, 180, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  24), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.SemiRare,  0), new Loot("Halberd",  3269,  LootPossibility.Rare,  0), new Loot("Cyclops Trophy",  7398,  LootPossibility.Rare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData CyclopsSmith = new CreatureData("Cyclops Smith", 435, 255, 0, 0, 220, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  69), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Heavy Machete",  0,  LootPossibility.Normal,  0), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("Battle Axe",  3266,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Dark Helmet",  3384,  LootPossibility.Rare,  0), new Loot("Cyclops Trophy",  7398,  LootPossibility.Rare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Club Ring",  3093,  LootPossibility.Rare,  0), new Loot("Spiked Squelcher",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Daemon = new CreatureData("Daemon", 3000, 6000, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  350), new Loot("Golden Helmet",  3365,  LootPossibility.Normal,  0), new Loot("Enchanted Plate Armor",  0,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Fire Sword",  3280,  LootPossibility.Normal,  0)}
      );
      public static CreatureData DamagedWorkerGolem = new CreatureData("Damaged Worker Golem", 260, 95, 0, 0, 90, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  86), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Iron Ore",  5880,  LootPossibility.Rare,  0), new Loot("Sword Ring",  3091,  LootPossibility.VeryRare,  0), new Loot("Nails",  0,  LootPossibility.VeryRare,  3)}
      );
      ...
      public static CreatureData DarkMagician = new CreatureData("Dark Magician", 325, 185, 0, 0, 100, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  80), new Loot("Mana Potion",  268,  LootPossibility.Normal,  0), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Normal,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Necrotic Rod",  3069,  LootPossibility.VeryRare,  0), new Loot("Small Enchanted Amethyst",  678,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData DarkTorturer = new CreatureData("Dark Torturer", 7350, 4650, 0, 0, 1300, false, true, FrontAttack.Wave, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  0), new Loot("White Pearl",  3026,  LootPossibility.Normal,  1), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  3), new Loot("Ham",  0,  LootPossibility.Normal,  8), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Death Ring",  6299,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Assassin Star",  7368,  LootPossibility.SemiRare,  2), new Loot("Saw",  0,  LootPossibility.Rare,  0), new Loot("Steel Boots",  3554,  LootPossibility.SemiRare,  0), new Loot("Gold Ingot",  9058,  LootPossibility.Rare,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Rare,  0), new Loot("Orichalcum Pearl",  0,  LootPossibility.Rare,  2), new Loot("Key Ring",  5801,  LootPossibility.VeryRare,  0), new Loot("Cat's Paw",  5479,  LootPossibility.VeryRare,  0), new Loot("Vile Axe",  0,  LootPossibility.VeryRare,  0), new Loot("Butcher's Axe",  0,  LootPossibility.VeryRare,  0), new Loot("Golden Legs",  3364,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Deer = new CreatureData("Deer", 25, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Ham",  0,  LootPossibility.Normal,  2)}
      );
      public static CreatureData Defiler = new CreatureData("Defiler", 3650, 3700, 0, 0, 712, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  280), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  4), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Talon",  3034,  LootPossibility.Normal,  0), new Loot("Small Emeralds",  0,  LootPossibility.SemiRare,  3), new Loot("Small Rubies",  0,  LootPossibility.SemiRare,  2), new Loot("Small Diamond",  3028,  LootPossibility.SemiRare,  1), new Loot("Plate Armor",  3357,  LootPossibility.Rare,  0), new Loot("Death Ring",  6299,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Demodras = new CreatureData("Demodras", 4500, 6000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  290), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  10), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  4), new Loot("Power Bolt",  3450,  LootPossibility.Normal,  5), new Loot("Onyx Arrow",  7365,  LootPossibility.Normal,  6), new Loot("Burst Arrows",  0,  LootPossibility.Normal,  10), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  10), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.Normal,  0), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Normal,  0), new Loot("Fire Sword",  3280,  LootPossibility.Normal,  0), new Loot("Life Crystal",  3061,  LootPossibility.Normal,  0), new Loot("Dragon Hammer",  3322,  LootPossibility.Normal,  0), new Loot("Dragon Shield",  3416,  LootPossibility.Normal,  0), new Loot("Serpent Sword",  3297,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Broadsword",  3301,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Golden Mug",  2903,  LootPossibility.Normal,  0), new Loot("Stuffed Dragon",  5791,  LootPossibility.Normal,  0), new Loot("Tower Shield",  3428,  LootPossibility.Normal,  0), new Loot("Gemmed Book",  0,  LootPossibility.Normal,  0), new Loot("Red Dragon Leather",  5948,  LootPossibility.Normal,  0), new Loot("Red Dragon Scale",  5882,  LootPossibility.Normal,  0), new Loot("Strange Helmet",  0,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Dragonbreath",  0,  LootPossibility.Normal,  0), new Loot("Royal Helmet",  3392,  LootPossibility.Rare,  0), new Loot("Dragon Scale Mail",  3386,  LootPossibility.Rare,  0), new Loot("Dragon Claw",  5919,  LootPossibility.Always,  0)}
      );
      public static CreatureData Demon = new CreatureData("Demon", 8200, 6000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { "Your soul will be mine!",  "CHAMEK ATH UTHUL ARAK!",  "I SMELL FEEEEAAAAAR!",  "Your resistance is futile!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  310), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  1), new Loot("Fire Mushrooms",  0,  LootPossibility.Normal,  6), new Loot("Devil Helmet",  3356,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Golden Sickle",  3306,  LootPossibility.Normal,  0), new Loot("Small Emerald",  3032,  LootPossibility.Normal,  0), new Loot("Fire Axe",  3320,  LootPossibility.SemiRare,  0), new Loot("Giant Sword",  3281,  LootPossibility.SemiRare,  0), new Loot("Great Health Potion",  239,  LootPossibility.SemiRare,  0), new Loot("Great Mana Potion",  238,  LootPossibility.SemiRare,  3), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  3), new Loot("Golden Ring",  0,  LootPossibility.SemiRare,  0), new Loot("Ice Rapier",  3284,  LootPossibility.SemiRare,  0), new Loot("Orb",  0,  LootPossibility.SemiRare,  0), new Loot("Purple Tome",  2848,  LootPossibility.SemiRare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.SemiRare,  0), new Loot("Talon",  3034,  LootPossibility.SemiRare,  0), new Loot("Assassin Stars",  0,  LootPossibility.Rare,  5), new Loot("Demon Horn",  5954,  LootPossibility.Rare,  0), new Loot("Demon Shield",  3420,  LootPossibility.Rare,  0), new Loot("Might Ring",  3048,  LootPossibility.Rare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.SemiRare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("Golden Legs",  3364,  LootPossibility.Rare,  0), new Loot("Mastermind Shield",  3414,  LootPossibility.Rare,  0), new Loot("Demon Trophy",  7393,  LootPossibility.VeryRare,  0), new Loot("Demonrage Sword",  7382,  LootPossibility.VeryRare,  0), new Loot("Magic Plate Armor",  3366,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData DemonSkeleton = new CreatureData("Demon Skeleton", 400, 240, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  25) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  50), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Throwing Star",  3287,  LootPossibility.Normal,  3), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Iron Helmet",  3353,  LootPossibility.Normal,  0), new Loot("Mysterious Fetish",  0,  LootPossibility.Rare,  0), new Loot("Mana Potion",  268,  LootPossibility.Rare,  0), new Loot("Mind Stone",  0,  LootPossibility.Rare,  0), new Loot("Guardian Shield",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Destroyer = new CreatureData("Destroyer", 3700, 2500, 0, 0, 615, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  330), new Loot("Small Amethysts",  0,  LootPossibility.Normal,  2), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  3), new Loot("Meat",  0,  LootPossibility.Normal,  6), new Loot("Burst Arrows",  0,  LootPossibility.Normal,  12), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Crowbar",  3304,  LootPossibility.Normal,  0), new Loot("Dark Armor",  3383,  LootPossibility.Normal,  0), new Loot("Pick",  3456,  LootPossibility.Normal,  0), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Rare,  0), new Loot("Giant Sword",  3281,  LootPossibility.Rare,  0), new Loot("Steel Boots",  3554,  LootPossibility.Rare,  0), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Chaos Mace",  7427,  LootPossibility.Rare,  0), new Loot("Skull Helmet",  5741,  LootPossibility.VeryRare,  0), new Loot("Crystal Necklace",  3008,  LootPossibility.VeryRare,  0), new Loot("Dreaded Cleaver",  7419,  LootPossibility.VeryRare,  0), new Loot("Death Ring",  6299,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData DiabolicImp = new CreatureData("Diabolic Imp", 1950, 2900, 0, 0, 870, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  197), new Loot("Scimitar",  3307,  LootPossibility.Normal,  0), new Loot("Blank Rune",  0,  LootPossibility.Normal,  2), new Loot("Cleaver",  0,  LootPossibility.Normal,  0), new Loot("Pitchfork",  0,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  3), new Loot("Concentrated Demonic Bloods",  0,  LootPossibility.Normal,  2), new Loot("Guardian Shield",  0,  LootPossibility.Normal,  0), new Loot("Platinum Coins",  0,  LootPossibility.SemiRare,  7), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.SemiRare,  0), new Loot("Soul Orb",  5944,  LootPossibility.SemiRare,  0), new Loot("Double Axe",  3275,  LootPossibility.Rare,  0), new Loot("Necrotic Rod",  3069,  LootPossibility.Rare,  0), new Loot("Magma Monocle",  827,  LootPossibility.Rare,  0), new Loot("Magma Coat",  0,  LootPossibility.Rare,  0), new Loot("Death Ring",  6299,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DiblistheFair = new CreatureData("Diblis the Fair", 0, 1800, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("gold",  0,  LootPossibility.Normal,  99), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  5), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.SemiRare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.SemiRare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.SemiRare,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Rare,  0), new Loot("Spellbook of Lost Souls",  8075,  LootPossibility.VeryRare,  0), new Loot("Vampire Lord Token",  8192,  LootPossibility.Always,  0)}
      );
      public static CreatureData Dipthrah = new CreatureData("Dipthrah", 4200, 2900, 0, 0, 1400, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  158), new Loot("Small Sapphire",  3029,  LootPossibility.Normal,  3), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Rare,  0), new Loot("Blue Gem",  3041,  LootPossibility.Rare,  0), new Loot("Ankh",  0,  LootPossibility.VeryRare,  0), new Loot("Skull Staff",  3324,  LootPossibility.VeryRare,  0), new Loot("Pharaoh Sword",  3334,  LootPossibility.VeryRare,  0), new Loot("Ornamented Ankh",  0,  LootPossibility.Always,  0)}
      );
      public static CreatureData DirePenguin = new CreatureData("Dire Penguin", 173, 119, 0, 0, 115, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Fish",  0,  LootPossibility.Normal,  4), new Loot("Green Perch",  0,  LootPossibility.Rare,  0), new Loot("Rainbow Trout",  0,  LootPossibility.Rare,  0), new Loot("Dragon Hammer",  3322,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Dirtbeard = new CreatureData("Dirtbeard", 630, 375, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Odd Hat",  0,  LootPossibility.Normal,  0), new Loot("The Shield Nevermourn",  9401,  LootPossibility.Normal,  0), new Loot("Pointed Rabbitslayer or Helmet of Nature",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData DoctorPerhaps = new CreatureData("Doctor Perhaps", 475, 325, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Mighty Helm of Green Sparks",  0,  LootPossibility.Normal,  0), new Loot("Trousers of the ancients",  9383,  LootPossibility.Normal,  0), new Loot("Meat shield",  9372,  LootPossibility.Normal,  0), new Loot("Glutton's Mace",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Doomhowl = new CreatureData("Doomhowl", 8500, 3750, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  15)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { }
      );
      public static CreatureData DoomsdayCultist = new CreatureData("Doomsday Cultist", 0, 0, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData Dragon = new CreatureData("Dragon", 1000, 700, 0, 0, 400, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  110), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  3), new Loot("Burst Arrow",  3449,  LootPossibility.Normal,  12), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.SemiRare,  0), new Loot("Steel Helmet",  3351,  LootPossibility.SemiRare,  0), new Loot("Broadsword",  3301,  LootPossibility.SemiRare,  0), new Loot("Plate Legs",  3557,  LootPossibility.SemiRare,  0), new Loot("Double Axe",  3275,  LootPossibility.Rare,  0), new Loot("Dragon Hammer",  3322,  LootPossibility.Rare,  0), new Loot("Green Dragon Leather",  5877,  LootPossibility.Rare,  0), new Loot("Green Dragon Scale",  5920,  LootPossibility.Rare,  0), new Loot("Serpent Sword",  3297,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.Rare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Dragon Shield",  3416,  LootPossibility.VeryRare,  0), new Loot("Dragonbone Staff",  7430,  LootPossibility.VeryRare,  0), new Loot("Small Diamond",  3028,  LootPossibility.VeryRare,  0), new Loot("Life Crystal",  3061,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DragonHatchling = new CreatureData("Dragon Hatchling", 380, 185, 0, 0, 200, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0)}
      );
      public static CreatureData DragonLord = new CreatureData("Dragon Lord", 1900, 2100, 0, 0, 760, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  250), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  5), new Loot("Small Sapphire",  3029,  LootPossibility.Normal,  0), new Loot("Golden Mug",  2903,  LootPossibility.Normal,  0), new Loot("Gemmed Book",  0,  LootPossibility.Normal,  0), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Power Bolt",  3450,  LootPossibility.Normal,  7), new Loot("Life Crystal",  3061,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Royal spear",  7378,  LootPossibility.Normal,  3), new Loot("Strange Helmet",  0,  LootPossibility.Rare,  0), new Loot("Red Dragon Scale",  5882,  LootPossibility.Normal,  0), new Loot("Red Dragon Leather",  5948,  LootPossibility.Rare,  0), new Loot("Fire Sword",  3280,  LootPossibility.Rare,  0), new Loot("Tower Shield",  3428,  LootPossibility.Rare,  0), new Loot("Dragon Slayer",  7402,  LootPossibility.VeryRare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Royal Helmet",  3392,  LootPossibility.VeryRare,  0), new Loot("Dragon Scale Mail",  3386,  LootPossibility.VeryRare,  0), new Loot("Dragon Lord Trophy",  7399,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DragonLordHatchling = new CreatureData("Dragon Lord Hatchling", 750, 645, 0, 0, 335, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  10), new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { "Fchu",  "Rooawwrr",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  165), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  0), new Loot("Mana Potion",  268,  LootPossibility.SemiRare,  0), new Loot("Green Mushroom",  0,  LootPossibility.Rare,  1), new Loot("Magma Boots",  818,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DrakenSpellweaver = new CreatureData("Draken Spellweaver", 5000, 2600, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Fire},
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  20), new DamageModifier(DamageType.Energy,  25)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  10), new DamageModifier(DamageType.Earth,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Weaver's W",  0,  LootPossibility.Normal,  0), new Loot("tip",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.Normal,  0), new Loot("Spellweaver's Robe",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData DrakenWarmaster = new CreatureData("Draken Warmaster", 4150, 2400, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Fire},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  1), new DamageModifier(DamageType.Holy,  20), new DamageModifier(DamageType.Death,  20), new DamageModifier(DamageType.Energy,  30), new DamageModifier(DamageType.Ice,  15), new DamageModifier(DamageType.Earth,  20)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Platinum Coins",  0,  LootPossibility.Normal,  2), new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Bone Shoulderplate",  0,  LootPossibility.Normal,  0), new Loot("Drakinata",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Halberd",  0,  LootPossibility.Normal,  0), new Loot("Warmaster's Wristguards",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Legs",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Dreadbeast = new CreatureData("Dreadbeast", 800, 250, 0, 0, 140, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coins",  0,  LootPossibility.Normal,  80), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Skull",  0,  LootPossibility.Rare,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Rare,  0), new Loot("Green Mushroom",  0,  LootPossibility.VeryRare,  0), new Loot("Hardened Bone",  5925,  LootPossibility.VeryRare,  0), new Loot("Bone Club",  3337,  LootPossibility.SemiRare,  0), new Loot("Bone Shield",  3441,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Dreadmaw = new CreatureData("Dreadmaw", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Piece of Crocodile Leather",  0,  LootPossibility.Always,  0)}
      );
      public static CreatureData Dreadwing = new CreatureData("Dreadwing", 8500, 3750, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Death, DamageType.Earth},
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData Dryad = new CreatureData("Dryad", 310, 190, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("White Mushroom",  0,  LootPossibility.Normal,  2), new Loot("Seeds",  647,  LootPossibility.SemiRare,  3), new Loot("Flower Dress",  0,  LootPossibility.SemiRare,  0), new Loot("Flower Wreath",  0,  LootPossibility.SemiRare,  0), new Loot("Leaf Legs",  9014,  LootPossibility.SemiRare,  0), new Loot("Coconut Shoes",  0,  LootPossibility.Normal,  0), new Loot("Orange Mushrooms",  0,  LootPossibility.Rare,  2)}
      );
      public static CreatureData Duskbringer = new CreatureData("Duskbringer", 0, 2600, 0, 0, 700, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Paralysis},
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  5), new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Energy,  10) },
      ...
      public static CreatureData Dwarf = new CreatureData("Dwarf", 90, 45, 0, 0, 30, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  8), new Loot("White Mushrooms",  0,  LootPossibility.Normal,  2), new Loot("Hatchet",  3276,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Pick",  3456,  LootPossibility.Normal,  0), new Loot("Letter",  0,  LootPossibility.Normal,  0), new Loot("Studded Armor",  3378,  LootPossibility.Normal,  0), new Loot("Copper Shield",  3430,  LootPossibility.Normal,  0), new Loot("Iron Ore",  5880,  LootPossibility.VeryRare,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData DwarfGeomancer = new CreatureData("Dwarf Geomancer", 380, 265, 0, 0, 210, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  35), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Pears",  0,  LootPossibility.Normal,  7), new Loot("Studded Legs",  3362,  LootPossibility.Normal,  0), new Loot("Leather Boots",  3552,  LootPossibility.Normal,  0), new Loot("White Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Spellbook",  648,  LootPossibility.SemiRare,  0), new Loot("Clerical Mace",  3311,  LootPossibility.Rare,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.Rare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.VeryRare,  0), new Loot("Iron Ore",  5880,  LootPossibility.VeryRare,  0), new Loot("Terra Boots",  813,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DwarfGuard = new CreatureData("Dwarf Guard", 245, 165, 0, 0, 140, false, true, FrontAttack.None, 
          ...
          new List<string>() { "Hail Durin!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("White Mushrooms",  0,  LootPossibility.Normal,  2), new Loot("Leather Boots",  3552,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.SemiRare,  0), new Loot("Double Axe",  3275,  LootPossibility.Rare,  0), new Loot("Iron Ore",  5880,  LootPossibility.Rare,  0), new Loot("Axe Ring",  3092,  LootPossibility.VeryRare,  0), new Loot("Health Potion",  266,  LootPossibility.VeryRare,  0), new Loot("Small Amethyst",  3033,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData DwarfMiner = new CreatureData("Dwarf Miner", 120, 60, 0, 0, 30, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Studded Armor",  3378,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Pick",  3456,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.Normal,  0), new Loot("Iron Ore",  5880,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DwarfSoldier = new CreatureData("Dwarf Soldier", 135, 70, 0, 0, 130, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  5), new DamageModifier(DamageType.Fire,  5) },
          new List<string>() { "Hail Durin!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Bolts",  3446,  LootPossibility.Normal,  7), new Loot("White Mushrooms",  0,  LootPossibility.Normal,  3), new Loot("Soldier Helmet",  3375,  LootPossibility.Normal,  0), new Loot("Shovel",  3457,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Dwarven Shield",  3425,  LootPossibility.Normal,  0), new Loot("Piercing Bolts",  0,  LootPossibility.SemiRare,  3), new Loot("Battle Axe",  3266,  LootPossibility.SemiRare,  0), new Loot("Iron Ore",  5880,  LootPossibility.Rare,  0), new Loot("Axe Ring",  3092,  LootPossibility.Rare,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.Rare,  0)}
      );
      public static CreatureData DworcFleshhunter = new CreatureData("Dworc Fleshhunter", 85, 40, 0, 0, 41, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  14), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Skulls",  0,  LootPossibility.Normal,  3), new Loot("Cleaver",  0,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Leather Armor",  3361,  LootPossibility.Normal,  0), new Loot("Tribal Mask",  3403,  LootPossibility.SemiRare,  0), new Loot("Hunting Spear",  3347,  LootPossibility.SemiRare,  0), new Loot("Bronze Amulet",  3056,  LootPossibility.SemiRare,  0), new Loot("Poison Dagger",  3299,  LootPossibility.SemiRare,  0), new Loot("Bone Shield",  3441,  LootPossibility.Rare,  0), new Loot("Ripper Lance",  3346,  LootPossibility.Rare,  0)}
      );
      public static CreatureData DworcVenomsniper = new CreatureData("Dworc Venomsniper", 80, 35, 0, 0, 17, false, false, FrontAttack.None, 
          ...
          new List<string>() { "Grow truk grrrrr.",  "Brak brrretz!",  "Prek tars,  dekklep zurk.",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  14), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Skulls",  0,  LootPossibility.Normal,  3), new Loot("Leather Armor",  3361,  LootPossibility.Normal,  0), new Loot("Poison Arrows",  0,  LootPossibility.Normal,  3), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Throwing Knives",  0,  LootPossibility.Normal,  2), new Loot("Poison Dagger",  3299,  LootPossibility.SemiRare,  0), new Loot("Tribal Mask",  3403,  LootPossibility.SemiRare,  0), new Loot("Bronze Amulet",  3056,  LootPossibility.Rare,  0), new Loot("Bast Skirt",  3560,  LootPossibility.VeryRare,  0), new Loot("Seeds",  647,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData DworcVoodoomaster = new CreatureData("Dworc Voodoomaster", 80, 55, 0, 0, 90, false, false, FrontAttack.None, 
          ...
          new List<string>() { "Grow truk grrrrr.",  "Brak brrretz!",  "Prek tars,  dekklep zurk.",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Skull",  0,  LootPossibility.Normal,  3), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Leather Armor",  3361,  LootPossibility.Normal,  0), new Loot("Bronze Amulet",  3056,  LootPossibility.SemiRare,  0), new Loot("Poison Dagger",  3299,  LootPossibility.SemiRare,  0), new Loot("Tribal Mask",  3403,  LootPossibility.SemiRare,  0), new Loot("Strange Symbol",  0,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("Voodoo Doll",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData EarthElemental = new CreatureData("Earth Elemental", 650, 450, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Earth Arrows",  0,  LootPossibility.Normal,  30), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Small Stones",  0,  LootPossibility.SemiRare,  10), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Small Topaz",  9057,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Efreet = new CreatureData("Efreet", 550, 410, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  125), new Loot("Pear",  0,  LootPossibility.Normal,  12), new Loot("Royal Spear",  7378,  LootPossibility.Normal,  3), new Loot("Heavy Machete",  0,  LootPossibility.Normal,  0), new Loot("Small Oil Lamp",  2933,  LootPossibility.Normal,  0), new Loot("Small Emerald",  3032,  LootPossibility.SemiRare,  4), new Loot("Seeds",  647,  LootPossibility.SemiRare,  2), new Loot("Green Tapestry",  0,  LootPossibility.Rare,  0), new Loot("Green Piece of Cloth",  5910,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.Rare,  0), new Loot("Mystic Turban",  3574,  LootPossibility.Rare,  0), new Loot("Magma Monocle",  827,  LootPossibility.Rare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Green Gem",  3038,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData ElderBeholder = new CreatureData("Elder Beholder", 500, 280, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  105), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Spellbook",  648,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Sniper Arrow",  7364,  LootPossibility.SemiRare,  5), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Beholder Eye",  5898,  LootPossibility.Rare,  0), new Loot("Terra Rod",  3065,  LootPossibility.Rare,  0), new Loot("Beholder Shield",  3418,  LootPossibility.Rare,  0), new Loot("Small Emerald",  3032,  LootPossibility.VeryRare,  0), new Loot("Beholder Helmet",  3408,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Elephant = new CreatureData("Elephant", 320, 160, 0, 0, 100, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Ham",  0,  LootPossibility.Normal,  3), new Loot("Tusk",  3044,  LootPossibility.Rare,  2), new Loot("Tusk Shield",  3443,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData ElfArcanist = new CreatureData("Elf Arcanist", 220, 175, 0, 0, 220, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  49), new Loot("Arrows",  0,  LootPossibility.Normal,  3), new Loot("Scroll",  0,  LootPossibility.Normal,  0), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Staff",  3289,  LootPossibility.Normal,  0), new Loot("S",  0,  LootPossibility.Normal,  0), new Loot("als",  0,  LootPossibility.Normal,  0), new Loot("Melon",  0,  LootPossibility.Normal,  0), new Loot("Bread",  0,  LootPossibility.Normal,  0), new Loot("Green Tunic",  0,  LootPossibility.Normal,  0), new Loot("Grave Flower",  3661,  LootPossibility.Normal,  0), new Loot("Bowl",  0,  LootPossibility.Normal,  0), new Loot("Inkwell",  3509,  LootPossibility.Normal,  0), new Loot("Sling Herb",  0,  LootPossibility.Normal,  0), new Loot("C",  0,  LootPossibility.Normal,  0), new Loot("lestick",  0,  LootPossibility.Normal,  0), new Loot("Elven Amulet",  3082,  LootPossibility.SemiRare,  0), new Loot("Holy Orchids",  0,  LootPossibility.Rare,  2), new Loot("Strong Mana Potion",  237,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.Rare,  0), new Loot("Life Crystal",  3061,  LootPossibility.VeryRare,  0), new Loot("Yellow Gem",  3037,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData ElfScout = new CreatureData("Elf Scout", 160, 75, 0, 0, 110, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Arrow",  3447,  LootPossibility.Normal,  15), new Loot("Poison Arrow",  3448,  LootPossibility.Normal,  6), new Loot("Grape",  0,  LootPossibility.Normal,  0), new Loot("Waterskin",  0,  LootPossibility.Normal,  0), new Loot("Studded Armor",  3378,  LootPossibility.Normal,  0), new Loot("S",  0,  LootPossibility.Normal,  0), new Loot("als",  0,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Studded Helmet",  3376,  LootPossibility.Normal,  0), new Loot("Bow",  3350,  LootPossibility.SemiRare,  0), new Loot("Heaven Blossom",  5921,  LootPossibility.Rare,  0), new Loot("Elvish Bow",  7438,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData EnergyElemental = new CreatureData("Energy Elemental", 500, 550, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  170), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Throwing Stars",  0,  LootPossibility.Normal,  5), new Loot("Flash Arrow",  761,  LootPossibility.Normal,  10), new Loot("Small Amethysts",  0,  LootPossibility.SemiRare,  3), new Loot("Mana Potion",  268,  LootPossibility.Normal,  0), new Loot("Obsidian Lance",  3313,  LootPossibility.SemiRare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Crystal Sword",  7449,  LootPossibility.SemiRare,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Rare,  0), new Loot("Crystal Ring",  3007,  LootPossibility.Rare,  0), new Loot("Energy Ring",  3051,  LootPossibility.Rare,  0), new Loot("Guardian Shield",  0,  LootPossibility.VeryRare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData EnlightenedoftheCult = new CreatureData("Enlightened of the Cult", 700, 500, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  80), new Loot("Cape",  0,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.SemiRare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.SemiRare,  0), new Loot("Pirate Voodoo Doll",  0,  LootPossibility.SemiRare,  0), new Loot("Music Sheet",  0,  LootPossibility.Normal,  0), new Loot("semi-rare)",  0,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.SemiRare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.Rare,  0), new Loot("Skull Staff",  3324,  LootPossibility.Rare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.Rare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.VeryRare,  0), new Loot("Blue Robe",  3567,  LootPossibility.VeryRare,  0), new Loot("Key Ring",  5801,  LootPossibility.VeryRare,  0), new Loot("Mysterious Voodoo Skull",  5668,  LootPossibility.VeryRare,  0), new Loot("Amber Staff",  7426,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData EnragedSquirrel = new CreatureData("Enraged Squirrel", 35, 0, 0, 0, 6, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "Chchch",  },
          new List<Loot>() { new Loot("Walnuts",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Esmeralda = new CreatureData("Esmeralda", 800, 600, 0, 0, 273, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  145), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  4), new Loot("Skull",  0,  LootPossibility.Always,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Always,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Knight Armor",  3370,  LootPossibility.Normal,  0), new Loot("Epee",  0,  LootPossibility.Normal,  0), new Loot("Tower Shield",  3428,  LootPossibility.Normal,  0), new Loot("Terra Mantle",  811,  LootPossibility.SemiRare,  0)}
      );
      ...
      public static CreatureData EternalGuardian = new CreatureData("Eternal Guardian", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth, DamageType.Drown, DamageType.Paralysis},
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  36), new Loot("Small Stone",  1781,  LootPossibility.Normal,  7), new Loot("Ancient Stone",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Fatality = new CreatureData("Fatality", 0, 0, 0, 0, 205, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData Ferumbras = new CreatureData("Ferumbras", 35000, 12000, 0, 0, 2400, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  270), new Loot("Small Amethysts",  0,  LootPossibility.Normal,  75), new Loot("Small Sapphires",  0,  LootPossibility.Normal,  92), new Loot("Small Rubies",  0,  LootPossibility.Normal,  49), new Loot("White Pearls",  0,  LootPossibility.Normal,  8), new Loot("Small Diamonds",  0,  LootPossibility.Normal,  90), new Loot("Small Topaz",  9057,  LootPossibility.Normal,  86), new Loot("Gold Ingots",  0,  LootPossibility.Normal,  2), new Loot("Talon",  3034,  LootPossibility.Normal,  0), new Loot("Snakebite Rod",  3066,  LootPossibility.Normal,  0), new Loot("Necrotic Rod",  3069,  LootPossibility.Normal,  0), new Loot("Gold Ring",  3063,  LootPossibility.Normal,  0), new Loot("Fire Axe",  3320,  LootPossibility.Normal,  0), new Loot("Crystal Ring",  3007,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Emerald Bangle",  3010,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Two H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Normal,  0), new Loot("Golden Armor",  3360,  LootPossibility.Normal,  0), new Loot("Golden Legs",  3364,  LootPossibility.Normal,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.Normal,  0), new Loot("Boots of Haste",  3079,  LootPossibility.Normal,  0), new Loot("Devil Helmet",  3356,  LootPossibility.Normal,  0), new Loot("Jade Hammer",  0,  LootPossibility.Normal,  0), new Loot("Mastermind Shield",  3414,  LootPossibility.Normal,  0), new Loot("Teddy Bear",  0,  LootPossibility.Normal,  0), new Loot("Thunder Hammer",  3309,  LootPossibility.Normal,  0), new Loot("Magic Plate Armor",  3366,  LootPossibility.Normal,  0), new Loot("Spellbook of Mind Control",  8074,  LootPossibility.Normal,  0), new Loot("Spellbook of Lost Souls",  8075,  LootPossibility.Normal,  0), new Loot("Spellscroll of Prophecies",  8076,  LootPossibility.Normal,  0), new Loot("Glacier Kilt",  823,  LootPossibility.Normal,  0), new Loot("Lightning Legs",  822,  LootPossibility.Normal,  0), new Loot("Terra Legs",  812,  LootPossibility.Normal,  0), new Loot("Abyss Hammer",  7414,  LootPossibility.Normal,  0), new Loot("Berserker",  0,  LootPossibility.Normal,  0), new Loot("Chaos Mace",  7427,  LootPossibility.Normal,  0), new Loot("Queen's Sceptre",  0,  LootPossibility.Normal,  0), new Loot("Ornamented Axe",  7411,  LootPossibility.Normal,  0), new Loot("Vile Axe",  0,  LootPossibility.Normal,  0), new Loot("Greenwood Coat",  8041,  LootPossibility.Normal,  0), new Loot("Divine Plate",  0,  LootPossibility.Normal,  0), new Loot("Emerald Sword",  8102,  LootPossibility.Normal,  0), new Loot("Obsidian Truncheon",  8100,  LootPossibility.Normal,  0), new Loot("Spellbook of Dark Mysteries",  8090,  LootPossibility.Normal,  0), new Loot("Skullcrusher",  0,  LootPossibility.Normal,  0), new Loot("Great Shield",  3422,  LootPossibility.Normal,  0), new Loot("Red Tome",  2852,  LootPossibility.Normal,  0), new Loot("Phoenix Shield",  3439,  LootPossibility.Normal,  0), new Loot("Hellforged Axe",  8096,  LootPossibility.Normal,  0), new Loot("Impaler",  0,  LootPossibility.Normal,  0), new Loot("Tempest Shield",  0,  LootPossibility.Normal,  0), new Loot("Velvet Mantle",  0,  LootPossibility.Normal,  0), new Loot("Demonrage Sword",  7382,  LootPossibility.Normal,  0), new Loot("Bloody Edge",  0,  LootPossibility.Normal,  0), new Loot("Demonwing Axe",  0,  LootPossibility.Normal,  0), new Loot("Havoc Blade",  0,  LootPossibility.Normal,  0), new Loot("Nightmare Blade",  7418,  LootPossibility.Normal,  0), new Loot("Demon Shield",  3420,  LootPossibility.Normal,  0), new Loot("Runed Sword",  0,  LootPossibility.Normal,  0), new Loot("Ferumbras' Hat",  5903,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData FireOverlord = new CreatureData("Fire Overlord", 4000, 2800, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Ice,  25) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  125), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  3), new Loot("Eternal Flames",  946,  LootPossibility.Normal,  0), new Loot("Lavos Armor",  8049,  LootPossibility.Rare,  0), new Loot("Magma Coat",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData FlamecallerZazrak = new CreatureData("Flamecaller Zazrak", 0, 0, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Dragon Priest's W",  0,  LootPossibility.Normal,  0), new Loot("tip",  0,  LootPossibility.Normal,  0), new Loot("Life Ring",  3052,  LootPossibility.Normal,  0), new Loot("Zaoan Robe",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Fleabringer = new CreatureData("Fleabringer", 265, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Worm",  0,  LootPossibility.Normal,  3), new Loot("Shaggy Tail",  0,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData ForemanKneebiter = new CreatureData("Foreman Kneebiter", 570, 445, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  1), new DamageModifier(DamageType.Fire,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Iron Ore",  5880,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData FrostDragon = new CreatureData("Frost Dragon", 1800, 2100, 0, 0, 600, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  350), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  5), new Loot("Gemmed Book",  0,  LootPossibility.Normal,  0), new Loot("Golden Mug",  2903,  LootPossibility.Normal,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Normal,  0), new Loot("Ice Cube",  7441,  LootPossibility.Normal,  0), new Loot("Power Bolt",  3450,  LootPossibility.Normal,  6), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Strange Helmet",  0,  LootPossibility.Rare,  0), new Loot("Ice Rapier",  3284,  LootPossibility.Rare,  0), new Loot("Life Crystal",  3061,  LootPossibility.SemiRare,  0), new Loot("Shard",  7290,  LootPossibility.Rare,  0), new Loot("Tower Shield",  3428,  LootPossibility.Rare,  0), new Loot("Dragon Slayer",  7402,  LootPossibility.VeryRare,  0), new Loot("Royal Helmet",  3392,  LootPossibility.VeryRare,  0), new Loot("Dragon Scale Mail",  3386,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData FrostDragonHatchling = new CreatureData("Frost Dragon Hatchling", 800, 745, 0, 0, 380, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  55), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  0), new Loot("Spellbook of Enlightenment",  8072,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0)}
      );
      public static CreatureData FrostGiant = new CreatureData("Frost Giant", 270, 150, 0, 0, 200, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Ice Cube",  7441,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.SemiRare,  0), new Loot("Battle Shield",  3413,  LootPossibility.SemiRare,  0), new Loot("Halberd",  3269,  LootPossibility.Rare,  0), new Loot("Norse Shield",  7460,  LootPossibility.Rare,  0), new Loot("Dark Helmet",  3384,  LootPossibility.Rare,  0), new Loot("Wolf Tooth Chain",  3012,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("Shard",  7290,  LootPossibility.VeryRare,  0), new Loot("Club Ring",  3093,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData FrostGiantess = new CreatureData("Frost Giantess", 275, 150, 0, 0, 150, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  40), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Ice Cube",  7441,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Norse Shield",  7460,  LootPossibility.Normal,  0), new Loot("Small Stones",  0,  LootPossibility.SemiRare,  10), new Loot("Wolf Tooth Chain",  3012,  LootPossibility.SemiRare,  0), new Loot("Club Ring",  3093,  LootPossibility.Rare,  0), new Loot("Halberd",  3269,  LootPossibility.Rare,  0), new Loot("Dark Helmet",  3384,  LootPossibility.Rare,  0), new Loot("Shard",  7290,  LootPossibility.Rare,  0), new Loot("Mana Potion",  268,  LootPossibility.Rare,  0), new Loot("Glacier Shoes",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData FrostTroll = new CreatureData("Frost Troll", 55, 23, 0, 0, 20, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  12), new Loot("Fish",  0,  LootPossibility.Normal,  1), new Loot("Club",  3270,  LootPossibility.Normal,  0), new Loot("Rapier",  3272,  LootPossibility.Normal,  0), new Loot("Spear",  3277,  LootPossibility.Normal,  0), new Loot("Wooden Shield",  3412,  LootPossibility.Normal,  0), new Loot("Coat",  0,  LootPossibility.Normal,  0), new Loot("Twigs",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData FuriousTroll = new CreatureData("Furious Troll", 245, 185, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  179), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  1), new Loot("War Hammer",  3279,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Fury = new CreatureData("Fury", 4100, 4500, 0, 0, 0, false, true, FrontAttack.Wave, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("platinum coins",  0,  LootPossibility.Normal,  2), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  3), new Loot("Orichalcum Pearls",  0,  LootPossibility.Normal,  3), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Small Amethysts",  0,  LootPossibility.Normal,  3), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Terra Rod",  3065,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Noble Axe",  7456,  LootPossibility.SemiRare,  0), new Loot("Red Piece of Cloth",  5911,  LootPossibility.SemiRare,  0), new Loot("Great Health Potion",  239,  LootPossibility.SemiRare,  0), new Loot("Rusty Legs",  8897,  LootPossibility.Normal,  0), new Loot("Crown Armor",  3381,  LootPossibility.Rare,  0), new Loot("Assassin Star",  7368,  LootPossibility.Rare,  1), new Loot("Steel Boots",  3554,  LootPossibility.Rare,  0), new Loot("Crystal Ring",  3007,  LootPossibility.Rare,  0), new Loot("Red Gem",  3039,  LootPossibility.Rare,  0), new Loot("Assassin Dagger",  0,  LootPossibility.VeryRare,  0), new Loot("Golden Legs",  3364,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData GangMember = new CreatureData("Gang Member", 295, 70, 0, 0, 95, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  23), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Brown Bread",  0,  LootPossibility.Normal,  0), new Loot("Torches",  0,  LootPossibility.Normal,  2), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Studded Legs",  3362,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Club Ring",  3093,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Gargoyle = new CreatureData("Gargoyle", 250, 150, 0, 0, 65, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Small Stone",  1781,  LootPossibility.Normal,  10), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Bone Club",  3337,  LootPossibility.Normal,  0), new Loot("Studded Club",  3336,  LootPossibility.Normal,  0), new Loot("Dark Armor",  3383,  LootPossibility.Rare,  0), new Loot("Morning Star",  3282,  LootPossibility.Rare,  0), new Loot("Steel Helmet",  3351,  LootPossibility.VeryRare,  0), new Loot("Wolf Tooth Chain",  3012,  LootPossibility.VeryRare,  0), new Loot("Club Ring",  3093,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData GeneralMurius = new CreatureData("General Murius", 550, 450, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  38), new Loot("Power Bolts",  0,  LootPossibility.Normal,  8), new Loot("Piercing Bolts",  0,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Shovel",  3457,  LootPossibility.Normal,  0), new Loot("Bronze Amulet",  3056,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Bolts",  3446,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Chain Legs",  3558,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Soldier Helmet",  3375,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Hatchet",  3276,  LootPossibility.Normal,  0), new Loot("Fishing Rod",  3483,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Combat Knife",  3292,  LootPossibility.Normal,  0), new Loot("Dead Snake",  3998,  LootPossibility.Normal,  0), new Loot("Carrots",  0,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.Normal,  0), new Loot("Dwarven Helmet",  3396,  LootPossibility.Rare,  0)}
      );
      public static CreatureData GhastlyDragon = new CreatureData("Ghastly Dragon", 7800, 4600, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Death, DamageType.Earth, DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Ice,  50)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  10), new DamageModifier(DamageType.Holy,  15), new DamageModifier(DamageType.Energy,  10) },
          new List<string>() { "EMBRACE MY GIFTS!",  "I WILL FEAST ON YOUR SOUL!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  203), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  2), new Loot("Undead Heart",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Halberd",  0,  LootPossibility.SemiRare,  0), new Loot("Twin Hooks",  0,  LootPossibility.SemiRare,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.SemiRare,  0), new Loot("Great Health Potion",  239,  LootPossibility.SemiRare,  0), new Loot("Great Spirit Potion",  7642,  LootPossibility.SemiRare,  0), new Loot("Soul Orb",  5944,  LootPossibility.SemiRare,  0), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("Ghastly Dragon Head",  0,  LootPossibility.SemiRare,  0), new Loot("Rusty Armor",  0,  LootPossibility.SemiRare,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.Normal,  0), new Loot("Zaoan Armor",  0,  LootPossibility.Rare,  0), new Loot("Jade Hat",  0,  LootPossibility.Rare,  0), new Loot("Drakinata",  0,  LootPossibility.Rare,  0), new Loot("Shiny Stone",  0,  LootPossibility.Rare,  0), new Loot("Spellweaver's Robe",  0,  LootPossibility.VeryRare,  0), new Loot("Zaoan Sword",  0,  LootPossibility.VeryRare,  0), new Loot("Dragon Scale Boots",  0,  LootPossibility.VeryRare,  0), new Loot("Guardian Boots",  0,  LootPossibility.VeryRare,  0), new Loot("Zaoan Helmet",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Ghost = new CreatureData("Ghost", 150, 120, 0, 0, 125, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("S",  0,  LootPossibility.Normal,  0), new Loot("als",  0,  LootPossibility.Normal,  0), new Loot("Shadow Herb",  0,  LootPossibility.Normal,  0), new Loot("Cape",  0,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Combat Knife",  3292,  LootPossibility.Normal,  0), new Loot("Orange Book",  0,  LootPossibility.SemiRare,  0), new Loot("White Piece of Cloth",  5909,  LootPossibility.Rare,  0), new Loot("Ancient Shield",  3432,  LootPossibility.Rare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Ghoul = new CreatureData("Ghoul", 100, 85, 0, 0, 97, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  25) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Worms",  3492,  LootPossibility.Normal,  6), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Viking Helmet",  3367,  LootPossibility.Normal,  0), new Loot("Knife",  3291,  LootPossibility.Normal,  0), new Loot("Skulls",  0,  LootPossibility.SemiRare,  2), new Loot("Scale Armor",  3377,  LootPossibility.SemiRare,  0), new Loot("Brown Piece of Cloth",  5913,  LootPossibility.SemiRare,  0), new Loot("Life Ring",  3052,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData GiantSpider = new CreatureData("Giant Spider", 1300, 900, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  115), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Poison Arrows",  0,  LootPossibility.Normal,  12), new Loot("Spider Silk",  5879,  LootPossibility.Rare,  0), new Loot("Time Ring",  3053,  LootPossibility.Rare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Knight Armor",  3370,  LootPossibility.Rare,  0), new Loot("Knight Legs",  3371,  LootPossibility.Rare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.VeryRare,  0), new Loot("Lightning Headb",  0,  LootPossibility.Normal,  0), new Loot("very rare)",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Gladiator = new CreatureData("Gladiator", 185, 90, 0, 0, 90, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.SemiRare,  0), new Loot("Steel Shield",  3409,  LootPossibility.SemiRare,  0), new Loot("Belted Cape",  8044,  LootPossibility.Rare,  0), new Loot("Iron Helmet",  3353,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData Gnarlhound = new CreatureData("Gnarlhound", 198, 60, 0, 0, 36, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  5), new DamageModifier(DamageType.Energy,  5)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  5) },
          new List<string>() { "Gnarlll!",  "Grrrrrr!",  },
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Worm",  0,  LootPossibility.Normal,  3), new Loot("Shaggy Tail",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Golgordan = new CreatureData("Golgordan", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  234), new Loot("Black Pearl",  3027,  LootPossibility.Normal,  8), new Loot("White Pearl",  3026,  LootPossibility.Normal,  11), new Loot("Small Emerald",  3032,  LootPossibility.Normal,  8), new Loot("Small Diamond  0-6 Onyx Arrow",  0,  LootPossibility.Normal,  4), new Loot("Gold Ring",  3063,  LootPossibility.Normal,  0), new Loot("Death Ring",  6299,  LootPossibility.Normal,  0), new Loot("Gold Ingot",  9058,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Snakebite Rod",  3066,  LootPossibility.Normal,  0), new Loot("Necrotic Rod",  3069,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Silver Dagger",  3290,  LootPossibility.Normal,  0), new Loot("Ice Rapier",  3284,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Fire Axe",  3320,  LootPossibility.Normal,  0), new Loot("Skull Staff",  3324,  LootPossibility.Normal,  0), new Loot("Giant Sword",  3281,  LootPossibility.Normal,  0), new Loot("Devil Helmet",  3356,  LootPossibility.Normal,  0), new Loot("Demon Shield",  3420,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Gozzler = new CreatureData("Gozzler", 240, 180, 0, 0, 245, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Brown Flask",  0,  LootPossibility.Normal,  0), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Battle Axe",  3266,  LootPossibility.SemiRare,  0), new Loot("Serpent Sword",  3297,  LootPossibility.Rare,  0), new Loot("Clerical Mace",  3311,  LootPossibility.Rare,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.VeryRare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData GrandMotherFoulscale = new CreatureData("Grand Mother Foulscale", 0, 0, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Fire, DamageType.Paralysis},
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  41), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData GravelordOshuran = new CreatureData("Gravelord Oshuran", 3100, 2400, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  97), new Loot("Strong Mana Potion",  237,  LootPossibility.Normal,  0), new Loot("White Pearl",  3026,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Blue Robe",  3567,  LootPossibility.Normal,  0), new Loot("Lightning Boots",  820,  LootPossibility.Normal,  0), new Loot("Spellscroll of Prophecies",  8076,  LootPossibility.Normal,  0), new Loot("Spellbook",  648,  LootPossibility.Normal,  0)}
      );
      public static CreatureData GreenDjinn = new CreatureData("Green Djinn", 330, 215, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  113), new Loot("Cheese",  0,  LootPossibility.Normal,  0), new Loot("Grave Flower",  3661,  LootPossibility.Normal,  0), new Loot("Small Oil Lamp",  2933,  LootPossibility.SemiRare,  0), new Loot("Royal Spear",  7378,  LootPossibility.SemiRare,  2), new Loot("Green Book",  0,  LootPossibility.SemiRare,  0), new Loot("Small Emerald",  3032,  LootPossibility.Rare,  4), new Loot("Mana Potion",  268,  LootPossibility.Rare,  0), new Loot("Green Piece of Cloth",  5910,  LootPossibility.Rare,  0), new Loot("Mystic Turban",  3574,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData GrimReaper = new CreatureData("Grim Reaper", 3900, 5500, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { "Death!",  "Come a little closer!",  "The end is near!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  236), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  4), new Loot("Orichalcum Pearls",  0,  LootPossibility.Normal,  4), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  0), new Loot("Scythe",  3453,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Dark Shield",  3421,  LootPossibility.SemiRare,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Glacier Kilt",  823,  LootPossibility.VeryRare,  0), new Loot("Underworld Rod",  8082,  LootPossibility.VeryRare,  0), new Loot("Skullcracker Armor",  8061,  LootPossibility.VeryRare,  0), new Loot("Nightmare Blade",  7418,  LootPossibility.VeryRare,  0), new Loot("Death Ring",  6299,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Grorlam = new CreatureData("Grorlam", 3000, 2400, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  14), new Loot("Small Stone",  1781,  LootPossibility.Normal,  20), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Pick",  3456,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Iron Ore",  5880,  LootPossibility.Normal,  0), new Loot("Crystal Ring",  3007,  LootPossibility.Normal,  0), new Loot("Power Ring",  3050,  LootPossibility.Normal,  0), new Loot("Red Gem",  3039,  LootPossibility.Normal,  0), new Loot("Carlin Sword",  3283,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Small Amethysts",  0,  LootPossibility.Rare,  2), new Loot("Steel Boots",  3554,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData GrynchClanGoblin = new CreatureData("Grynch Clan Goblin", 80, 4, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  22), new Loot("Present Bag",  0,  LootPossibility.Normal,  0), new Loot("Snowballs",  0,  LootPossibility.Normal,  5), new Loot("Lump of Cake Dough",  0,  LootPossibility.Normal,  3), new Loot("Oranges",  0,  LootPossibility.Normal,  3), new Loot("Cookies",  0,  LootPossibility.Normal,  5), new Loot("Cherries",  0,  LootPossibility.Normal,  4), new Loot("Apples",  0,  LootPossibility.Normal,  3), new Loot("Eggs",  0,  LootPossibility.SemiRare,  2), new Loot("C",  0,  LootPossibility.Normal,  3), new Loot("y Canes",  0,  LootPossibility.SemiRare,  0), new Loot("Cream Cake",  0,  LootPossibility.SemiRare,  0), new Loot("Lute",  2950,  LootPossibility.SemiRare,  0), new Loot("Blank Rune",  0,  LootPossibility.SemiRare,  0), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("semi-rare)",  0,  LootPossibility.SemiRare,  0), new Loot("L",  0,  LootPossibility.Normal,  0), new Loot("scape Picture",  0,  LootPossibility.SemiRare,  0), new Loot("Bronze Amulet",  3056,  LootPossibility.SemiRare,  0), new Loot("Scroll",  0,  LootPossibility.SemiRare,  0), new Loot("Gingerbreadman",  0,  LootPossibility.SemiRare,  2), new Loot("Scarf",  3572,  LootPossibility.SemiRare,  0), new Loot("Chicken Feathers",  0,  LootPossibility.SemiRare,  5), new Loot("Bat Wings",  0,  LootPossibility.SemiRare,  3), new Loot("Honeycomb",  0,  LootPossibility.SemiRare,  0), new Loot("Explorer Brooch",  0,  LootPossibility.SemiRare,  0), new Loot("Walnuts",  0,  LootPossibility.SemiRare,  5), new Loot("Peanuts",  0,  LootPossibility.Rare,  5), new Loot("Valentine's Cake",  0,  LootPossibility.Rare,  0), new Loot("Watch",  0,  LootPossibility.Rare,  0), new Loot("Broom",  0,  LootPossibility.Rare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.Rare,  0), new Loot("Dice",  5794,  LootPossibility.Rare,  0), new Loot("Mirror",  0,  LootPossibility.Rare,  0), new Loot("various Pillows",  0,  LootPossibility.Rare,  0), new Loot("Flower Bowl",  2983,  LootPossibility.Rare,  0), new Loot("Bottle",  0,  LootPossibility.Rare,  0), new Loot("Scarab Coin",  3042,  LootPossibility.Rare,  0), new Loot("Orichalcum Pearl",  0,  LootPossibility.Rare,  2), new Loot("Crystal Coin",  3043,  LootPossibility.VeryRare,  0), new Loot("Elvenhair Rope",  646,  LootPossibility.VeryRare,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData HairmanTheHuge = new CreatureData("Hairman The Huge", 600, 335, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coins",  0,  LootPossibility.Normal,  60), new Loot("Bananas",  0,  LootPossibility.Normal,  2), new Loot("Ape Fur",  5883,  LootPossibility.SemiRare,  0), new Loot("Plate Armor",  3357,  LootPossibility.SemiRare,  0), new Loot("Power Ring",  3050,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0)}
      );
      public static CreatureData HandofCursedFate = new CreatureData("Hand of Cursed Fate", 7500, 5000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  5), new Loot("Small Sapphires",  0,  LootPossibility.Normal,  4), new Loot("Cape",  0,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Normal,  0), new Loot("Emerald Bangle",  3010,  LootPossibility.Normal,  0), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  4), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.SemiRare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.SemiRare,  0), new Loot("Knight Armor",  3370,  LootPossibility.SemiRare,  0), new Loot("Skull Staff",  3324,  LootPossibility.SemiRare,  0), new Loot("Gold Ingot",  9058,  LootPossibility.Rare,  0), new Loot("Crown Armor",  3381,  LootPossibility.Rare,  0), new Loot("Violet Gem",  3036,  LootPossibility.VeryRare,  0), new Loot("Golden Figurine",  5799,  LootPossibility.VeryRare,  0), new Loot("Abyss Hammer",  7414,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData HarbingerofDarkness = new CreatureData("Harbinger of Darkness", 0, 0, 0, 0, 4066, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData HauntedTreeling = new CreatureData("Haunted Treeling", 450, 310, 0, 0, 300, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  96), new Loot("White Mushroom",  0,  LootPossibility.Normal,  2), new Loot("Red Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Wooden Trash",  0,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0), new Loot("Orange Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Strong Health Potion",  236,  LootPossibility.SemiRare,  0), new Loot("Trunk Chair Kit",  0,  LootPossibility.SemiRare,  0), new Loot("Small Emerald",  3032,  LootPossibility.SemiRare,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.Rare,  0), new Loot("Bullseye Potion",  7443,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Haunter = new CreatureData("Haunter", 8500, 4000, 0, 0, 129, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  10)},
          new List<DamageModifier>() {  },
          new List<string>() { "Surrender ,  I'll end it quick.",  },
          new List<Loot>() { }
      );
      ...
      public static CreatureData HellfireFighter = new CreatureData("Hellfire Fighter", 3800, 3900, 0, 0, 2749, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Ice,  25) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  165), new Loot("Burnt Scroll",  0,  LootPossibility.Normal,  0), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  0), new Loot("Small Ruby",  3030,  LootPossibility.Normal,  4), new Loot("Orichalcum Pearl",  0,  LootPossibility.Normal,  2), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.SemiRare,  0), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("Emerald Bangle",  3010,  LootPossibility.SemiRare,  0), new Loot("Fire Sword",  3280,  LootPossibility.SemiRare,  0), new Loot("Fire Axe",  3320,  LootPossibility.Rare,  0), new Loot("Magma Legs",  821,  LootPossibility.Rare,  0), new Loot("Magma Coat",  0,  LootPossibility.VeryRare,  0), new Loot("Demonbone Amulet",  3019,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Hellgorak = new CreatureData("Hellgorak", 30000, 10000, 0, 0, 1800, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  283), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  29), new Loot("Demonic Essence",  6499,  LootPossibility.Always,  0), new Loot("Small Rubies",  0,  LootPossibility.Normal,  25), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  22), new Loot("Small Diamonds",  0,  LootPossibility.Normal,  21), new Loot("Small Emeralds",  0,  LootPossibility.Normal,  25), new Loot("Small Sapphires",  0,  LootPossibility.Normal,  21), new Loot("Small Topazs",  0,  LootPossibility.Normal,  25), new Loot("Black Pearls",  0,  LootPossibility.Normal,  22), new Loot("White Pearls",  0,  LootPossibility.Normal,  25), new Loot("Great Spirit Potion",  7642,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  2), new Loot("Demon Horn",  5954,  LootPossibility.Normal,  2), new Loot("Crystal Necklace",  3008,  LootPossibility.Normal,  0), new Loot("Stone Skin Amulet",  3081,  LootPossibility.Normal,  0), new Loot("Golden Amulet",  3013,  LootPossibility.Normal,  0), new Loot("Ruby Necklace",  3016,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Rare,  0), new Loot("Rusty Legs",  8897,  LootPossibility.Rare,  0), new Loot("Beastslayer Axe",  0,  LootPossibility.Normal,  0), new Loot("Noble Axe",  7456,  LootPossibility.Normal,  0), new Loot("Butcher's Axe",  0,  LootPossibility.Normal,  0), new Loot("Spirit Cloak",  0,  LootPossibility.Normal,  0), new Loot("Focus Cape",  8043,  LootPossibility.Normal,  0), new Loot("Blue Robe",  3567,  LootPossibility.Normal,  0), new Loot("Crown Armor",  3381,  LootPossibility.Normal,  0), new Loot("Knight Legs",  3371,  LootPossibility.Normal,  0), new Loot("Crown Legs",  3382,  LootPossibility.Normal,  0), new Loot("Magma Legs",  821,  LootPossibility.Normal,  0), new Loot("Steel Boots",  3554,  LootPossibility.Normal,  0), new Loot("Spellbook of Warding",  8073,  LootPossibility.Normal,  0), new Loot("Spellbook of Mind Control",  8074,  LootPossibility.Normal,  0), new Loot("Golden Armor",  3360,  LootPossibility.Normal,  0), new Loot("Golden Legs",  3364,  LootPossibility.Normal,  0), new Loot("Spellbook of Lost Souls",  8075,  LootPossibility.SemiRare,  0), new Loot("Vile Axe",  0,  LootPossibility.Normal,  0), new Loot("Spellscroll of Prophecies",  8076,  LootPossibility.Rare,  0), new Loot("Demonbone Amulet",  3019,  LootPossibility.Rare,  0), new Loot("Voltage Armor",  0,  LootPossibility.Rare,  0), new Loot("Spellbook of Dark Mysteries",  8090,  LootPossibility.VeryRare,  0), new Loot("Demonwing Axe",  0,  LootPossibility.VeryRare,  0), new Loot("Great Axe",  3303,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Hellhound = new CreatureData("Hellhound", 7500, 6800, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  375), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  5), new Loot("Ham",  0,  LootPossibility.Normal,  6), new Loot("Throwing Knives",  0,  LootPossibility.Normal,  11), new Loot("Black Pearls",  0,  LootPossibility.Normal,  4), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Gold Ingot",  9058,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Rare,  0), new Loot("Giant Sword",  3281,  LootPossibility.SemiRare,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Knight Axe",  3318,  LootPossibility.SemiRare,  0), new Loot("Spike Sword",  0,  LootPossibility.SemiRare,  0), new Loot("Ruthless Axe",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Hellspawn = new CreatureData("Hellspawn", 3500, 2550, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  207), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  6), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  0), new Loot("Assassin Stars",  0,  LootPossibility.Normal,  2), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Small Topazes",  0,  LootPossibility.Normal,  4), new Loot("Knight Legs",  3371,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.SemiRare,  2), new Loot("Warrior Helmet",  3369,  LootPossibility.Normal,  0), new Loot("Knight Armor",  3370,  LootPossibility.SemiRare,  0), new Loot("Spiked Squelcher",  0,  LootPossibility.Normal,  0), new Loot("Onyx Flail",  0,  LootPossibility.Rare,  0), new Loot("Dracoyle Statue",  0,  LootPossibility.VeryRare,  0), new Loot("Black Skull",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData HeraldofGloom = new CreatureData("Herald of Gloom", 450, 450, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  20), new DamageModifier(DamageType.Ice,  20)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  5), new DamageModifier(DamageType.Death,  5), new DamageModifier(DamageType.Energy,  5) },
          new List<string>() { },
          new List<Loot>() { new Loot("Midnight Shard",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Hero = new CreatureData("Hero", 1400, 1200, 0, 0, 360, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Arrows",  0,  LootPossibility.Normal,  15), new Loot("Rope",  3003,  LootPossibility.Normal,  0), new Loot("Scroll",  0,  LootPossibility.Normal,  0), new Loot("Lyre",  0,  LootPossibility.Normal,  0), new Loot("Green Tunic",  0,  LootPossibility.Normal,  0), new Loot("Bow",  3350,  LootPossibility.Normal,  0), new Loot("Scarf",  3572,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Grapes",  0,  LootPossibility.Normal,  0), new Loot("Red Rose",  0,  LootPossibility.Normal,  0), new Loot("Wedding Ring",  3004,  LootPossibility.Normal,  0), new Loot("Two H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Sniper Arrow",  7364,  LootPossibility.Normal,  6), new Loot("War Hammer",  3279,  LootPossibility.SemiRare,  0), new Loot("Red Piece of Cloth",  5911,  LootPossibility.SemiRare,  0), new Loot("Crown Armor",  3381,  LootPossibility.Rare,  0), new Loot("Crown Shield",  3419,  LootPossibility.Rare,  0), new Loot("Crown Helmet",  3385,  LootPossibility.Rare,  0), new Loot("Fire Sword",  3280,  LootPossibility.Rare,  0), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.VeryRare,  0), new Loot("Might Ring",  3048,  LootPossibility.VeryRare,  0), new Loot("Crown Legs",  3382,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Hide = new CreatureData("Hide", 500, 240, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  5), new Loot("Steel Helmet",  3351,  LootPossibility.Normal,  0), new Loot("Terra Hood",  830,  LootPossibility.Normal,  0), new Loot("Spider Silk",  5879,  LootPossibility.Normal,  0), new Loot("Knight Legs",  3371,  LootPossibility.Normal,  0), new Loot("Time Ring",  3053,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Hunter = new CreatureData("Hunter", 150, 150, 0, 0, 120, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Poison Arrow",  3448,  LootPossibility.Normal,  2), new Loot("Arrows",  0,  LootPossibility.Normal,  24), new Loot("Oranges",  0,  LootPossibility.Normal,  2), new Loot("Rolls",  0,  LootPossibility.Normal,  2), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Bow",  3350,  LootPossibility.Normal,  0), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Dragon Necklace",  3085,  LootPossibility.Rare,  0), new Loot("Burst Arrows",  0,  LootPossibility.Rare,  3), new Loot("Wolf Trophy",  7394,  LootPossibility.VeryRare,  0), new Loot("Lion Trophy",  7400,  LootPossibility.VeryRare,  0), new Loot("Sniper Gloves",  5875,  LootPossibility.VeryRare,  0), new Loot("Small Ruby",  3030,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Hyaena = new CreatureData("Hyaena", 60, 20, 0, 0, 20, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Worms",  3492,  LootPossibility.Normal,  4), new Loot("Meat",  0,  LootPossibility.Normal,  2)}
      );
      public static CreatureData Hydra = new CreatureData("Hydra", 2350, 2100, 0, 0, 750, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  250), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Ham",  0,  LootPossibility.Normal,  4), new Loot("Small Sapphire",  3029,  LootPossibility.SemiRare,  0), new Loot("Knight Armor",  3370,  LootPossibility.Rare,  0), new Loot("Warrior Helmet",  3369,  LootPossibility.Rare,  0), new Loot("Stone Skin Amulet",  3081,  LootPossibility.Rare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("Hydra Egg",  4839,  LootPossibility.Rare,  0), new Loot("Life Crystal",  3061,  LootPossibility.VeryRare,  0), new Loot("Royal Helmet",  3392,  LootPossibility.VeryRare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.VeryRare,  0), new Loot("Medusa Shield",  3436,  LootPossibility.VeryRare,  0), new Loot("Boots of Haste",  3079,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData IceGolem = new CreatureData("Ice Golem", 385, 295, 0, 0, 305, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  53), new Loot("Ice Cube",  7441,  LootPossibility.Rare,  0), new Loot("Ice Rapier",  3284,  LootPossibility.SemiRare,  0), new Loot("Black Pearl",  3027,  LootPossibility.SemiRare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Rare,  0), new Loot("Small Diamond",  3028,  LootPossibility.Rare,  0), new Loot("Crystal Sword",  7449,  LootPossibility.Rare,  0), new Loot("Strange Helmet",  0,  LootPossibility.Rare,  0), new Loot("Shard",  7290,  LootPossibility.Rare,  0), new Loot("Spike Sword",  0,  LootPossibility.VeryRare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.VeryRare,  0), new Loot("Glacier Mask",  829,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData IceWitch = new CreatureData("Ice Witch", 650, 580, 0, 0, 394, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Ice Cube",  7441,  LootPossibility.Normal,  0), new Loot("Clerical Mace",  3311,  LootPossibility.Normal,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Normal,  0), new Loot("Shard",  7290,  LootPossibility.SemiRare,  0), new Loot("Crystal Sword",  7449,  LootPossibility.SemiRare,  0), new Loot("Glacier Shoes",  0,  LootPossibility.Rare,  0), new Loot("Diamond Sceptre",  7387,  LootPossibility.Rare,  0), new Loot("Mystic Turban",  3574,  LootPossibility.Rare,  0), new Loot("Glacier Kilt",  823,  LootPossibility.VeryRare,  0), new Loot("Earmuffs",  7459,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Incineron = new CreatureData("Incineron", 7000, 3500, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Fire, DamageType.Ice},
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  20)},
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData Infernalist = new CreatureData("Infernalist", 3650, 4000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  115), new Loot("Raspberry",  0,  LootPossibility.Normal,  5), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Skull Staff",  3324,  LootPossibility.SemiRare,  0), new Loot("Red Piece of Cloth",  5911,  LootPossibility.SemiRare,  0), new Loot("Small Enchanted Ruby",  676,  LootPossibility.SemiRare,  0), new Loot("Energy Ring",  3051,  LootPossibility.Rare,  0), new Loot("Magic Sulphur",  5904,  LootPossibility.Rare,  0), new Loot("Spellbook of Mind Control",  8074,  LootPossibility.Rare,  0), new Loot("Royal Tapestry",  0,  LootPossibility.Rare,  0), new Loot("Red Tome",  2852,  LootPossibility.Rare,  0), new Loot("Gold Ingot",  9058,  LootPossibility.VeryRare,  0), new Loot("Black Skull",  0,  LootPossibility.VeryRare,  0), new Loot("Magma Boots",  818,  LootPossibility.VeryRare,  0), new Loot("Queen's Sceptre",  0,  LootPossibility.VeryRare,  0), new Loot("Crystal of Power",  9067,  LootPossibility.VeryRare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData InsectSwarm = new CreatureData("Insect Swarm", 50, 40, 0, 0, 13, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  1) },
          new List<string>() { },
      ...
      public static CreatureData IslandTroll = new CreatureData("Island Troll", 50, 20, 0, 0, 10, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Wood",  5901,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Spear",  3277,  LootPossibility.Normal,  0), new Loot("H",  0,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Leather Boots",  3552,  LootPossibility.Normal,  0), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Wooden Shield",  3412,  LootPossibility.Normal,  0), new Loot("Rope",  3003,  LootPossibility.Normal,  0), new Loot("Studded Club",  3336,  LootPossibility.Normal,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Rare,  0), new Loot("Marlin",  901,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData JaggedEarthElemental = new CreatureData("Jagged Earth Elemental", 0, 1300, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  180), new Loot("Some Leaves",  0,  LootPossibility.Normal,  0), new Loot("Twigs",  0,  LootPossibility.Normal,  0), new Loot("Small Stones Seeds",  0,  LootPossibility.Rare,  10), new Loot("Iron Ore",  5880,  LootPossibility.Rare,  0), new Loot("Small Emeralds",  0,  LootPossibility.Rare,  2), new Loot("Natural Soil",  0,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Juggernaut = new CreatureData("Juggernaut", 20000, 8700, 0, 0, 2260, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  400), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  5), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  8), new Loot("Ham",  0,  LootPossibility.Normal,  8), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  3), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  4), new Loot("Rusty Armor",  0,  LootPossibility.Rare,  0), new Loot("Dirty Fur",  0,  LootPossibility.Normal,  0), new Loot("Broken Pottery",  0,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.SemiRare,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Dragon Hammer",  3322,  LootPossibility.SemiRare,  0), new Loot("Spiked Squelcher",  0,  LootPossibility.SemiRare,  0), new Loot("Gold Ingot",  9058,  LootPossibility.Rare,  0), new Loot("Demonbone Amulet",  3019,  LootPossibility.Rare,  0), new Loot("Golden Legs",  3364,  LootPossibility.Rare,  0), new Loot("Golden Armor",  3360,  LootPossibility.Rare,  0), new Loot("Mastermind Shield",  3414,  LootPossibility.VeryRare,  0), new Loot("Skullcracker Armor",  8061,  LootPossibility.VeryRare,  0), new Loot("Heavy Mace",  3340,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData KillerCaiman = new CreatureData("Killer Caiman", 1500, 800, 0, 0, 300, false, true, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  5), new DamageModifier(DamageType.Ice,  10), new DamageModifier(DamageType.Earth,  20)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  5) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  120), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Piece of Crocodile Leather",  0,  LootPossibility.Normal,  0), new Loot("Crocodile Boots",  3556,  LootPossibility.Rare,  0), new Loot("Giant Shimmering Pearl",  0,  LootPossibility.Rare,  0), new Loot("Small Emerald",  3032,  LootPossibility.Rare,  0), new Loot("Bunch of Ripe Rice‎",  0,  LootPossibility.Rare,  2)}
      );
      ...
      public static CreatureData Kongra = new CreatureData("Kongra", 340, 115, 0, 0, 60, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  40), new Loot("Banana",  0,  LootPossibility.Normal,  11), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0), new Loot("Power Ring",  3050,  LootPossibility.Normal,  0), new Loot("Club Ring",  3093,  LootPossibility.SemiRare,  0), new Loot("Plate Armor",  3357,  LootPossibility.SemiRare,  0), new Loot("Health Potion",  266,  LootPossibility.SemiRare,  0), new Loot("Ape Fur",  5883,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData LancerBeetle = new CreatureData("Lancer Beetle", 400, 250, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  50)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Ice,  5) },
          new List<string>() { "Crump!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  121), new Loot("Lump of Dirt",  0,  LootPossibility.Normal,  0), new Loot("Poisonous Slime",  0,  LootPossibility.Normal,  0), new Loot("Lancer Beetle Shell",  0,  LootPossibility.Normal,  0), new Loot("Beetle Necklace",  0,  LootPossibility.VeryRare,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Larva = new CreatureData("Larva", 70, 44, 0, 0, 36, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Ice,  5) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Meat",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Lersatio = new CreatureData("Lersatio", 0, 2500, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  5), new Loot("Gold",  0,  LootPossibility.Normal,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Ring of healing",  3098,  LootPossibility.SemiRare,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Rare,  0), new Loot("Dreaded Cleaver",  7419,  LootPossibility.Rare,  0)}
      );
      public static CreatureData LethalLissy = new CreatureData("Lethal Lissy", 1450, 500, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  102), new Loot("Knight Armor",  3370,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Skull",  0,  LootPossibility.Normal,  2), new Loot("Lethal Lissy's Shirt",  6100,  LootPossibility.Always,  0)}
      );
      public static CreatureData Leviathan = new CreatureData("Leviathan", 6000, 5000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  234), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  6), new Loot("Small Sapphires",  0,  LootPossibility.Normal,  3), new Loot("Glacier Amulet",  815,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Focus Cape",  8043,  LootPossibility.Normal,  0), new Loot("Northwind Rod",  8083,  LootPossibility.Normal,  0), new Loot("Glacier Kilt",  823,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Crystalline Armor",  0,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.SemiRare,  0), new Loot("Rusty Legs",  8897,  LootPossibility.Rare,  0), new Loot("Bonebreaker",  0,  LootPossibility.Normal,  0), new Loot("Moon Backpack",  9604,  LootPossibility.Rare,  0), new Loot("Oceanborn Leviathan Armor",  0,  LootPossibility.VeryRare,  0), new Loot("Sea Serpent Trophy",  0,  LootPossibility.Always,  0), new Loot("Leviathan's Amulet",  0,  LootPossibility.Always,  0)}
      );
      public static CreatureData Lich = new CreatureData("Lich", 880, 900, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  120), new Loot("Staff",  3289,  LootPossibility.Normal,  0), new Loot("Spellbook",  648,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.Normal,  0), new Loot("White Pearl",  3026,  LootPossibility.Normal,  0), new Loot("Dirty Cape",  0,  LootPossibility.Normal,  0), new Loot("Strange Helmet",  0,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Normal,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.VeryRare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("Lightning Boots",  820,  LootPossibility.Rare,  0), new Loot("Blue Robe",  3567,  LootPossibility.VeryRare,  0), new Loot("Castle Shield",  3435,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData LizardChosen = new CreatureData("Lizard Chosen", 3050, 2200, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  10)},
          new List<DamageModifier>() {  },
          new List<string>() { "Grzzzzzzz!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  224), new Loot("Spiked Iron Ball",  0,  LootPossibility.Normal,  0), new Loot("Cursed Shoulder Spikes",  0,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Corrupted flag",  0,  LootPossibility.SemiRare,  0), new Loot("Lizard Leather rare)",  0,  LootPossibility.Normal,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Rare,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.Rare,  0), new Loot("Zaoan Helmet",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData LizardDragonPriest = new CreatureData("Lizard Dragon Priest", 1450, 1200, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  45)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  137), new Loot("Dragon Priest's W",  0,  LootPossibility.Normal,  0), new Loot("tip",  0,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Lizard Leather",  5876,  LootPossibility.Normal,  0), new Loot("Bunch of Ripe Rice",  0,  LootPossibility.Normal,  0), new Loot("Life Ring",  3052,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  0), new Loot("Terra Rod",  3065,  LootPossibility.Rare,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.Rare,  0), new Loot("Zaoan Robe",  0,  LootPossibility.VeryRare,  0), new Loot("Yellow Gem",  3037,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData LizardGateGuardian = new CreatureData("Lizard Gate Guardian", 3000, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coins",  0,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Normal,  0), new Loot("Zaoan Helmet",  0,  LootPossibility.SemiRare,  0), new Loot("Zaoan Sword",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData LizardHighGuard = new CreatureData("Lizard High Guard", 1800, 1450, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  45)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  220), new Loot("Spiked Iron Ball",  0,  LootPossibility.Normal,  0), new Loot("High Guard's Shoulderplates",  0,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Normal,  0), new Loot("High Guard Flag",  0,  LootPossibility.Rare,  0), new Loot("Small Emerald",  3032,  LootPossibility.SemiRare,  0), new Loot("Zaoan Legs",  0,  LootPossibility.Rare,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.SemiRare,  0), new Loot("Bunch of Ripe Rice",  0,  LootPossibility.Rare,  0), new Loot("Lizard Leather",  5876,  LootPossibility.Rare,  0), new Loot("Red Lantern",  0,  LootPossibility.Rare,  0), new Loot("Zaoan Armor",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData LizardLegionnaire = new CreatureData("Lizard Legionnaire", 1400, 1100, 0, 0, 460, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  45)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { "Tssss!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  136), new Loot("Legionnaire's Flags",  0,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0), new Loot("Lizard Trophy",  0,  LootPossibility.Normal,  0), new Loot("Broken Halberd",  0,  LootPossibility.SemiRare,  0), new Loot("Zaoan Halberd",  0,  LootPossibility.SemiRare,  0), new Loot("Zaoan Shoes",  0,  LootPossibility.Rare,  0), new Loot("Drakinata",  0,  LootPossibility.VeryRare,  0), new Loot("Zaoan Armor",  0,  LootPossibility.VeryRare,  0), new Loot("Small Diamond",  3028,  LootPossibility.VeryRare,  0), new Loot("Red Lantern",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData LizardSentinel = new CreatureData("Lizard Sentinel", 265, 110, 0, 0, 115, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { "Tssss!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  60), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Spear",  3277,  LootPossibility.Normal,  3), new Loot("Hunting Spear",  3347,  LootPossibility.SemiRare,  0), new Loot("Obsidian Lance",  3313,  LootPossibility.SemiRare,  0), new Loot("Halberd",  3269,  LootPossibility.SemiRare,  0), new Loot("Sentinel Shield",  3444,  LootPossibility.SemiRare,  0), new Loot("Lizard Leather",  5876,  LootPossibility.SemiRare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Rare,  0), new Loot("Small Diamond",  3028,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData LizardSnakecharmer = new CreatureData("Lizard Snakecharmer", 325, 210, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  70), new Loot("Dead Snake",  3998,  LootPossibility.Normal,  0), new Loot("Dirty Cape",  0,  LootPossibility.Normal,  0), new Loot("Cape",  0,  LootPossibility.Normal,  0), new Loot("Lizard Leather",  5876,  LootPossibility.SemiRare,  0), new Loot("Snakebite Rod",  3066,  LootPossibility.Rare,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Rare,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Rare,  0), new Loot("Terra Rod",  3065,  LootPossibility.VeryRare,  0), new Loot("Mana Potion",  268,  LootPossibility.VeryRare,  0), new Loot("Yellow Gem",  3037,  LootPossibility.VeryRare,  0), new Loot("Life Crystal",  3061,  LootPossibility.VeryRare,  0), new Loot("Life Ring",  3052,  LootPossibility.VeryRare,  0), new Loot("Charmer's Tiara",  3407,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData LizardTemplar = new CreatureData("Lizard Templar", 410, 155, 0, 0, 70, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  60), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.SemiRare,  0), new Loot("Lizard Leather",  5876,  LootPossibility.SemiRare,  0), new Loot("Plate Armor",  3357,  LootPossibility.Rare,  0), new Loot("Templar Scytheblade",  3345,  LootPossibility.Rare,  0), new Loot("Small Emerald",  3032,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Rare,  0), new Loot("Salam",  0,  LootPossibility.Normal,  0), new Loot("er Shield",  0,  LootPossibility.Rare,  0)}
      );
      public static CreatureData LizardZaogun = new CreatureData("Lizard Zaogun", 2955, 1700, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  5), new DamageModifier(DamageType.Death,  10), new DamageModifier(DamageType.Fire,  45), new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  15)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Zaogun's Shoulderplates",  0,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Red Lantern Strong Health Potion",  0,  LootPossibility.Normal,  0), new Loot("Lizard Scale",  5881,  LootPossibility.Normal,  0), new Loot("Small Emerald",  3032,  LootPossibility.SemiRare,  0), new Loot("Zaogun Flag",  0,  LootPossibility.Rare,  0), new Loot("Zaoan Legs",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData LostSoul = new CreatureData("Lost Soul", 5800, 4000, 0, 0, 600, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  320), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  3), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Rotten Meat",  0,  LootPossibility.Normal,  2), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Legion Helmet",  3374,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Silver Goblet",  0,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  2), new Loot("Titan Axe",  7413,  LootPossibility.SemiRare,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Rare,  0), new Loot("Ruby Necklace",  3016,  LootPossibility.Rare,  0), new Loot("Death Ring",  6299,  LootPossibility.Rare,  0), new Loot("Skeleton Decoration",  6525,  LootPossibility.Rare,  0), new Loot("Key Ring",  5801,  LootPossibility.Rare,  0), new Loot("Stone Skin Amulet",  3081,  LootPossibility.Rare,  0), new Loot("Skull Staff",  3324,  LootPossibility.Rare,  0), new Loot("Amulet of Loss",  3057,  LootPossibility.Normal,  0)}
      );
      public static CreatureData MadScientist = new CreatureData("Mad Scientist", 325, 205, 0, 0, 127, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  120), new Loot("Mana Potion",  268,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0), new Loot("Powder Herb",  0,  LootPossibility.SemiRare,  0), new Loot("Life Crystal",  3061,  LootPossibility.Rare,  0), new Loot("Small Enchanted Amethyst",  678,  LootPossibility.Rare,  0), new Loot("White Mushroom",  0,  LootPossibility.Rare,  3), new Loot("Cream Cake",  0,  LootPossibility.Rare,  0), new Loot("Cookie",  0,  LootPossibility.Rare,  5), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("rare)",  0,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("Of Vortex",  0,  LootPossibility.VeryRare,  0), new Loot("Mastermind Potion",  7440,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData MadTechnomancer = new CreatureData("Mad Technomancer", 0, 55, 0, 0, 350, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Technomancer Beard",  396,  LootPossibility.Always,  0)}
      );
      public static CreatureData Madareth = new CreatureData("Madareth", 0, 10000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  30), new Loot("Demon Horns",  0,  LootPossibility.Normal,  2), new Loot("Small Diamonds",  0,  LootPossibility.Normal,  2), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Rusty Legs",  8897,  LootPossibility.Normal,  0), new Loot("Mastermind Shield",  3414,  LootPossibility.Normal,  0), new Loot("Demon Shield",  3420,  LootPossibility.Normal,  0), new Loot("Mastermind Potion",  7440,  LootPossibility.Normal,  0), new Loot("Berserk Potion",  7439,  LootPossibility.Normal,  0), new Loot("Bullseye Potion",  7443,  LootPossibility.Normal,  0), new Loot("Axe Ring",  3092,  LootPossibility.Normal,  0), new Loot("Death Ring",  6299,  LootPossibility.Normal,  0), new Loot("Sword Ring",  3091,  LootPossibility.Normal,  0), new Loot("Club Ring",  3093,  LootPossibility.Normal,  0), new Loot("Ring Of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Great Spirit Potion",  7642,  LootPossibility.Normal,  0), new Loot("Time Ring",  3053,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Inferno",  0,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Starstorm",  0,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Voodoo",  0,  LootPossibility.Normal,  0), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Underworld Rod",  8082,  LootPossibility.Normal,  0), new Loot("Hailstorm Rod",  3067,  LootPossibility.Normal,  0), new Loot("Springsprout Rod",  8084,  LootPossibility.Normal,  0), new Loot("Lyre",  0,  LootPossibility.Normal,  0), new Loot("Wooden Flute",  0,  LootPossibility.Normal,  0), new Loot("Lute",  2950,  LootPossibility.Normal,  0), new Loot("War Drum",  0,  LootPossibility.Normal,  0), new Loot("War Horn",  2958,  LootPossibility.Normal,  0), new Loot("Didgeridoo",  0,  LootPossibility.Normal,  0), new Loot("Bloody Edge",  0,  LootPossibility.Normal,  0), new Loot("Crystal Sword",  7449,  LootPossibility.Normal,  0), new Loot("Mercenary Sword",  7386,  LootPossibility.Normal,  0), new Loot("Relic Sword",  7383,  LootPossibility.Normal,  0), new Loot("Assassin Dagger",  0,  LootPossibility.Normal,  0), new Loot("Nightmare Blade",  7418,  LootPossibility.Normal,  0), new Loot("Haunted Blade",  7407,  LootPossibility.Normal,  0), new Loot("Two H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Ice Rapier",  3284,  LootPossibility.Normal,  0), new Loot("Boots of Haste",  3079,  LootPossibility.Normal,  0), new Loot("Demon Helmet",  3387,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Mahrdis = new CreatureData("Mahrdis", 3900, 3050, 0, 0, 2400, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  214), new Loot("Small Rubies",  0,  LootPossibility.Normal,  3), new Loot("Life Ring",  3052,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Red Gem",  3039,  LootPossibility.Rare,  0), new Loot("Fire Axe",  3320,  LootPossibility.VeryRare,  0), new Loot("Holy Falcon",  0,  LootPossibility.VeryRare,  0), new Loot("Phoenix Shield",  3439,  LootPossibility.VeryRare,  0), new Loot("Burning Heart",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Mammoth = new CreatureData("Mammoth", 320, 160, 0, 0, 110, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Ham",  0,  LootPossibility.Normal,  3), new Loot("Tusk",  3044,  LootPossibility.Rare,  2), new Loot("Furry Club",  7432,  LootPossibility.Rare,  0), new Loot("Tusk Shield",  3443,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData ManintheCave = new CreatureData("Man in the Cave", 485, 770, 0, 0, 157, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  27), new Loot("Ropes",  0,  LootPossibility.Normal,  3), new Loot("Brown Bread",  0,  LootPossibility.Normal,  0), new Loot("Brown Piece of Cloth",  5913,  LootPossibility.Normal,  0), new Loot("Mammoth Fur Cape",  7463,  LootPossibility.Normal,  0), new Loot("Mercenary Sword",  7386,  LootPossibility.Normal,  0), new Loot("Shard",  7290,  LootPossibility.Normal,  0), new Loot("Fur Cap",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Marid = new CreatureData("Marid", 550, 410, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  130), new Loot("Blueberry",  0,  LootPossibility.Normal,  25), new Loot("Royal Spear",  7378,  LootPossibility.Normal,  3), new Loot("Heavy Machete",  0,  LootPossibility.Normal,  0), new Loot("Small Oil Lamp",  2933,  LootPossibility.Normal,  0), new Loot("Blue Tapestry",  0,  LootPossibility.SemiRare,  0), new Loot("Blue Rose",  3659,  LootPossibility.SemiRare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.SemiRare,  4), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Blue Piece of Cloth",  5912,  LootPossibility.SemiRare,  0), new Loot("Wooden Flute",  0,  LootPossibility.Rare,  0), new Loot("Seeds",  647,  LootPossibility.Rare,  0), new Loot("Hailstorm Rod",  3067,  LootPossibility.Rare,  0), new Loot("Mystic Turban",  3574,  LootPossibility.Rare,  0), new Loot("Magma Monocle",  827,  LootPossibility.Rare,  0), new Loot("Blue Gem",  3041,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Marziel = new CreatureData("Marziel", 0, 3000, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Platinum Coins",  0,  LootPossibility.Normal,  7), new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Rare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Massacre = new CreatureData("Massacre", 32000, 20000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  207), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  6), new Loot("Meat",  0,  LootPossibility.Normal,  9), new Loot("Orichalcum Pearl",  0,  LootPossibility.Normal,  6), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Old Twig",  0,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Golden Armor",  3360,  LootPossibility.SemiRare,  0), new Loot("Heavy Mace",  3340,  LootPossibility.VeryRare,  0), new Loot("Berserker",  0,  LootPossibility.VeryRare,  0), new Loot("Great Shield",  3422,  LootPossibility.VeryRare,  0), new Loot("Piece of Massacre's Shell",  6540,  LootPossibility.Always,  0)}
      );
      public static CreatureData MassiveEarthElemental = new CreatureData("Massive Earth Elemental", 1330, 950, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  15) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  221), new Loot("Small Stones",  0,  LootPossibility.Normal,  10), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Rare,  2), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.Rare,  0), new Loot("Small Topaz",  9057,  LootPossibility.SemiRare,  2), new Loot("Stone Skin Amulet",  3081,  LootPossibility.VeryRare,  0), new Loot("Terra Amulet",  814,  LootPossibility.VeryRare,  0), new Loot("Diamond Sceptre",  7387,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData MassiveEnergyElemental = new CreatureData("Massive Energy Elemental", 1100, 950, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  125), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  3), new Loot("Flash Arrow",  761,  LootPossibility.Normal,  14), new Loot("Rusty Armor",  0,  LootPossibility.SemiRare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Lightning Pendant",  816,  LootPossibility.Rare,  0), new Loot("Spellbook of Warding",  8073,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Starstorm",  0,  LootPossibility.Rare,  0), new Loot("Energy spike sword",  0,  LootPossibility.Rare,  0), new Loot("Shockwave Amulet",  0,  LootPossibility.VeryRare,  0), new Loot("Lightning Legs",  822,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Medusa = new CreatureData("Medusa", 4500, 4050, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  2), new Loot("Small Emeralds",  0,  LootPossibility.Normal,  3), new Loot("Ultimate Health Potions",  0,  LootPossibility.Normal,  2), new Loot("Great Mana Potions",  0,  LootPossibility.Normal,  2), new Loot("White Pearl",  3026,  LootPossibility.Normal,  0), new Loot("Terra Amulet",  814,  LootPossibility.SemiRare,  0), new Loot("Medusa Shield",  3436,  LootPossibility.SemiRare,  0), new Loot("Knight Armor",  3370,  LootPossibility.SemiRare,  0), new Loot("Sacred Tree Amulet",  0,  LootPossibility.Rare,  0), new Loot("Titan Axe",  7413,  LootPossibility.Rare,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Terra Mantle",  811,  LootPossibility.VeryRare,  0), new Loot("Terra Legs",  812,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Menace = new CreatureData("Menace", 0, 0, 0, 0, 215, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData MerikhtheSlaughterer = new CreatureData("Merikh the Slaughterer", 2000, 1500, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  87), new Loot("Green Piece of Cloth",  5910,  LootPossibility.Normal,  4), new Loot("Royal Spear",  7378,  LootPossibility.Normal,  3), new Loot("Seeds",  647,  LootPossibility.Normal,  0), new Loot("Heavy Machete",  0,  LootPossibility.Normal,  0), new Loot("Small Oil Lamp",  2933,  LootPossibility.Normal,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Normal,  2), new Loot("Pears",  0,  LootPossibility.Normal,  8), new Loot("Mystic Turban",  3574,  LootPossibility.Normal,  0), new Loot("Small Emeralds",  0,  LootPossibility.Normal,  2), new Loot("Magma Monocle",  827,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData MidnightSpawn = new CreatureData("Midnight Spawn", 0, 0, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  30), new DamageModifier(DamageType.Death,  99), new DamageModifier(DamageType.Ice,  10), new DamageModifier(DamageType.Earth,  99)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  10), new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Energy,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Midnight Shard",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData MidnightWarrior = new CreatureData("Midnight Warrior", 1000, 750, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth, DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  15), new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  20)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Midnight Shard",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Minishabaal = new CreatureData("Minishabaal", 6000, 4000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Pitchfork",  0,  LootPossibility.Normal,  0), new Loot("Fire Axe",  3320,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  0), new Loot("Surprise Bags",  0,  LootPossibility.Normal,  5), new Loot("Crown Legs",  3382,  LootPossibility.Normal,  0), new Loot("Demon Shield",  3420,  LootPossibility.Normal,  0), new Loot("Guardian Shield",  0,  LootPossibility.Normal,  0), new Loot("Demonbone Amulet",  3019,  LootPossibility.Rare,  0), new Loot("Golden Legs",  3364,  LootPossibility.Rare,  0), new Loot("Tempest Shield",  0,  LootPossibility.VeryRare,  0), new Loot("Demon Helmet",  3387,  LootPossibility.VeryRare,  0), new Loot("Death Ring",  6299,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData MinotaurArcher = new CreatureData("Minotaur Archer", 100, 65, 0, 0, 100, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  28), new Loot("Bolts",  3446,  LootPossibility.Normal,  23), new Loot("Piercing Bolts",  0,  LootPossibility.Normal,  4), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Soldier Helmet",  3375,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Chain Legs",  3558,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.SemiRare,  0), new Loot("Minotaur Leather",  5878,  LootPossibility.Rare,  0), new Loot("Scale Armor",  3377,  LootPossibility.VeryRare,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0)}
      );
      public static CreatureData MinotaurGuard = new CreatureData("Minotaur Guard", 185, 160, 0, 0, 100, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Fishing Rod",  3483,  LootPossibility.Normal,  0), new Loot("Hatchet",  3276,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Chain Legs",  3558,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.SemiRare,  0), new Loot("Minotaur Leather",  5878,  LootPossibility.Rare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0)}
      );
      public static CreatureData MinotaurMage = new CreatureData("Minotaur Mage", 155, 150, 0, 0, 205, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  40), new Loot("Carrots",  0,  LootPossibility.Normal,  8), new Loot("Torches",  0,  LootPossibility.Normal,  2), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Dead Snakes",  0,  LootPossibility.Normal,  2), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Combat Knife",  3292,  LootPossibility.Normal,  0), new Loot("Knife",  3291,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Chain Legs",  3558,  LootPossibility.Normal,  0), new Loot("Minotaur Leather",  5878,  LootPossibility.SemiRare,  0), new Loot("Taurus Mace",  7425,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.VeryRare,  0), new Loot("Mana Potion",  268,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Monk = new CreatureData("Monk", 240, 200, 0, 0, 140, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Bread",  0,  LootPossibility.Normal,  0), new Loot("Scroll",  0,  LootPossibility.Normal,  0), new Loot("Lamp",  0,  LootPossibility.Normal,  0), new Loot("Brown Flask",  0,  LootPossibility.Normal,  0), new Loot("S",  0,  LootPossibility.Normal,  0), new Loot("als",  0,  LootPossibility.Normal,  0), new Loot("Leather Armor",  3361,  LootPossibility.Normal,  0), new Loot("Staff",  3289,  LootPossibility.Normal,  0), new Loot("Life Crystal",  3061,  LootPossibility.SemiRare,  0), new Loot("Ankh",  0,  LootPossibility.SemiRare,  0), new Loot("Power Ring",  3050,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData Mooh = new CreatureData("Mooh", 0, 0, -1, -1, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "",  },
      ...
      public static CreatureData Morgaroth = new CreatureData("Morgaroth", 55000, 15000, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  74), new Loot("Demonic Essences",  0,  LootPossibility.Normal,  5), new Loot("Small Emeralds",  0,  LootPossibility.Normal,  7), new Loot("Small Diamonds",  0,  LootPossibility.Normal,  5), new Loot("White Pearls",  0,  LootPossibility.Normal,  11), new Loot("Small Sapphires",  0,  LootPossibility.Normal,  9), new Loot("Black Pearl",  3027,  LootPossibility.Normal,  13), new Loot("Demon Horns",  0,  LootPossibility.Normal,  2), new Loot("Infernal Bolts",  0,  LootPossibility.Normal,  100), new Loot("Ancient Amulet",  3025,  LootPossibility.Normal,  0), new Loot("Blue Gem",  3041,  LootPossibility.Normal,  0), new Loot("Boots of Haste",  3079,  LootPossibility.Normal,  0), new Loot("Crystal Ball",  3076,  LootPossibility.Normal,  0), new Loot("Crystal Ring",  3007,  LootPossibility.Normal,  0), new Loot("Death Ring",  6299,  LootPossibility.Normal,  0), new Loot("Demon Shield",  3420,  LootPossibility.Normal,  0), new Loot("Demonbone",  0,  LootPossibility.Normal,  0), new Loot("Devil Helmet",  3356,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Fire Axe",  3320,  LootPossibility.Normal,  0), new Loot("Giant Sword",  3281,  LootPossibility.Normal,  0), new Loot("Golden Legs",  3364,  LootPossibility.Normal,  0), new Loot("Golden Mug",  2903,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Great Spirit Potion",  7642,  LootPossibility.Normal,  0), new Loot("Green Gem",  3038,  LootPossibility.Normal,  0), new Loot("Ice Rapier",  3284,  LootPossibility.Normal,  0), new Loot("Life Crystal",  3061,  LootPossibility.Normal,  0), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Magic Plate Armor",  3366,  LootPossibility.Normal,  0), new Loot("Magma Coat",  0,  LootPossibility.Normal,  0), new Loot("Mastermind Shield",  3414,  LootPossibility.Normal,  0), new Loot("Might Ring",  3048,  LootPossibility.Normal,  0), new Loot("Mind Stone",  0,  LootPossibility.Normal,  0), new Loot("Moonlight Rod",  3070,  LootPossibility.Normal,  0), new Loot("Necrotic Rod",  3069,  LootPossibility.Normal,  0), new Loot("Onyx Flail",  0,  LootPossibility.Normal,  0), new Loot("Orb",  0,  LootPossibility.Normal,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.Normal,  0), new Loot("Purple Tome",  2848,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Ring of the Sky",  0,  LootPossibility.Normal,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Normal,  0), new Loot("Silver Dagger",  3290,  LootPossibility.Normal,  0), new Loot("Skull Staff",  3324,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Stone Skin Amulet",  3081,  LootPossibility.Normal,  0), new Loot("Strange Symbol",  0,  LootPossibility.Normal,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Ultimate Health Potion",  7643,  LootPossibility.Normal,  0), new Loot("Chain Bolter",  8022,  LootPossibility.Rare,  0), new Loot("Dark Lord's Cape",  0,  LootPossibility.Rare,  0), new Loot("Fireborn Giant Armor",  8053,  LootPossibility.Rare,  0), new Loot("Great Shield",  3422,  LootPossibility.Rare,  0), new Loot("Molten Plate",  0,  LootPossibility.Rare,  0), new Loot("Morgaroth's Heart",  0,  LootPossibility.Rare,  0), new Loot("Obsidian Truncheon",  8100,  LootPossibility.Rare,  0), new Loot("Royal Crossbow",  8023,  LootPossibility.Rare,  0), new Loot("Teddy Bear",  0,  LootPossibility.Rare,  0), new Loot("The Devileye",  0,  LootPossibility.Rare,  0), new Loot("The Ironworker",  0,  LootPossibility.Rare,  0), new Loot("The Stomper",  0,  LootPossibility.Rare,  0), new Loot("Thunder Hammer",  3309,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Morguthis = new CreatureData("Morguthis", 4800, 3000, 0, 0, 1900, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold",  0,  LootPossibility.Normal,  153), new Loot("Stone Skin Amulet",  3081,  LootPossibility.Normal,  0), new Loot("Knight Axe",  3318,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Demonbone Amulet",  3019,  LootPossibility.VeryRare,  0), new Loot("Ravager's Axe",  0,  LootPossibility.VeryRare,  0), new Loot("Assassin Star",  7368,  LootPossibility.VeryRare,  3), new Loot("Steel Boots",  3554,  LootPossibility.VeryRare,  0), new Loot("Sword Hilt",  0,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData Mummy = new CreatureData("Mummy", 240, 150, 0, 0, 129, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  91), new Loot("worms",  3492,  LootPossibility.Normal,  3), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Magic Light W",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Strange Talisman",  3045,  LootPossibility.Normal,  0), new Loot("Silver Brooch",  0,  LootPossibility.Normal,  0), new Loot("Poison Dagger",  3299,  LootPossibility.Normal,  0), new Loot("Crystal Ring",  3007,  LootPossibility.SemiRare,  0), new Loot("Black Pearl",  3027,  LootPossibility.SemiRare,  0), new Loot("Silver Amulet",  3054,  LootPossibility.Rare,  0), new Loot("Yellow Piece of Cloth",  5914,  LootPossibility.Rare,  0), new Loot("Black Shield",  3429,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Munster = new CreatureData("Munster", 58, 35, 0, 0, 15, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { "Meep!",  "Meeeeep!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  19), new Loot("Worms",  3492,  LootPossibility.Normal,  4), new Loot("Cookie",  0,  LootPossibility.Normal,  0), new Loot("Club",  3270,  LootPossibility.Normal,  0), new Loot("Jacket",  0,  LootPossibility.Normal,  0), new Loot("Cheese",  0,  LootPossibility.Normal,  4), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Bone Club",  3337,  LootPossibility.Always,  0), new Loot("Dice",  5794,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData MutatedBat = new CreatureData("Mutated Bat", 900, 615, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  111), new Loot("Star Herb",  0,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Obsidian Lance",  3313,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  2), new Loot("Bat Wing",  5894,  LootPossibility.SemiRare,  2), new Loot("Black Shield",  3429,  LootPossibility.SemiRare,  0), new Loot("Black Pearl",  3027,  LootPossibility.Rare,  3), new Loot("Small Amethyst",  3033,  LootPossibility.Rare,  2), new Loot("Energy Ring",  3051,  LootPossibility.Rare,  0), new Loot("Mercenary Sword",  7386,  LootPossibility.VeryRare,  0), new Loot("Batwing Hat",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData MutatedHuman = new CreatureData("Mutated Human", 240, 150, 0, 0, 164, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  130), new Loot("Worm",  0,  LootPossibility.Normal,  3), new Loot("Cheese",  0,  LootPossibility.Normal,  0), new Loot("Fishbone",  0,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Studded Armor",  3378,  LootPossibility.Normal,  0), new Loot("Fern",  0,  LootPossibility.SemiRare,  0), new Loot("Strange Talisman",  3045,  LootPossibility.SemiRare,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Rare,  0), new Loot("Peanut",  0,  LootPossibility.Rare,  0), new Loot("Silver Amulet",  3054,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData MutatedRat = new CreatureData("Mutated Rat", 550, 450, 0, 0, 305, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  130), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Moldy Cheese",  0,  LootPossibility.Normal,  0), new Loot("Stone Herb",  0,  LootPossibility.Normal,  0), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.SemiRare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Rare,  0), new Loot("Spellbook of Enlightenment",  8072,  LootPossibility.VeryRare,  0), new Loot("Tower Shield",  3428,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData MutatedTiger = new CreatureData("Mutated Tiger", 1100, 750, 0, 0, 0, false, true, FrontAttack.Wave, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  96), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Life Ring",  3052,  LootPossibility.SemiRare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Silky Tapestry",  9046,  LootPossibility.Rare,  0), new Loot("Glorious Axe",  7454,  LootPossibility.VeryRare,  0), new Loot("Guardian Shield",  0,  LootPossibility.VeryRare,  0), new Loot("Angelic Axe",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Necromancer = new CreatureData("Necromancer", 580, 580, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Poison Arrow",  3448,  LootPossibility.Normal,  5), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Green Mushroom",  0,  LootPossibility.SemiRare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Clerical Mace",  3311,  LootPossibility.SemiRare,  0), new Loot("Mystic Turban",  3574,  LootPossibility.Rare,  0), new Loot("Skull Staff",  3324,  LootPossibility.VeryRare,  0), new Loot("Noble Axe",  7456,  LootPossibility.VeryRare,  0), new Loot("Spellbook of Warding",  8073,  LootPossibility.VeryRare,  0), new Loot("Boots of Haste",  3079,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Necropharus = new CreatureData("Necropharus", 750, 1050, 0, 0, 300, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  79), new Loot("Bone Club",  3337,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Clerical Mace",  3311,  LootPossibility.Normal,  0), new Loot("Mystic Turban",  3574,  LootPossibility.Normal,  0), new Loot("Snakebite Rod",  3066,  LootPossibility.Normal,  0), new Loot("Moonlight Rod",  3070,  LootPossibility.Normal,  0), new Loot("Bowl",  0,  LootPossibility.Normal,  0), new Loot("Grave Flower",  3661,  LootPossibility.Normal,  0), new Loot("Skull Staff",  3324,  LootPossibility.SemiRare,  0), new Loot("Boots of Haste",  3079,  LootPossibility.Rare,  0), new Loot("Soul Stone",  5809,  LootPossibility.Always,  0)}
      );
      public static CreatureData Nightmare = new CreatureData("Nightmare", 2700, 2150, 0, 0, 720, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  120), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Power Bolt",  3450,  LootPossibility.Normal,  4), new Loot("Concentrated Demonic Blood",  0,  LootPossibility.Normal,  2), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Platinum Coin",  3035,  LootPossibility.SemiRare,  4), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("Death Ring",  6299,  LootPossibility.SemiRare,  0), new Loot("Ancient Shield",  3432,  LootPossibility.Rare,  0), new Loot("Knight Legs",  3371,  LootPossibility.Rare,  0), new Loot("Steel Helmet",  3351,  LootPossibility.Rare,  0), new Loot("War Axe",  3342,  LootPossibility.VeryRare,  0), new Loot("Skeleton Decoration",  6525,  LootPossibility.Rare,  0), new Loot("Boots of Haste",  3079,  LootPossibility.VeryRare,  0), new Loot("Mysterious Voodoo Skull",  5668,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData NightmareScion = new CreatureData("Nightmare Scion", 1400, 1350, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  147), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  3), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Death Ring",  6299,  LootPossibility.Rare,  0), new Loot("Crown Helmet",  3385,  LootPossibility.Rare,  0), new Loot("Focus Cape",  8043,  LootPossibility.Rare,  0), new Loot("Crystal of Focus",  0,  LootPossibility.VeryRare,  0), new Loot("Diamond Sceptre",  7387,  LootPossibility.Rare,  0), new Loot("Bar of Chocolate",  0,  LootPossibility.VeryRare,  0), new Loot("Shadow Sceptre",  7451,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Nightslayer = new CreatureData("Nightslayer", 400, 375, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Fire, DamageType.Paralysis},
          new List<DamageModifier>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  5), new DamageModifier(DamageType.Death,  5) },
          new List<string>() { },
      ...
      public static CreatureData Nightstalker = new CreatureData("Nightstalker", 700, 500, 0, 0, 260, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  107), new Loot("Shadow Herb",  0,  LootPossibility.Normal,  0), new Loot("Crystal Ring",  3007,  LootPossibility.SemiRare,  0), new Loot("Protection Amulet",  3084,  LootPossibility.SemiRare,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.Rare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.Rare,  0), new Loot("Spirit Cloak",  0,  LootPossibility.Rare,  0), new Loot("Crystal of Balance",  0,  LootPossibility.VeryRare,  0), new Loot("Haunted Blade",  7407,  LootPossibility.VeryRare,  0), new Loot("Chaos Mace",  7427,  LootPossibility.VeryRare,  0), new Loot("Boots of Haste",  3079,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Nomad = new CreatureData("Nomad", 160, 60, 0, 0, 80, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  51), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Brass Shield",  3411,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.SemiRare,  0), new Loot("Steel Shield",  3409,  LootPossibility.Rare,  0), new Loot("Iron Helmet",  3353,  LootPossibility.Rare,  0), new Loot("Parchment",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData NoviceoftheCult = new CreatureData("Novice of the Cult", 285, 100, 0, 0, 146, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Scarf",  3572,  LootPossibility.SemiRare,  0), new Loot("Orange Book",  0,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Vortex",  0,  LootPossibility.Rare,  0), new Loot("Pirate Voodoo Doll",  0,  LootPossibility.VeryRare,  0), new Loot("Dwarven Ring",  3097,  LootPossibility.VeryRare,  0), new Loot("Music Sheet",  0,  LootPossibility.Normal,  0), new Loot("very rare)",  0,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.VeryRare,  0), new Loot("Garlic Necklace",  3083,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Omruc = new CreatureData("Omruc", 4300, 2950, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  160), new Loot("Apple",  0,  LootPossibility.Normal,  2), new Loot("Arrow",  3447,  LootPossibility.Normal,  21), new Loot("Poison Arrow",  3448,  LootPossibility.Normal,  20), new Loot("Burst Arrow",  3449,  LootPossibility.Normal,  15), new Loot("Onyx Arrow 0-3 Power Bolt",  0,  LootPossibility.Normal,  2), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  3), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Normal,  0), new Loot("Yellow Gem",  3037,  LootPossibility.Normal,  0), new Loot("Boots of Haste",  3079,  LootPossibility.Rare,  0), new Loot("Hammer of Wrath",  3332,  LootPossibility.VeryRare,  0), new Loot("Crystal Arrow",  3239,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Orc = new CreatureData("Orc", 70, 25, 0, 0, 35, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Studded Armor",  3378,  LootPossibility.Normal,  0), new Loot("Studded Helmet",  3376,  LootPossibility.Normal,  0), new Loot("Studded Shield",  3426,  LootPossibility.Normal,  0), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Old",  0,  LootPossibility.Normal,  0), new Loot("Used Backpack",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData OrcBerserker = new CreatureData("Orc Berserker", 210, 195, 0, 0, 200, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Lamp",  0,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Battle Axe",  3266,  LootPossibility.Normal,  0), new Loot("Hunting Spears",  0,  LootPossibility.SemiRare,  2), new Loot("Halberd",  3269,  LootPossibility.SemiRare,  0)}
      );
      public static CreatureData OrcLeader = new CreatureData("Orc Leader", 450, 270, 0, 0, 255, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  35), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Throwing Knife",  3298,  LootPossibility.Normal,  4), new Loot("Scimitar",  3307,  LootPossibility.Normal,  0), new Loot("Dagger",  3267,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Backpack",  0,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.SemiRare,  0), new Loot("Plate Armor",  3357,  LootPossibility.Rare,  0), new Loot("Royal Spear",  7378,  LootPossibility.Rare,  0), new Loot("Sword Ring",  3091,  LootPossibility.Rare,  0), new Loot("Plate Legs",  3557,  LootPossibility.Rare,  0), new Loot("Broadsword",  3301,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.VeryRare,  0), new Loot("Warrior Helmet",  3369,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData OrcMarauder = new CreatureData("Orc Marauder", 235, 205, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { },
          ...
          new List<string>() { "Grrrrrr",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  83), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Orcish Axe",  3316,  LootPossibility.Normal,  0), new Loot("Bow",  3350,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Obsidian Lance",  3313,  LootPossibility.Normal,  0), new Loot("Shaggy Tail",  0,  LootPossibility.SemiRare,  0), new Loot("Orc Tooth",  0,  LootPossibility.SemiRare,  0), new Loot("Silkweaver Bow",  8029,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData OrcRider = new CreatureData("Orc Rider", 180, 110, 0, 0, 120, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  87), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Backpack",  0,  LootPossibility.Normal,  0), new Loot("Wolf Tooth Chain",  3012,  LootPossibility.Normal,  0), new Loot("Orcish Axe",  3316,  LootPossibility.Normal,  0), new Loot("Studded Helmet",  3376,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.SemiRare,  0), new Loot("Obsidian Lance",  3313,  LootPossibility.Rare,  0)}
      );
      public static CreatureData OrcShaman = new CreatureData("Orc Shaman", 115, 110, 0, 0, 81, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  5), new Loot("Corncobs",  0,  LootPossibility.Normal,  2), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Chain Helmet",  3352,  LootPossibility.Normal,  0), new Loot("Spear",  3277,  LootPossibility.Normal,  0), new Loot("Grey Small Book",  0,  LootPossibility.Normal,  0), new Loot("Staff",  3289,  LootPossibility.SemiRare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Decay",  0,  LootPossibility.Rare,  0)}
      );
      public static CreatureData OrcSpearman = new CreatureData("Orc Spearman", 105, 38, 0, 0, 55, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  11), new Loot("Studded Legs",  3362,  LootPossibility.Normal,  0), new Loot("Spear",  3277,  LootPossibility.Normal,  0), new Loot("Machete",  3308,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Studded Helmet",  3376,  LootPossibility.Normal,  0), new Loot("Dirty Fur",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData OrcWarlord = new CreatureData("Orc Warlord", 950, 670, 0, 0, 450, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  50), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Fish",  0,  LootPossibility.Normal,  2), new Loot("Scimitar",  3307,  LootPossibility.Normal,  0), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Hunting Spear",  3347,  LootPossibility.Normal,  0), new Loot("Throwing Stars",  0,  LootPossibility.Normal,  22), new Loot("Orcish Axe",  3316,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0), new Loot("Dark Helmet",  3384,  LootPossibility.Normal,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Dragon Hammer",  3322,  LootPossibility.Rare,  0), new Loot("Crusader Helmet",  3391,  LootPossibility.Rare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("Orc Trophy",  7395,  LootPossibility.VeryRare,  0), new Loot("Golden Ring",  0,  LootPossibility.VeryRare,  0), new Loot("Magma Boots",  818,  LootPossibility.VeryRare,  0), new Loot("on Thais)",  0,  LootPossibility.Normal,  0), new Loot("Amazon Armor",  3394,  LootPossibility.Normal,  0), new Loot("on Thais)",  0,  LootPossibility.Normal,  0), new Loot("Amazon Shield",  3437,  LootPossibility.Normal,  0)}
      );
      public static CreatureData OrcWarrior = new CreatureData("Orc Warrior", 125, 50, 0, 0, 60, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Wooden Shield",  3412,  LootPossibility.Normal,  0), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Bottle",  0,  LootPossibility.Normal,  0), new Loot("Copper Shield",  3430,  LootPossibility.SemiRare,  0), new Loot("Studded Club",  3336,  LootPossibility.Rare,  0), new Loot("Poison Dagger",  3299,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData OverchargedEnergyElement = new CreatureData("Overcharged Energy Element", 1750, 1300, 0, 0, 895, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  50), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Energy Soil",  0,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Rare,  2), new Loot("Berserk Potion",  7439,  LootPossibility.Rare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Starstorm",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Penguin = new CreatureData("Penguin", 33, 0, 0, 0, 3, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Fish",  0,  LootPossibility.SemiRare,  2), new Loot("Green Perch",  0,  LootPossibility.Rare,  0), new Loot("Rainbow Trout",  0,  LootPossibility.Rare,  0), new Loot("Northern Pike",  0,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Phantasm = new CreatureData("Phantasm", 3950, 4400, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Blank Rune",  0,  LootPossibility.Normal,  2), new Loot("Shadow Herb",  0,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Small Emerald",  3032,  LootPossibility.Normal,  2), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.SemiRare,  0), new Loot("Abyss Hammer",  7414,  LootPossibility.Rare,  0), new Loot("Platinum Coin",  3035,  LootPossibility.Rare,  0), new Loot("Crown Armor",  3381,  LootPossibility.Rare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.VeryRare,  0), new Loot("Death Ring",  6299,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData PirateBuccaneer = new CreatureData("Pirate Buccaneer", 425, 250, 0, 0, 260, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  59), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Worn Leather Boots",  0,  LootPossibility.Normal,  0), new Loot("Throwing Knives",  0,  LootPossibility.Normal,  6), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.SemiRare,  0), new Loot("Battle Shield",  3413,  LootPossibility.SemiRare,  0), new Loot("Treasure Map",  0,  LootPossibility.Normal,  0), new Loot("Pirate Shirt",  6095,  LootPossibility.Rare,  0), new Loot("Plate Armor",  3357,  LootPossibility.Rare,  0), new Loot("Peg Leg",  6126,  LootPossibility.Rare,  0), new Loot("Eye Patch",  6098,  LootPossibility.Rare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.VeryRare,  0), new Loot("Pirate Backpack",  5926,  LootPossibility.VeryRare,  0), new Loot("Hook",  6097,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData PirateCorsair = new CreatureData("Pirate Corsair", 675, 350, 0, 0, 320, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Dark Shield",  3421,  LootPossibility.Normal,  0), new Loot("Dark Armor",  3383,  LootPossibility.Normal,  0), new Loot("Throwing Stars",  0,  LootPossibility.Normal,  12), new Loot("Treasure Map",  0,  LootPossibility.Normal,  0), new Loot("Hook",  6097,  LootPossibility.SemiRare,  0), new Loot("Peg Leg",  6126,  LootPossibility.SemiRare,  0), new Loot("Eye Patch",  6098,  LootPossibility.SemiRare,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Rare,  0), new Loot("Skull C",  0,  LootPossibility.Normal,  0), new Loot("le",  0,  LootPossibility.Rare,  0), new Loot("Pirate Backpack",  5926,  LootPossibility.Rare,  0), new Loot("Pirate Hat",  0,  LootPossibility.Rare,  0), new Loot("Pirate Boots",  5461,  LootPossibility.VeryRare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData PirateCutthroat = new CreatureData("Pirate Cutthroat", 325, 175, 0, 0, 271, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  48), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Peg Leg",  6126,  LootPossibility.SemiRare,  0), new Loot("Hook",  6097,  LootPossibility.SemiRare,  0), new Loot("Eye Patch",  6098,  LootPossibility.SemiRare,  0), new Loot("Dice",  5794,  LootPossibility.SemiRare,  0), new Loot("Pirate Knee Breeches",  5918,  LootPossibility.Rare,  0), new Loot("Rum Flask",  0,  LootPossibility.Rare,  0), new Loot("Light Shovel",  5710,  LootPossibility.Rare,  0), new Loot("Pirate Bag",  0,  LootPossibility.Rare,  0), new Loot("Treasure Map",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData PirateGhost = new CreatureData("Pirate Ghost", 275, 250, 0, 0, 240, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  69), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Dirty Cape",  0,  LootPossibility.Normal,  0), new Loot("Torn Book",  0,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Rare,  0), new Loot("Parchment",  0,  LootPossibility.Rare,  0), new Loot("Spike Sword",  0,  LootPossibility.VeryRare,  0), new Loot("Red Robe",  3566,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData PirateMarauder = new CreatureData("Pirate Marauder", 210, 125, 0, 0, 180, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  60), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Spears",  0,  LootPossibility.Normal,  2), new Loot("B",  0,  LootPossibility.Normal,  0), new Loot("ana",  0,  LootPossibility.SemiRare,  0), new Loot("Peg Leg",  6126,  LootPossibility.SemiRare,  0), new Loot("Hook",  6097,  LootPossibility.SemiRare,  0), new Loot("Eye Patch",  6098,  LootPossibility.SemiRare,  0), new Loot("Treasure Map",  0,  LootPossibility.SemiRare,  0), new Loot("Rum Flask",  0,  LootPossibility.SemiRare,  0), new Loot("Pirate Bag",  0,  LootPossibility.SemiRare,  0), new Loot("Empty Goldfish Bowl",  0,  LootPossibility.Rare,  0), new Loot("Dice",  5794,  LootPossibility.Rare,  0)}
      );
      public static CreatureData PirateSkeleton = new CreatureData("Pirate Skeleton", 190, 85, 0, 0, 50, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  25) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  25), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Bone Club",  3337,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Plaguesmith = new CreatureData("Plaguesmith", 8250, 4500, 0, 0, 800, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  231), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  3), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  3), new Loot("Onyx Arrow",  7365,  LootPossibility.Normal,  3), new Loot("Moldy Cheese",  0,  LootPossibility.Normal,  0), new Loot("Piece of Iron",  0,  LootPossibility.Normal,  0), new Loot("Silver Brooch",  0,  LootPossibility.Normal,  0), new Loot("Dirty Cape",  0,  LootPossibility.Normal,  0), new Loot("Crowbar",  3304,  LootPossibility.Normal,  0), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("War Hammer",  3279,  LootPossibility.Normal,  0), new Loot("Club Ring",  3093,  LootPossibility.Normal,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Axe Ring",  3092,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Rusty Armor",  0,  LootPossibility.Rare,  0), new Loot("Knight Legs",  3371,  LootPossibility.SemiRare,  0), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("Piece of Hell Steel",  0,  LootPossibility.Rare,  0), new Loot("Piece of Royal Steel",  0,  LootPossibility.Rare,  0), new Loot("Piece of Draconian Steel",  0,  LootPossibility.Rare,  0), new Loot("Hammer of Wrath",  3332,  LootPossibility.Rare,  0), new Loot("Steel Boots",  3554,  LootPossibility.Rare,  0), new Loot("War Horn",  2958,  LootPossibility.VeryRare,  0), new Loot("Emerald Bangle",  3010,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData PolarBear = new CreatureData("Polar Bear", 85, 28, 0, 0, 30, false, false, FrontAttack.None, 
          ...
          new List<string>() { "GROARRR!",  },
          new List<Loot>() { new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Bear Paw",  5896,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Priestess = new CreatureData("Priestess", 390, 420, 0, 0, 195, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Apple",  0,  LootPossibility.Normal,  2), new Loot("Bowl",  0,  LootPossibility.Normal,  0), new Loot("Dagger",  3267,  LootPossibility.Normal,  0), new Loot("Sling Herb",  0,  LootPossibility.Normal,  0), new Loot("Goat Grass",  0,  LootPossibility.Normal,  0), new Loot("Orange Book",  0,  LootPossibility.Normal,  0), new Loot("Crystal Ball",  3076,  LootPossibility.Normal,  0), new Loot("Wood Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Powder Herb",  0,  LootPossibility.Normal,  0), new Loot("Clerical Mace",  3311,  LootPossibility.Normal,  0), new Loot("Crystal Necklace",  3008,  LootPossibility.Normal,  0), new Loot("Wooden Flute",  0,  LootPossibility.Rare,  0), new Loot("Talon",  3034,  LootPossibility.Rare,  0), new Loot("Mana Potion",  268,  LootPossibility.Normal,  0), new Loot("Hailstorm Rod",  3067,  LootPossibility.Rare,  0), new Loot("Piggy Bank",  2995,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Primitive = new CreatureData("Primitive", 200, 45, 0, 0, 90, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Studded Shield",  3426,  LootPossibility.Normal,  0), new Loot("Studded Helmet",  3376,  LootPossibility.Normal,  0), new Loot("Studded Armor",  3378,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Sabre",  3273,  LootPossibility.Normal,  0), new Loot("Surprise Bag",  0,  LootPossibility.Normal,  0), new Loot("Surprise Bag",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData QuaraConstrictor = new CreatureData("Quara Constrictor", 450, 250, 0, 0, 256, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  93), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Shrimp",  0,  LootPossibility.Normal,  5), new Loot("Brass Armor",  3359,  LootPossibility.SemiRare,  0), new Loot("Fish Fin",  5895,  LootPossibility.SemiRare,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData QuaraHydromancer = new CreatureData("Quara Hydromancer", 1100, 800, 0, 0, 825, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Staff",  3289,  LootPossibility.Normal,  0), new Loot("Remains of a Fish",  0,  LootPossibility.Normal,  0), new Loot("Shrimp",  0,  LootPossibility.SemiRare,  5), new Loot("White Pearl",  3026,  LootPossibility.SemiRare,  0), new Loot("Black Pearl",  3027,  LootPossibility.SemiRare,  0), new Loot("Small Emerald",  3032,  LootPossibility.SemiRare,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("Of Cosmic Energy",  0,  LootPossibility.Rare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("Fish Fin",  5895,  LootPossibility.Rare,  0), new Loot("Great Mana Potion",  238,  LootPossibility.VeryRare,  0), new Loot("Knight Armor",  3370,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData QuaraMantassin = new CreatureData("Quara Mantassin", 800, 400, 0, 0, 140, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  130), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Cape",  0,  LootPossibility.Normal,  0), new Loot("Shrimp",  0,  LootPossibility.Normal,  5), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.SemiRare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.SemiRare,  0), new Loot("Fish Fin",  5895,  LootPossibility.Rare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Rare,  0), new Loot("Strange Helmet",  0,  LootPossibility.VeryRare,  0), new Loot("Blue Robe",  3567,  LootPossibility.VeryRare,  0), new Loot("Glacier Shoes",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData QuaraPincher = new CreatureData("Quara Pincher", 1800, 1200, 0, 0, 340, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  120), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Small Ruby",  3030,  LootPossibility.SemiRare,  0), new Loot("Shrimp",  0,  LootPossibility.SemiRare,  5), new Loot("Fish Fin",  5895,  LootPossibility.Rare,  0), new Loot("Warrior Helmet",  3369,  LootPossibility.Rare,  0), new Loot("Glacier Robe",  0,  LootPossibility.VeryRare,  0), new Loot("Great Health Potion",  239,  LootPossibility.VeryRare,  0), new Loot("Crown Armor",  3381,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData QuaraPincherScout = new CreatureData("Quara Pincher Scout", 775, 600, 0, 0, 240, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  10) },
          new List<string>() { "Clank! Clank!",  "Clap!",  "Crrrk! Crrrk!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  49), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Small Ruby",  3030,  LootPossibility.Rare,  0), new Loot("Life Crystal",  3061,  LootPossibility.Rare,  0), new Loot("Fish Fin",  5895,  LootPossibility.Rare,  0)}
      );
      public static CreatureData QuaraPredator = new CreatureData("Quara Predator", 2200, 1600, 0, 0, 470, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  130), new Loot("Royal Spear",  7378,  LootPossibility.Normal,  7), new Loot("Fishbone",  0,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Viking Helmet",  3367,  LootPossibility.Normal,  0), new Loot("Small Diamond",  3028,  LootPossibility.Normal,  0), new Loot("Shrimp",  0,  LootPossibility.SemiRare,  5), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Fish Fin",  5895,  LootPossibility.Rare,  0), new Loot("Skull Helmet",  5741,  LootPossibility.VeryRare,  0), new Loot("Assassin Star",  7368,  LootPossibility.VeryRare,  2), new Loot("Relic Sword",  7383,  LootPossibility.VeryRare,  0), new Loot("Glacier Robe",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData QuaraPredatorScout = new CreatureData("Quara Predator Scout", 890, 400, 0, 0, 190, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  10) },
          new List<string>() { "Gnarrr!",  "Tcharrr!",  "Rrrah!",  "Rraaar!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  37), new Loot("Fishbone",  0,  LootPossibility.Normal,  0), new Loot("Viking Helmet",  3367,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Life Crystal",  3061,  LootPossibility.Rare,  0), new Loot("Small Diamond",  3028,  LootPossibility.Rare,  0), new Loot("Fish Fin",  5895,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData Rahemos = new CreatureData("Rahemos", 3700, 3100, 0, 0, 1850, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  230), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  3), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Magician Hat",  3573,  LootPossibility.Rare,  0), new Loot("Orb",  0,  LootPossibility.VeryRare,  0), new Loot("Necrotic Rod",  3069,  LootPossibility.VeryRare,  0), new Loot("Violet Gem",  3036,  LootPossibility.VeryRare,  0), new Loot("Crystal W",  0,  LootPossibility.Normal,  0), new Loot("very rare)",  0,  LootPossibility.VeryRare,  0), new Loot("Twin Axe",  3335,  LootPossibility.VeryRare,  0), new Loot("Ancient Rune",  0,  LootPossibility.Always,  0)}
      );
      public static CreatureData Rat = new CreatureData("Rat", 20, 5, 0, 0, 8, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  5), new Loot("Worm",  0,  LootPossibility.Normal,  3), new Loot("Cheese",  0,  LootPossibility.Normal,  0), new Loot("Cookies",  0,  LootPossibility.Normal,  2)}
      );
      public static CreatureData RenegadeOrc = new CreatureData("Renegade Orc", 450, 270, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "Harga puchak muhmak!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  29), new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Brown Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Scimitar",  3307,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Broadsword",  3301,  LootPossibility.Normal,  0), new Loot("Sword Ring",  3091,  LootPossibility.Normal,  0), new Loot("Longsword",  3285,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData RoaringWaterElemental = new CreatureData("Roaring Water Elemental", 1750, 1300, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  179), new Loot("Iced Soil",  0,  LootPossibility.SemiRare,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Rare,  2), new Loot("Giant Shimmering Pearl",  0,  LootPossibility.Rare,  2), new Loot("Northwind Rod",  8083,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Rocko = new CreatureData("Rocko", 10000, 3400, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Death, DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  15), new DamageModifier(DamageType.Holy,  10), new DamageModifier(DamageType.Fire,  30), new DamageModifier(DamageType.Energy,  25), new DamageModifier(DamageType.Ice,  20)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { }
      );
      ...
      public static CreatureData RottietheRotworm = new CreatureData("Rottie the Rotworm", 65, 40, 0, 0, 25, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  27), new Loot("Worms",  3492,  LootPossibility.Normal,  5), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Legion Helmet",  3374,  LootPossibility.Normal,  0), new Loot("Copper Shield",  3430,  LootPossibility.Normal,  0), new Loot("Katana",  3300,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Rotworm = new CreatureData("Rotworm", 65, 40, 0, 0, 40, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  27), new Loot("Worms",  3492,  LootPossibility.Normal,  5), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Rare,  0), new Loot("Sword",  3264,  LootPossibility.Rare,  0), new Loot("Legion Helmet",  3374,  LootPossibility.VeryRare,  0), new Loot("Copper Shield",  3430,  LootPossibility.VeryRare,  0), new Loot("Katana",  3300,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData RukorZad = new CreatureData("Rukor Zad", 380, 380, 0, 0, 370, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  50), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Sandcrawler = new CreatureData("Sandcrawler", 30, 20, 0, 0, 3, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  1) },
          new List<string>() { "Chrk chrk!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  6), new Loot("S",  0,  LootPossibility.Normal,  0), new Loot("crawler Shell",  0,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData SeaSerpent = new CreatureData("Sea Serpent", 1950, 2300, 0, 0, 800, false, true, FrontAttack.None, 
          ...
          new List<string>() { "CHHHRRRR",  "HISSSS",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  234), new Loot("Dragon Ham",  0,  LootPossibility.Normal,  3), new Loot("Viking Helmet",  3367,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Small Sapphire",  3029,  LootPossibility.SemiRare,  3), new Loot("Strong Health Potion",  236,  LootPossibility.SemiRare,  0), new Loot("Strong Mana Potion",  237,  LootPossibility.SemiRare,  0), new Loot("Serpent Sword",  3297,  LootPossibility.SemiRare,  0), new Loot("Spirit Cloak",  0,  LootPossibility.SemiRare,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Rare,  0), new Loot("Northwind Rod",  8083,  LootPossibility.Rare,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Rare,  0), new Loot("Glacier Amulet",  815,  LootPossibility.Rare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.VeryRare,  0), new Loot("Glacier Kilt",  823,  LootPossibility.VeryRare,  0), new Loot("Focus Cape",  8043,  LootPossibility.VeryRare,  0), new Loot("Leviathan's Amulet",  0,  LootPossibility.VeryRare,  0), new Loot("Crystalline Armor",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData SerpentSpawn = new CreatureData("Serpent Spawn", 3000, 3050, 0, 0, 1400, false, true, FrontAttack.Beam, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  219), new Loot("Onyx Arrow",  7365,  LootPossibility.Normal,  3), new Loot("Charmer's Tiara",  3407,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Gemmed Book",  0,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0), new Loot("Green Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Golden Mug",  2903,  LootPossibility.Normal,  0), new Loot("Life Ring",  3052,  LootPossibility.Normal,  0), new Loot("Small Sapphire",  3029,  LootPossibility.Normal,  0), new Loot("Snakebite Rod",  3066,  LootPossibility.Normal,  0), new Loot("Power Bolt",  3450,  LootPossibility.Normal,  0), new Loot("Crown Armor",  3381,  LootPossibility.Rare,  0), new Loot("Life Crystal",  3061,  LootPossibility.Rare,  0), new Loot("Mercenary Sword",  7386,  LootPossibility.Rare,  0), new Loot("Noble Axe",  7456,  LootPossibility.Rare,  0), new Loot("Old Parchment",  0,  LootPossibility.Rare,  0), new Loot("Strange Helmet",  0,  LootPossibility.Rare,  0), new Loot("Tower Shield",  3428,  LootPossibility.Rare,  0), new Loot("Warrior Helmet",  3369,  LootPossibility.Rare,  0), new Loot("Royal Helmet",  3392,  LootPossibility.VeryRare,  0), new Loot("Spellbook of Mind Control",  8074,  LootPossibility.VeryRare,  0), new Loot("Swamplair Armor",  0,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData ShadowHound = new CreatureData("Shadow Hound", 0, 0, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Paralysis},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  20), new DamageModifier(DamageType.Holy,  30), new DamageModifier(DamageType.Fire,  40), new DamageModifier(DamageType.Energy,  10), new DamageModifier(DamageType.Earth,  80)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  5), new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { "Grrrr!",  },
          new List<Loot>() { new Loot("Midnight Shard",  0,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData ShardofCorruption = new CreatureData("Shard of Corruption", 600, 7, 0, 0, 200, false, true, FrontAttack.Wave, 
          new List<DamageType>() { DamageType.Earth, DamageType.Drown},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  60), new DamageModifier(DamageType.Death,  10), new DamageModifier(DamageType.Energy,  20), new DamageModifier(DamageType.Ice,  15)},
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { }
      );
      public static CreatureData Shardhead = new CreatureData("Shardhead", 800, 650, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Energy,  20) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  195), new Loot("Ice Cubes",  0,  LootPossibility.Normal,  2), new Loot("Strong Mana Potion",  237,  LootPossibility.Normal,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Shard",  7290,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData SilverRabbit = new CreatureData("Silver Rabbit", 15, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Carrot",  0,  LootPossibility.Normal,  1), new Loot("Blue Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Green Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Purple Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Red Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("Yellow Coloured Egg",  0,  LootPossibility.Normal,  0), new Loot("only during the Easter holiday)",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData SirValorcrest = new CreatureData("Sir Valorcrest", 0, 1800, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  93), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  5), new Loot("Vampire Lord Token",  8192,  LootPossibility.Always,  0), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Sword Ring",  3091,  LootPossibility.Normal,  0), new Loot("Ring of Healing",  3098,  LootPossibility.Normal,  0), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Rare,  0), new Loot("Chaos Mace",  7427,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Skeleton = new CreatureData("Skeleton", 50, 35, 0, 0, 30, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Torches",  0,  LootPossibility.Normal,  2), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Brass Shield",  3411,  LootPossibility.Normal,  0), new Loot("Hatchet",  3276,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Viking Helmet",  3367,  LootPossibility.SemiRare,  0), new Loot("Sword",  3264,  LootPossibility.SemiRare,  0)}
      );
      public static CreatureData SkeletonWarrior = new CreatureData("Skeleton Warrior", 65, 45, 0, 0, 43, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Brass Shield",  3411,  LootPossibility.Normal,  0), new Loot("White Mushroom",  0,  LootPossibility.Normal,  3), new Loot("Brown Mushroom",  0,  LootPossibility.SemiRare,  0)}
      );
      public static CreatureData Skunk = new CreatureData("Skunk", 20, 3, 0, 0, 8, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Worms",  3492,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  2)}
      );
      ...
      public static CreatureData Smuggler = new CreatureData("Smuggler", 130, 48, 0, 0, 60, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  10), new Loot("Torch",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  0), new Loot("Knife",  3291,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Combat Knife",  3292,  LootPossibility.Normal,  0), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.SemiRare,  0), new Loot("Deer Trophy",  7397,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData SmugglerBaronSilvertoe = new CreatureData("Smuggler Baron Silvertoe", 280, 170, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  20), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Short Sword",  3294,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData Spectre = new CreatureData("Spectre", 1350, 2100, 0, 0, 820, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  300), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  7), new Loot("Blank Rune",  0,  LootPossibility.Normal,  2), new Loot("S",  0,  LootPossibility.Normal,  0), new Loot("als",  0,  LootPossibility.Normal,  0), new Loot("Lyre",  0,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.SemiRare,  0), new Loot("White Piece of Cloth",  5909,  LootPossibility.SemiRare,  0), new Loot("Silver Brooch",  0,  LootPossibility.Rare,  0), new Loot("Death Ring",  6299,  LootPossibility.Rare,  0), new Loot("Relic Sword",  7383,  LootPossibility.Rare,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Rare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.VeryRare,  0), new Loot("Shadow Sceptre",  7451,  LootPossibility.VeryRare,  0), new Loot("Demonbone Amulet",  3019,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData SpitNettle = new CreatureData("Spit Nettle", 150, 20, 0, 0, 45, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  5), new Loot("Shadow Herb",  0,  LootPossibility.Normal,  0), new Loot("Sling Herb",  0,  LootPossibility.Normal,  2), new Loot("Grave Flower",  3661,  LootPossibility.SemiRare,  0), new Loot("Seeds",  647,  LootPossibility.SemiRare,  0)}
      );
      ...
      public static CreatureData Stalker = new CreatureData("Stalker", 120, 90, 0, 0, 100, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  20), new DamageModifier(DamageType.Holy,  5) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  8), new Loot("Throwing Knife",  3298,  LootPossibility.Normal,  2), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Backpack",  0,  LootPossibility.Normal,  0), new Loot("Katana",  3300,  LootPossibility.Normal,  0), new Loot("Obsidian Lance",  3313,  LootPossibility.Rare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData StoneGolem = new CreatureData("Stone Golem", 270, 160, 0, 0, 110, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  15), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Small Stone",  1781,  LootPossibility.Normal,  4), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Carlin Sword",  3283,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Power Ring",  3050,  LootPossibility.SemiRare,  0), new Loot("Iron Ore",  5880,  LootPossibility.SemiRare,  0), new Loot("Crystal Ring",  3007,  LootPossibility.VeryRare,  0), new Loot("Red Gem",  3039,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData Stonecracker = new CreatureData("Stonecracker", 0, 3500, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  78), new Loot("meat",  0,  LootPossibility.Normal,  3), new Loot("Big Bone",  0,  LootPossibility.Normal,  0), new Loot("Behemoth Claw",  5930,  LootPossibility.Normal,  0), new Loot("Crowbar",  3304,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Perfect Behemoth Fang",  0,  LootPossibility.Normal,  0), new Loot("Assassin Star",  7368,  LootPossibility.Normal,  0), new Loot("War Axe",  3342,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  0), new Loot("Strange Symbol",  0,  LootPossibility.Normal,  0), new Loot("Dark Armor",  3383,  LootPossibility.Normal,  0), new Loot("Steel Boots",  3554,  LootPossibility.Normal,  0), new Loot("Giant Sword",  3281,  LootPossibility.Normal,  0)}
      );
      public static CreatureData SvorenTheMad = new CreatureData("Svoren The Mad", 6300, 3000, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Fire, DamageType.Energy, DamageType.Earth},
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "NO mommy NO. Leave me alone!",  "Not that tower again!",  "The cat has grown some horns!",  "What was I doing here again",  },
          new List<Loot>() { }
      );
      ...
      public static CreatureData Tarantula = new CreatureData("Tarantula", 225, 120, 0, 0, 90, false, false, FrontAttack.None, 
          ...
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  40), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.SemiRare,  0), new Loot("Time Ring",  3053,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Terramite = new CreatureData("Terramite", 365, 160, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  1), new DamageModifier(DamageType.Earth,  1)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  1), new DamageModifier(DamageType.Energy,  1) },
          new List<string>() { "Zrp zrp!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  23), new Loot("Terramite Legs",  0,  LootPossibility.Normal,  0), new Loot("Terramite Eggs",  0,  LootPossibility.Normal,  0), new Loot("Terramite Shell",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TerrorBird = new CreatureData("Terror Bird", 300, 150, 0, 0, 90, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Worms",  3492,  LootPossibility.Normal,  3), new Loot("Meat",  0,  LootPossibility.Normal,  3), new Loot("Seeds",  647,  LootPossibility.SemiRare,  0), new Loot("Health Potion",  266,  LootPossibility.SemiRare,  0), new Loot("Feather Headdress",  3406,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Thalas = new CreatureData("Thalas", 4100, 2950, 0, 0, 1400, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  159), new Loot("Small Emerald",  3032,  LootPossibility.SemiRare,  3), new Loot("Poison Dagger",  3299,  LootPossibility.SemiRare,  0), new Loot("Time Ring",  3053,  LootPossibility.SemiRare,  0), new Loot("Stealth Ring",  3049,  LootPossibility.Rare,  0), new Loot("Great Health Potion",  239,  LootPossibility.Rare,  0), new Loot("Serpent Sword",  3297,  LootPossibility.VeryRare,  0), new Loot("Green Gem",  3038,  LootPossibility.VeryRare,  0), new Loot("Djinn Blade",  3339,  LootPossibility.VeryRare,  0), new Loot("Cobrafang Dagger",  3238,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData TheAxeorcist = new CreatureData("The Axeorcist", 0, 0, 0, 0, 276, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "FIGHT!",  },
          new List<Loot>() { new Loot("Unknown",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TheBigBadOne = new CreatureData("The Big Bad One", 300, 170, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Wolf Paws",  0,  LootPossibility.Normal,  2), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Wolf Trophy",  7394,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TheBlightfather = new CreatureData("The Blightfather", 0, 0, 0, 0, 0, false, true, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  91), new Loot("Lancer Beetle Shell",  0,  LootPossibility.Normal,  0), new Loot("Lump of Dirt",  0,  LootPossibility.Normal,  0), new Loot("Poisonous Slime",  0,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TheBloodtusk = new CreatureData("The Bloodtusk", 600, 300, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Ice,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  100), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  4), new Loot("Tusks",  0,  LootPossibility.Normal,  2), new Loot("Mammoth Fur Cape",  7463,  LootPossibility.Normal,  0), new Loot("Tusk Shield",  3443,  LootPossibility.Normal,  0), new Loot("Furry Club",  7432,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TheCollector = new CreatureData("The Collector", 340, 100, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Ice},
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "Leave as long as you can.",  },
          new List<Loot>() { }
      );
      public static CreatureData TheCount = new CreatureData("The Count", 4600, 1750, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Holy,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("The Ring of the Count",  0,  LootPossibility.Always,  0), new Loot("War Hammer",  3279,  LootPossibility.Normal,  0), new Loot("Vampire Shield",  3434,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData TheDreadorian = new CreatureData("The Dreadorian", 0, 0, 0, 0, 0, false, false, FrontAttack.Wave, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
      ...
      public static CreatureData TheEvilEye = new CreatureData("The Evil Eye", 1200, 750, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  56), new Loot("Longsword",  3285,  LootPossibility.Normal,  0), new Loot("Morning Star",  3282,  LootPossibility.Normal,  0), new Loot("Steel Shield",  3409,  LootPossibility.Normal,  0), new Loot("Wooden Shield",  3412,  LootPossibility.Normal,  0), new Loot("Spellbook",  648,  LootPossibility.Normal,  0), new Loot("Two-H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Beholder Shield",  3418,  LootPossibility.Normal,  0), new Loot("Terra Rod",  3065,  LootPossibility.Normal,  0), new Loot("Beholder Helmet",  3408,  LootPossibility.Normal,  0), new Loot("Terra Mantle",  811,  LootPossibility.Normal,  0), new Loot("Beholder Eye",  5898,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData TheHornedFox = new CreatureData("The Horned Fox", 265, 300, 0, 0, 120, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  74), new Loot("Piercing Bolts",  0,  LootPossibility.SemiRare,  14), new Loot("Strong Health Potion",  236,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Leather Legs",  3559,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Shovel",  3457,  LootPossibility.Normal,  0), new Loot("Bronze Amulet",  3056,  LootPossibility.Normal,  0), new Loot("Crossbow",  3349,  LootPossibility.Normal,  0), new Loot("Bolts",  3446,  LootPossibility.Normal,  0), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Chain Armor",  3358,  LootPossibility.Normal,  0), new Loot("Chain Legs",  3558,  LootPossibility.Normal,  0), new Loot("Chain Helmets",  0,  LootPossibility.Normal,  0), new Loot("Soldier Helmet",  3375,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Hatchet",  3276,  LootPossibility.Normal,  0), new Loot("Fishing Rod",  3483,  LootPossibility.Normal,  0), new Loot("Battle Shield",  3413,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Combat Knife",  3292,  LootPossibility.Normal,  0), new Loot("Dead Snake",  3998,  LootPossibility.Normal,  0), new Loot("Carrots",  0,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.Normal,  0), new Loot("Dwarven Helmet",  3396,  LootPossibility.Rare,  0), new Loot("Nose Ring",  5804,  LootPossibility.Always,  0)}
      );
      public static CreatureData TheImperor = new CreatureData("The Imperor", 15000, 8000, 0, 0, 2000, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  3), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Fire Axe",  3320,  LootPossibility.Normal,  0), new Loot("Crown Legs",  3382,  LootPossibility.Normal,  0), new Loot("Pitchfork",  0,  LootPossibility.Normal,  0), new Loot("Guardian Shield",  0,  LootPossibility.Normal,  0), new Loot("Imperor's Trident",  6534,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData TheMutatedPumpkin = new CreatureData("The Mutated Pumpkin", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Yummy Gummy Worm",  0,  LootPossibility.Normal,  40), new Loot("Toy Spider",  0,  LootPossibility.Normal,  0), new Loot("Spiderwebs",  0,  LootPossibility.Normal,  0), new Loot("Bat Decoration",  6491,  LootPossibility.Normal,  0), new Loot("Skeleton Decoration",  6525,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData TheOldWhopper = new CreatureData("The Old Whopper", 785, 750, 0, 0, 175, false, true, FrontAttack.Wave, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  106), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TheOldWidow = new CreatureData("The Old Widow", 3200, 2800, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  231), new Loot("Platinum Coin",  3035,  LootPossibility.Normal,  2), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Steel Helmet",  3351,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Energy Ring",  3051,  LootPossibility.Normal,  0), new Loot("Time Ring",  3053,  LootPossibility.Normal,  0), new Loot("Platinum Amulet",  3055,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  3), new Loot("Knight Armor",  3370,  LootPossibility.Normal,  0), new Loot("Knight Legs",  3371,  LootPossibility.Normal,  0), new Loot("Spider Silk",  5879,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData TheSnapper = new CreatureData("The Snapper", 300, 150, 0, 0, 55, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  5), new DamageModifier(DamageType.Fire,  10), new DamageModifier(DamageType.Energy,  5) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  194), new Loot("Health Potions",  0,  LootPossibility.Normal,  5), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Crocodile Boots",  3556,  LootPossibility.Normal,  0), new Loot("Knight Armor",  3370,  LootPossibility.Rare,  0), new Loot("Life Ring",  3052,  LootPossibility.Always,  0)}
      );
      public static CreatureData TheVoiceofRuin = new CreatureData("The Voice of Ruin", 0, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Spiked Iron Ball",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData TheWeakenedCount = new CreatureData("The Weakened Count", 740, 450, 0, 0, 283, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  92), new Loot("Skull",  0,  LootPossibility.Normal,  0), new Loot("Vampire Shield",  3434,  LootPossibility.VeryRare,  0), new Loot("The Ring of the Count",  0,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData ThievingSquirrel = new CreatureData("Thieving Squirrel", 55, 0, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { "Chchch",  },
          new List<Loot>() { new Loot("Flask with Beaver Bait",  0,  LootPossibility.Always,  0)}
      );
      public static CreatureData ThornbackTortoise = new CreatureData("Thornback Tortoise", 300, 150, 0, 0, 112, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Tortoise Egg",  0,  LootPossibility.Normal,  3), new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Ham",  0,  LootPossibility.Normal,  2), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Health Potion",  266,  LootPossibility.SemiRare,  0), new Loot("Brown Mushroom",  0,  LootPossibility.Rare,  0), new Loot("White Mushroom",  0,  LootPossibility.Rare,  0), new Loot("War Hammer",  3279,  LootPossibility.Rare,  0)}
      );
      public static CreatureData Thul = new CreatureData("Thul", 3000, 1800, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Shrimp",  0,  LootPossibility.Normal,  0), new Loot("Small Amethyst",  3033,  LootPossibility.Normal,  0), new Loot("White Pearl",  3026,  LootPossibility.Normal,  0), new Loot("Black Pearl",  3027,  LootPossibility.Normal,  0), new Loot("Double Axe",  3275,  LootPossibility.Normal,  0), new Loot("Halberd",  3269,  LootPossibility.Normal,  0), new Loot("Skull Helmet",  5741,  LootPossibility.Normal,  0), new Loot("W",  0,  LootPossibility.Normal,  0), new Loot("of Cosmic Energy",  0,  LootPossibility.Normal,  0), new Loot("Relic Sword",  7383,  LootPossibility.Rare,  0), new Loot("Fish Fin",  5895,  LootPossibility.Always,  0)}
      );
      ...
      public static CreatureData Tiger = new CreatureData("Tiger", 75, 40, 0, 0, 40, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Death,  10), new DamageModifier(DamageType.Ice,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Meat",  0,  LootPossibility.Normal,  4), new Loot("Ham",  0,  LootPossibility.Normal,  4)}
      );
      public static CreatureData TiquandasRevenge = new CreatureData("Tiquandas Revenge", 2400, 2635, 0, 0, 910, false, true, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  1) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  110), new Loot("Meat",  0,  LootPossibility.Normal,  50), new Loot("Ham",  0,  LootPossibility.Normal,  8), new Loot("Dark Mushroom",  0,  LootPossibility.Normal,  6), new Loot("Seeds",  647,  LootPossibility.Always,  3), new Loot("M",  0,  LootPossibility.Normal,  0), new Loot("rake",  0,  LootPossibility.Always,  0)}
      );
      public static CreatureData Tirecz = new CreatureData("Tirecz", 25000, 6000, 0, 0, 0, false, false, FrontAttack.Wave, 
          new List<DamageType>() { },
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  10), new DamageModifier(DamageType.Holy,  30), new DamageModifier(DamageType.Death,  30), new DamageModifier(DamageType.Fire,  50), new DamageModifier(DamageType.Energy,  30), new DamageModifier(DamageType.Ice,  30), new DamageModifier(DamageType.Earth,  30)},
          new List<DamageModifier>() {  },
          new List<string>() { "Hissss!",  },
          new List<Loot>() { }
      );
      public static CreatureData Toad = new CreatureData("Toad", 135, 60, 0, 0, 48, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { "Ribbit! Ribbit!",  "Ribbit!",  },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  12), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Club",  3270,  LootPossibility.Normal,  0), new Loot("War Hammer",  3279,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData Tortoise = new CreatureData("Tortoise", 185, 90, 0, 0, 50, false, false, FrontAttack.None, 
          ...
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  10) },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  30), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Battle Hammer",  3305,  LootPossibility.Normal,  0), new Loot("Plate Shield",  3410,  LootPossibility.Normal,  0), new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Hams",  0,  LootPossibility.Normal,  2), new Loot("Tortoise Eggs",  0,  LootPossibility.SemiRare,  3), new Loot("Tortoise Shield",  6131,  LootPossibility.Rare,  0), new Loot("Turtle Shell",  0,  LootPossibility.Rare,  0)}
      );
      ...
      public static CreatureData Tremorak = new CreatureData("Tremorak", 10000, 1300, 0, 0, 0, false, false, FrontAttack.None, 
          new List<DamageType>() { DamageType.Earth},
          new List<DamageModifier>() { new DamageModifier(DamageType.Physical,  50), new DamageModifier(DamageType.Holy,  50), new DamageModifier(DamageType.Death,  35), new DamageModifier(DamageType.Energy,  85), new DamageModifier(DamageType.Ice,  20)},
          new List<DamageModifier>() { new DamageModifier(DamageType.Fire,  15) },
          new List<string>() { "*STOMP STOMP*",  },
          new List<Loot>() { }
      );
      public static CreatureData Troll = new CreatureData("Troll", 50, 20, 0, 0, 25, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  12), new Loot("Meat",  0,  LootPossibility.Normal,  0), new Loot("Leather Boots",  3552,  LootPossibility.Normal,  0), new Loot("Leather Helmet",  3355,  LootPossibility.Normal,  0), new Loot("Rope",  3003,  LootPossibility.Normal,  0), new Loot("Bag",  0,  LootPossibility.Normal,  0), new Loot("Spear",  3277,  LootPossibility.Normal,  0), new Loot("H",  0,  LootPossibility.Normal,  0), new Loot("Axe",  3274,  LootPossibility.Normal,  0), new Loot("Wooden Shield",  3412,  LootPossibility.Normal,  0), new Loot("Studded Club",  3336,  LootPossibility.SemiRare,  0), new Loot("Silver Amulet",  3054,  LootPossibility.VeryRare,  0)}
      );
      ...
      public static CreatureData TrollLegionnaire = new CreatureData("Troll Legionnaire", 210, 140, 0, 0, 270, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  191), new Loot("Throwing Stars",  0,  LootPossibility.Normal,  10), new Loot("Stealth Ring",  3049,  LootPossibility.Rare,  0)}
      );
      public static CreatureData UndeadDragon = new CreatureData("Undead Dragon", 8350, 7200, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Power Bolts",  0,  LootPossibility.Normal,  6), new Loot("Onyx Arrows",  0,  LootPossibility.Normal,  10), new Loot("Platinum Coins",  0,  LootPossibility.Normal,  5), new Loot("Blank Rune",  0,  LootPossibility.Normal,  0), new Loot("Broadsword",  3301,  LootPossibility.Normal,  0), new Loot("Death Ring",  6299,  LootPossibility.Normal,  0), new Loot("Demonic Essence",  6499,  LootPossibility.Normal,  0), new Loot("Golden Mug",  2903,  LootPossibility.Normal,  0), new Loot("Soul Orb",  5944,  LootPossibility.Normal,  0), new Loot("Torn Book",  0,  LootPossibility.Normal,  0), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Dragonbone Staff",  7430,  LootPossibility.SemiRare,  0), new Loot("Knight Armor",  3370,  LootPossibility.SemiRare,  0), new Loot("Life Crystal",  3061,  LootPossibility.SemiRare,  0), new Loot("Hardened Bone",  5925,  LootPossibility.Rare,  0), new Loot("Rusty Armor",  0,  LootPossibility.Normal,  0), new Loot("Underworld Rod",  8082,  LootPossibility.Rare,  0), new Loot("Gold Ingot",  9058,  LootPossibility.Rare,  0), new Loot("War Axe",  3342,  LootPossibility.Rare,  0), new Loot("Dragon Scale Mail",  3386,  LootPossibility.VeryRare,  0), new Loot("Golden Armor",  3360,  LootPossibility.VeryRare,  0), new Loot("Royal Helmet",  3392,  LootPossibility.VeryRare,  0), new Loot("Skull Helmet",  5741,  LootPossibility.VeryRare,  0), new Loot("Divine Plate",  0,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData UndeadGladiator = new CreatureData("Undead Gladiator", 1000, 800, 0, 0, 385, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  150), new Loot("Meat",  0,  LootPossibility.Normal,  2), new Loot("Throwing Star",  3287,  LootPossibility.Normal,  18), new Loot("Hunting Spear",  3347,  LootPossibility.Normal,  0), new Loot("Scimitar",  3307,  LootPossibility.Normal,  0), new Loot("Brass Legs",  3372,  LootPossibility.Normal,  0), new Loot("Plate Armor",  3357,  LootPossibility.Normal,  0), new Loot("Plate Legs",  3557,  LootPossibility.Normal,  0), new Loot("Brass Armor",  3359,  LootPossibility.Normal,  0), new Loot("Protection Amulet",  3084,  LootPossibility.Normal,  0), new Loot("Two H",  0,  LootPossibility.Normal,  0), new Loot("ed Sword",  0,  LootPossibility.Normal,  0), new Loot("Stealth Ring",  3049,  LootPossibility.SemiRare,  0), new Loot("Belted Cape",  8044,  LootPossibility.SemiRare,  0), new Loot("Dark Helmet",  3384,  LootPossibility.SemiRare,  0), new Loot("Crusader Helmet",  3391,  LootPossibility.Rare,  0), new Loot("Health Potion",  266,  LootPossibility.Rare,  0), new Loot("Knight Axe",  3318,  LootPossibility.Rare,  0), new Loot("Beastslayer Axe",  0,  LootPossibility.VeryRare,  0), new Loot("Warrior's Sweat",  0,  LootPossibility.VeryRare,  0), new Loot("Mercenary Sword",  7386,  LootPossibility.VeryRare,  0), new Loot("Glorious Axe",  7454,  LootPossibility.VeryRare,  0)}
      );
      public static CreatureData UndeadJester = new CreatureData("Undead Jester", 355, 5, 0, 0, 0, false, false, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Fish",  0,  LootPossibility.Normal,  0), new Loot("Bar of Chocolate",  0,  LootPossibility.Normal,  0), new Loot("Spellw",  0,  LootPossibility.Normal,  0), new Loot("",  0,  LootPossibility.Normal,  0), new Loot("Supersoft Pillow",  0,  LootPossibility.Normal,  0), new Loot("Suspicious Surprise Bag",  0,  LootPossibility.Normal,  0), new Loot("Red Piece of Cloth",  5911,  LootPossibility.Normal,  0), new Loot("Yellow Piece of Cloth",  5914,  LootPossibility.Normal,  0), new Loot("White Piece of Cloth",  5909,  LootPossibility.Normal,  0), new Loot("Green Piece of Cloth",  5910,  LootPossibility.Normal,  0), new Loot("Blue Piece of Cloth",  5912,  LootPossibility.Normal,  0), new Loot("Brown Piece of Cloth",  5913,  LootPossibility.Normal,  0), new Loot("The Head of a Jester Doll",  0,  LootPossibility.Normal,  0), new Loot("Part of a Jester Doll",  0,  LootPossibility.Normal,  0), new Loot("Part of a Jester Doll",  0,  LootPossibility.Normal,  0), new Loot("Part of a Jester Doll",  0,  LootPossibility.Normal,  0), new Loot("Part of a Jester Doll",  0,  LootPossibility.Normal,  0), new Loot("The Torso of a Jester Doll",  0,  LootPossibility.Normal,  0), new Loot("Piggy Bank",  2995,  LootPossibility.Normal,  0), new Loot("Toy Mouse",  123,  LootPossibility.Normal,  0), new Loot("Green Perch",  0,  LootPossibility.Normal,  0), new Loot("Rainbow Trout",  0,  LootPossibility.Normal,  0), new Loot("Marlin",  901,  LootPossibility.Normal,  0), new Loot("Ice Cream Cone",  0,  LootPossibility.Normal,  0)}
      );
      public static CreatureData UndeadMineWorker = new CreatureData("Undead Mine Worker", 65, 45, 0, 0, 20, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  0), new Loot("Bone",  0,  LootPossibility.Normal,  0), new Loot("White Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Brown Mushroom",  0,  LootPossibility.Normal,  0), new Loot("Mace",  3286,  LootPossibility.Normal,  0), new Loot("Sword",  3264,  LootPossibility.Normal,  0)}
      );
      ...
      public static CreatureData UndeadProspector = new CreatureData("Undead Prospector", 100, 85, 0, 0, 50, false, false, FrontAttack.None, 
          new List<DamageType>() { },
          new List<DamageModifier>() { },
          new List<DamageModifier>() {  },
          new List<string>() { },
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  23), new Loot("Worms",  3492,  LootPossibility.Normal,  5), new Loot("Scale Armor",  3377,  LootPossibility.Normal,  0), new Loot("Brass Helmet",  3354,  LootPossibility.Normal,  0), new Loot("Brown Piece of Cloth",  5913,  LootPossibility.Normal,  0), new Loot("Torch",  0,  LootPossibility.Normal,  0), new Loot("Knife",  3291,  LootPossibility.Normal,  0)}
      );
      public static CreatureData Ungreez = new CreatureData("Ungreez", 8200, 500, 0, 0, 0, false, true, FrontAttack.None, 
          ...
          new List<Loot>() { new Loot("Gold Coin",  3031,  LootPossibility.Normal,  90), new Loot("Fire Mushroom",  0,  LootPossibility.Normal,  6), new Loot("Great Health Potion",  239,  LootPossibility.Normal,  0), new Loot("Great Mana Potion",  238,  LootPossibility.Normal,  0)}
      );
